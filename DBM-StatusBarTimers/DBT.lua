...
function barPrototype:AnimateEnlarge(elapsed)
	...
	if melapsed < 1 then
		...
		local newWidth = DBT.Options.HugeWidth + (DBT.Options.Width - DBT.Options.HugeWidth) * (melapsed / 1)
		local newScale = DBT.Options.HugeScale + (DBT.Options.Scale - DBT.Options.HugeScale) * (melapsed / 1)
		self.frame:ClearAllPoints()
