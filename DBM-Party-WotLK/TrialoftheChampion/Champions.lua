...
if not UnitInVehicle(args:IsPlayer()) then --Only fires combat if you aren't mounted in the horse vehicles, should hopefully fix combat firing for first event.
