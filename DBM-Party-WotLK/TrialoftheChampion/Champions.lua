...
if not UnitInVehicle(UnitName("player")) then --Only fires combat if you aren't mounted in the horse vehicles, should hopefully fix combat firing for first event.
