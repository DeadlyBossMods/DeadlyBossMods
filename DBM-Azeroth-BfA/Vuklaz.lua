...
local timerWrithingSandsCD				= mod:NewCDTimer(41.3, 314659, nil, nil, nil, 1, nil, DBM_CORE_Translations.DAMAGE_ICON)--21.8?
local timerRazorSpinesCD				= mod:NewCDTimer(25.5, 314698, nil, nil, nil, 2, nil, DBM_CORE_Translations.HEALER_ICON)
local timerCrushingClawsCD				= mod:NewCDTimer(14.4, 314618, nil, nil, nil, 5, nil, DBM_CORE_Translations.TANK_ICON..DBM_CORE_Translations.HEALER_ICON)
