...
local timerForceandVerveCD				= mod:NewCDTimer(82.0, 314333, nil, nil, 2, 2, nil, DBM_CORE_Translations.DEADLY_ICON, nil, 1, 5)
local timerSummonSwarmguardCD			= mod:NewCDTimer(30.5, 314307, nil, nil, nil, 1, nil, DBM_CORE_Translations.TANK_ICON..DBM_CORE_Translations.DAMAGE_ICON)
