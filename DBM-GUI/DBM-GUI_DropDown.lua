do
	...
	for i=1, MAX_BUTTONS do
		for _, buttonName in ipairs(buttonTable) do
			...
			if i == 1 then
				...
				TabFrame1[buttonName][i]:SetPoint("TOPLEFT", TabFrame1[buttonName][i - 1], "BOTTOMLEFT")
			end
	...
	function DBM_GUI:CreateDropdown(title, values, vartype, var, callfunc, width, height, parent)
		...
		if title ~= nil and title ~= "" then
			dropdown.titletext = dropdown:CreateFontString(dropdown:GetName() .. "Text", 'BACKGROUND')
