...
L.Bar7CustomInline			= "Использовать кастомный встроенный значок '!'"
--Timer Example Texts
L.CBTGeneric						= "Общий"
...
L.FilterInterruptNoteName			= "Не показывать, если у оповещения есть счетчик, но Вашего имени нет в кастомной заметке"--Используется только на боссах, трэш мобы не считаются
...
L.DisableMusic						= "Отключить музыкальный канал во время боя с боссами<br/>(Примечание: если включено, кастомная музыка босса не будет воспроизводиться, если она включена в звуках событий)"
--Other
