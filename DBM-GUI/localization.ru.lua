...
L.Area_TextTimers = "Скорые таймеры (только включённые полосы DBM)"
L.TextTimersEnable = "Показывать таймеры перед завершением (по умолчанию выключено)"
L.TextTimersThreshold = "Показывать при остатке секунд"
...
L.TextTimersLock = "Закрепить положение"
L.TextTimersTest = "Проверить / переместить текст"
L.TextTimersReset = "Сбросить положение"
