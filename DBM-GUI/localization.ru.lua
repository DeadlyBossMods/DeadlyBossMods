...
L.Slider_BarOffSetX 				= "Горизонтальный интервал: %d"
L.Slider_BarOffSetY 				= "Вертикальный интервал: %d"
...
L.NPIcon_BarOffSetX 				= "Смещение иконки по оси X: %d"
L.NPIcon_BarOffSetY 				= "Смещение иконки по оси Y: %d"
...
L.AuraDurationFontSize				= "Размер шрифта длительности ауры: %d"
L.AuraStackFontSize					= "Размер шрифта количества стаков: %d"
