...
L.EnableTankPrivateAuraIcons		= "Показывать иконки аур первого игрока с ролью танка, который не вы"--Флажок
L.ShowSecondCoTank					= "Показывать иконки аур второго игрока с ролью танка, который не вы"--Флажок
...
L.CoTankSlot1Player					= "Игрок для первой ячейки со-танка"
L.CoTankSlot2Player					= "Игрок для второй ячейки со-танка"
