...
L.OTabRaids							= "Рейды"
L.OTabLairs							= "Логова"--Только в актуальном патче
...
L.Tools_GearCheck					= "Проверка экипировки"
L.Tools_BreakTimer					= "Запустить таймер перерыва"
L.Tools_PizzaTimer					= "Запустить общий таймер"
L.Tools_BrezArea					= "Таймер восстановления боевого воскрешения"
L.Tools_ShowBrezFrame				= "Отображение количества БР во время боев с боссами и в подземельях M+"
L.Tools_KeystoneArea				= "Ключи"
L.Tools_ShowKeystoneOnComplete		= "Автоматически показывать окно ключа после завершения прохождения подземелья M+."
L.Tools_AddChallengeTeleports		= "Добавить телепорты в интерфейс испытаний"
L.Tools_OverrideKeystoneSlash		= "Перезаписать слеш-команды для фрейма М+ ключа (/keystone, /keys и /key)\n(Примечание: если эта опция не отмечена, DBM будет стараться не перезаписывать эти команды для других аддонов. Однако DBM зарегистрирует их, если какая-либо из них не используется)"
...
L.Reset 							= "Сброс"
L.Import							= "Импорт"
L.ButtonExportMod					= "Экспорт модуля"
L.ButtonImportMod					= "Импорт модуля"
L.ModProfileImportFooter			= "Поддерживает профили этого босса или всего модуля."
L.ModProfileExportFooter			= "Экспортирует только настройки этого босса."
L.AddonProfileImportFooter			= "Поддерживает профили всего модуля или отдельного босса."
L.AddonProfileExportFooter			= "Экспортирует настройки всего модуля."
L.ModImportSuccess					= "Настройки импортированы для %s."
L.ModImportFailed				    = "Не удалось импортировать настройки для %s. Данные могут быть недействительны/повреждены или иметь неподдерживаемый формат."
L.ImportProfileFailed				= "Не удалось импортировать строку профиля. Данные могут быть недействительны/повреждены или иметь неподдерживаемый формат."
L.ImportProfileWrongType			= "Эта строка импорта предназначена для другого типа профиля."
L.ImportProfileWrongTypeCore		= "Это профиль настроек ядра. Импортируйте его в Настройки DBM > %s > %s."
L.ImportProfileWrongTypeInstance	= "Это профиль модуля. Импортируйте его на странице статистики этого модуля в разделе %s."
L.ImportProfileWrongTypeBoss		= "Это профиль модуля босса. Импортируйте его на панели настроек этого босса."
L.ImportProfileUnsupportedVersion	= "Эта строка импорта использует неподдерживаемую версию профиля."
L.ImportInstanceProfilePrompt		= "Эта строка содержит настройки для всего модуля. Импортировать все настройки модуля или только настройки для %s?"
L.ImportInstanceProfileAll			= "Импортировать все настройки модуля"
L.ImportInstanceProfileBoss			= "Только этого босса"
L.ProfileImported					= "Профиль импортирован."
L.PartialProfileImported			= "Профиль импортирован для %d из %d модулей; отсутствующие модули не изменены."
...
L.Statistic_BestClear			    = "Лучшее прохождение:"
...
L.RenameSpellButton					= "Переименовать"
L.RenameSpellHeader					= "Задать пользовательское имя для %s"
L.GTFOAbilityTitle					= "GTFO"
L.GTFOAbilityDescription			= "Любая способность, наносящая урон, от которой следует отойти"
...
L.AnnounceConsumables				= "Объявлять проверку расходных материалов в начале боя"
...
L.ModAllResetConfirm				= "Вы уверены, что хотите сбросить все настройки для %s?"
L.ModAllStatResetConfirm			= "Вы уверены, что хотите сбросить всю статистику для %s?"
L.ModProfileDeleteConfirm			= "Вы уверены, что хотите удалить профиль модуля %s?"
...
L.Area_ImportExportSpellRenames		= "Импорт/экспорт переименований заклинаний"
L.ImportExportSpellRenamesInfo		= "Импорт перезапишет Ваши текущие переименования заклинаний. Делайте это на свой страх и риск."
L.ButtonImportSpellRenames			= "Импорт переименований заклинаний"
L.ButtonExportSpellRenames			= "Экспорт переименований заклинаний"
L.ExportSpellRenamesFailed			= "Не удалось экспортировать строку переименований заклинаний. Данные могут быть недействительны/повреждены или иметь неподдерживаемый формат."
L.ImportSpellRenamesFailed			= "Не удалось импортировать строку переименований заклинаний. Данные могут быть недействительны/повреждены или иметь неподдерживаемый формат."
L.ImportSpellRenamesWrongType		= "Не удалось импортировать строку переименований заклинаний. Этот тип экспорта не относится к переименованиям заклинаний."
L.ImportSpellRenamesUnsupportedVersion	= "Не удалось импортировать строку переименований заклинаний. Эта версия экспорта не поддерживается."
L.SpellRenamesImported				= "Переименования заклинаний импортированы."
L.ImportErrorOn						= "Для настройки отсутствуют пользовательские звуки: %s"
L.ImportVoiceMissing				= "Отсутствует голосовой пакет: %s"
L.LegacyProfileImportNotice			= "Импортирован профиль старого формата. Этот формат устарел. Пожалуйста, экспортируйте его заново в новом формате."
...
L.Warn_Duration						= "Длительность предупреждения (сек.)"
L.None								= "Нет"
L.Random							= "Случайно"
L.Outline							= "Контур"
...
L.ShortTextSpellname				= "Использовать переименование заклинаний в тексте оповещения"
L.SpecWarn_FlashFrameRepeat			= "Количество миганий"
...
L.SpecWarn_FlashDur					= "Длительности мигания"
L.SpecWarn_FlashAlpha				= "Прозрачность мигания"
...
L.AlwaysShowPlayerAuras				= "Показывать рамки аур вне подземелий"--Флажок
L.AuraMaxDuration					= "Максимальная длительность отслеживаемых аур"
L.SetPAGrowDirection				= "Направление роста"--Выпадающее меню
L.SetPAIconScale					= "Масштаб значка"--Ползунок. Повторно используется для личного пользования и танками
L.SetPAMaxIcons						= "Макс. кол-во иконок"--Ползунок. Повторно используется для личного пользования и танками
L.SetPAIconSpacing					= "Расстояние между иконками"--Ползунок. Повторно используется для личного пользования и танками
L.HidePATooltip						= "Отключить всплывающую подсказку при наведении курсора мыши"--Флажок
L.HidePABorder						= "Отключить границу"--Флажок
L.OnlyBossOrRoleAuras				= "Показывать только ауры боссов/ролей (Примечание: отфильтровано Blizzard, отображаются не все важные ауры)"
L.Area_TankPrivateAuras				= "Настройки приватной ауры для совместного танка"
L.EnableTankPrivateAuraIcons		= "Показывать иконки аур первого игрока, играющего за танка, кроме Вас"--Флажок
L.CoTankVisibility					= "Показывать второго танка, когда:"
L.CoTankVisibilityAuto				= "В специализации танка"
L.CoTankVisibilityAlways			= "Всегда"
L.CoTankVisibilityNever				= "Никогда"
L.ShowSecondCoTank					= "Показывать иконки аур второго игрока, играющего за танка, кроме Вас"--Флажок
L.CoTankUseHealerInFiveMan			= "В подземельях на 5 игроков автоматически отслеживать лекаря вместо второго танка"
L.CoTankShowPlayerName				= "Показывать имя отслеживаемого игрока"
L.CoTankNameFontSize				= "Размер шрифта имени отслеживаемого игрока"
L.CoTankNameXOffset					= "Смещение имени отслеживаемого игрока по оси X"
L.CoTankNameYOffset					= "Смещение имени отслеживаемого игрока по оси Y"
L.CoTankSlot1Player					= "Первый игрок на позиции второго танка"
L.CoTankSlot2Player					= "Второй игрок на позиции второго танка"
L.CoTankAutomatic					= "Автоматически"
L.RIGHT								= "Справа"
L.LEFT								= "Слева"
L.UP								= "Сверху"
L.DOWN								= "Снизу"
L.CENTER_HORIZONTAL					= "По центру горизонтально"
L.CENTER_VERTICAL					= "По центру вертикально"
...
L.Bar_Height						= "Высота индикатора"
L.Slider_BarOffSetX 				= "Горизонтальный интервал"
L.Slider_BarOffSetY 				= "Вертикальный интервал"
L.Slider_BarWidth 					= "Ширина"
L.Slider_BarScale 					= "Масштаб"
L.Slider_TextOffSetX				= "Смещение текста по оси X"
L.Slider_TextOffSetY				= "Смещение текста по оси Y"
L.BarSaturation						= "Насыщенность полос для коротких интервалов времени (когда увеличенные полосы отключены)"
L.BarBackgroundColor				= "Цвет фона"
L.BarBackgroundOpacity				= "Прозрачность фона"
L.EnableBarBorder					= "Включить границу полосы"
L.BarBorderSize						= "Размер границы"
L.BarBorderColor					= "Цвет границы"
L.MidnightNote						= "Примечание: из-за ограничений API, которые имеются в 'Полночи', DBM не может поддерживать разные цвета начала и конца. Будет использоваться только начальный цвет."
...
L.Panel_TextTimers					= "Текстовые таймеры"
L.Area_TextTimers					= "Текст приближающихся таймеров (данные жёстко заданных полос DBM, даже если полосы не видны)"
L.TextTimersEnable					= "Показывать таймеры перед завершением (по умолчанию отключено)"
L.TextTimersThreshold				= "Показывать, сколько осталось секунд"
L.TextTimersMaxLines				= "Максимум строк"
L.TextTimersMaxNameLength			= "Максимальная длина названия (0: без ограничений)"
L.TextTimersFontSize				= "Размер текста"
L.TextTimersUrgentThreshold			= "Срочность при остатке секунд (0: выключено)"
L.TextTimersUrgentColor				= "Цвет срочности"
L.TextTimersIcon					= "Показывать значок способности"
L.TextTimersInheritBarColor			= "Использовать начальный и конечный цвета полосы"
...
L.VarianceTransparency				= "Прозрачность полосы"
...
L.Bar_Decimal						= "Отображать десятые, когда время меньше"
L.Bar_Alpha							= "Прозрачность"
L.Bar_EnlargeTime					= "Увеличение полосы, когда время меньше"
L.Bar_AppearTime					= "Скрывать полосу, когда время больше"
...
L.ShortTimerText					= "Использовать переименование заклинаний в тексте таймера"
L.HardcodedTimer					= "Использовать жёстко заданные таймеры (когда доступны), чтобы восстановить утерянные функции, такие как переименование заклинаний и отключение ненужных таймеров"
...
L.NoTimers							= "Отключить полосы таймеров DBM (текстовые таймеры останутся видимыми, если включены)"
...
L.SpamBlockNoShowAnnounce			= "Не показывать текст и не воспроизводить звук для каких-либо общих (не акцентированных) оповещений"
...
L.SpamBlockNoTLColors				= "Не задавать цвета временной шкалы Blizzard (примечание: это также отключает цвета полос DBM)"
...
L.PT_Threshold						= "Не воспроизводить звук отсчета таймера атаки/перерыва/пользов. более"
...
L.FilterInterruptNoteName			= "Не показывать, если у оповещения есть счетчик, но Вашего имени нет в пользовательской заметке"--Используется только на боссах, трэш не считается
...
L.Area_TInterruptFilter				= "Параметры фильтра прерываний для трэша"--Используются вышеуказанные 3 строки
...
L.NPAuraSize						= "Размер иконок в пикселях (в квадрате)"
L.NPIcon_BarOffSetX 				= "Смещение иконки по оси X"
L.NPIcon_BarOffSetY 				= "Смещение иконки по оси Y"
L.NPIcon_GrowthDirection 			= "Направление роста иконки"
L.NPIcon_Spacing		 			= "Расстояние между иконками"
L.NPIcon_MaxTextLen		 			= "Максимальная длина текста"
...
L.AuraDurationFontSize				= "Размер шрифта длительности ауры"
L.AuraDurationFontColor				= "Цвет шрифта длительности ауры"
L.AuraDurationEmphasizeAt			= "Выделять длительность ниже"
L.AuraDurationEmphasizeColor		= "Цвет выделенной длительности"
L.AuraIconZoom						= "Масштаб значка"
L.AuraShowDecimalSeconds			= "Показывать десятые доли секунды"
L.AuraDecimalThreshold				= "Показывать десятые доли ниже"
L.AuraStackFontSize					= "Размер шрифта количества стаков"
L.AuraStackFontColor					= "Цвет шрифта количества стаков"
...
L.AuraSortLongDurationFirst			= "Сначала с длинной длительностью"
