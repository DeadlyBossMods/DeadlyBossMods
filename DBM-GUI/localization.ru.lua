...
L.SpamBlockNoBossGUIDs		= "Не показывать иконки индикаторов для таймеров восстановления способностей, использующих гибридные таймеры<br/>(Как индикаторы, так и обычные полосы. Обычно применяется к боссам подземелий)"
...
L.Area_NPGlow				= "Свечение (Примечание: Настройка свечения возможна только при работе DBM с индикаторами здоровья)."
