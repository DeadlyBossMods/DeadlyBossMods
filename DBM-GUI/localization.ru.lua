...
L.ModImportFailed					= "Ошибка импорта: настройки для %s не найдены."
L.ModImportDecodeFailed				= "Не удалось импортировать настройки для %s. Данные могут быть недействительны/повреждены или иметь неподдерживаемый формат."
