...
L.SetPAStackScale					= "Масштаб текста в стаке"--Ползунок. Повторно используется для личного пользования и танками
L.SetPATextScale					= "Масштаб текстового сообщения"--Ползунок
