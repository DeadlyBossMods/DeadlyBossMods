...
L.ModProfileImportFooter			= "Поддерживает профили этого босса или всего подземелья."
L.ModProfileExportFooter			= "Экспортирует только настройки этого босса."
L.AddonProfileImportFooter			= "Поддерживает профили всего подземелья или отдельного босса."
L.AddonProfileExportFooter			= "Экспортирует настройки всего подземелья."
...
L.ImportProfileWrongTypeInstance	= "Это профиль подземелья. Импортируйте его на странице статистики этого подземелья в разделе %s."
...
L.ImportInstanceProfilePrompt		= "Эта строка содержит настройки для всего подземелья. Импортировать все настройки или только настройки для %s?"
L.ImportInstanceProfileAll			= "Импортировать всё"
