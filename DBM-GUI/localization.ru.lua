...
L.ExportSpellRenamesFailed			= "Не удалось экспортировать строку переименований заклинаний. Данные могут быть недействительны/повреждены или в неподдерживаемом формате."
L.ImportSpellRenamesFailed			= "Не удалось импортировать строку переименований заклинаний. Данные могут быть недействительны/повреждены или в неподдерживаемом формате."
