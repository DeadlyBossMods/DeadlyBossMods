...
L.FilterTrashWarnings		= "Фильтровать объявления для трэша в подземельях с соратниками, а также обычных, героических и тривиальных (превышенных по уровню) подземельях"
