...
L.EnableTankPrivateAuraIcons		= "Показывать иконки аур первому игроку, играющему за танка, кроме Вас"--Флажок
L.ShowSecondCoTank					= "Показывать иконки аур второму игроку, играющему за танка, кроме Вас"--Флажок
