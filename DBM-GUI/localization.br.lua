...
L.ShowWAKeys						= "Exibir as teclas WeakAuras ao lado dos nomes dos feitiços para ajudar a escrever WeakAuras usando os gatilhos do boss mod"
...
L.AutologBosses 					= "Registrar automaticamente o conteúdo selecionado usando o registro de combate do Blizzard"
...
L.Panel_HandFilter 					= "Reduzir assistência do DBM"
...
L.SpamSpecRoleTaunt 				= "Filtrar alertas de 'provocar' (Sem texto ou som)"
L.SpamSpecRoleSoak 					= "Filtrar alertas de 'absorver' (Sem texto ou som)"
L.SpamSpecRoleStack 				= "Filtrar alertas de 'acúmulo alto' (Sem texto ou som)"
L.SpamSpecRoleSwitch 				= "Filtrar alertas de 'troca de alvo' e 'adds' (Sem texto ou som)"
L.SpamSpecRoleGTFO 					= "Filtrar alertas de 'GTFO' (Sem texto ou som)"
...
L.AutologBosses				= "Gravar automaticamente o registro de encontro com os chefes utilizando o registro de combate da Blizzard (requer que seja usado /dbm pull antes do chefe <a href=\"http://www.warcraftlogs.com\">|cff3588ffwarcraftlogs.com|r</a> compatibilidade)"
...
L.SelectProfileToCopy		= "Selecionar o perfil à ser copiado"
...
L.Failed = "Falhou"
L.ShowReport = "Mostrar relatório"
L.ShowDiff = "Mostrar diferenças"
L.ShowErrors = "Mostrar erros"
