...
L.Bar_Decimal				= "Decimal exibe abaixo: %d"
L.Bar_Alpha					= "Transparência: %0.1f"
L.Bar_EnlargeTime			= "Barras aumentam abaixo: %d"
L.Bar_AppearTime			= "Barras ocultam acima: %d" --Used for when hidden bars show on the small bar anchor
