...
L.Area_TextTimers = "Texto dos temporizadores próximos (apenas barras ativas do DBM)"
L.TextTimersEnable = "Mostrar temporizadores em texto perto do fim (desativado por padrão)"
...
L.TextTimersLock = "Bloquear posição"
L.TextTimersTest = "Testar / mover texto"
L.TextTimersReset = "Redefinir posição"
