...
L.OTabAbout							= "Sobre"
L.SearchMatch						= "%d correspondência"
...
L.Tools_GearCheck					= "Verificação de equipamento"
L.Tools_BreakTimer					= "Iniciar cronômetro de pausa"
L.Tools_PizzaTimer					= "Iniciar cronômetro genérico"
L.Tools_BrezArea					= "Cronômetro de ressurreição em combate"
L.Tools_ShowBrezFrame				= "Exibir o quadro de cargas de ressurreição em combate durante encontros de chefe e masmorras Mítica+"
--L.Tools_KeystoneArea				= "Keystones"
L.Tools_ShowKeystoneOnComplete		= "Exibir automaticamente o quadro da pedra-chave ao concluir uma masmorra Mítica+"
--L.Tools_AddChallengeTeleports		= "Add teleports to Challenges UI"
L.Tools_OverrideKeystoneSlash		= "Substituir comandos de barra para o quadro da pedra-chave (/keystone, /keys e /key)\n(Nota: O DBM tentará nunca substituir nenhum destes para outros addons se isto não estiver marcado. Entretanto, o DBM irá registrá-los se algum deles estiver sem uso)"
...
L.Reset 							= "Redefinir"
L.Import							= "Importar"
L.ButtonExportMod					= "Exportar módulo"
L.ButtonImportMod					= "Importar módulo"
L.ModProfileImportFooter			= "Permite importar perfis deste encontro ou do módulo inteiro."
L.ModProfileExportFooter			= "Exporta apenas as opções deste encontro."
L.AddonProfileImportFooter			= "Permite importar perfis do módulo inteiro ou de um único encontro."
L.AddonProfileExportFooter			= "Exporta as opções do módulo inteiro."
L.ModImportSuccess					= "Configurações importadas para %s."
L.ModImportFailed				    = "Falha ao importar configurações para %s. Os dados podem estar inválidos/corrompidos ou em um formato não suportado."
L.ImportProfileFailed				= "Falha ao importar a string do perfil. Os dados podem estar inválidos/corrompidos ou em um formato não suportado."
L.ImportProfileWrongType			= "Esta string de importação é para um tipo de perfil diferente."
L.ImportProfileWrongTypeCore		= "Este é um perfil das configurações principais. Importe-o em Opções do DBM > %s > %s."
L.ImportProfileWrongTypeInstance	= "Este é um perfil de módulo. Importe-o na página de estatísticas desse módulo, em %s."
L.ImportProfileWrongTypeBoss		= "Este é um perfil de módulo de chefe. Importe-o no painel de opções desse chefe."
L.ImportProfileUnsupportedVersion	= "Esta string de importação usa uma versão de perfil não suportada."
L.ImportInstanceProfilePrompt		= "Esta string contém configurações para todo o módulo. Importar todas as configurações do módulo ou apenas as de %s?"
L.ImportInstanceProfileAll			= "Importar todas as configurações do módulo"
L.ImportInstanceProfileBoss			= "Apenas este chefe"
L.ProfileImported					= "Perfil importado."
L.PartialProfileImported			= "Perfil importado para %d de %d módulos; os módulos ausentes não foram alterados."
L.Enable							= ENABLE
L.Disable							= DISABLE
L.NoSound							= "Sem som"
...
L.Statistic_BestClear			    = "Limpeza mais rápida:"
...
L.Latency_Text						= "Latência máx. de sincronização"
...
L.Button_ResetWindowSize			= "Redefinir tamanho"
L.Editbox_WindowWidth				= "Largura"
L.Editbox_WindowHeight				= "Altura"
L.UIGroupingOptions					= "Opções de agrupamento de IU (alterá-las requer recarregamento da IU)"
L.GroupOptionsExcludeIcon			= "Excluir as opções de 'Ativar ícone' de serem agrupadas por feitiço (elas serão agrupadas na categoria de 'Ícones')"
L.GroupOptionsExcludePrivateAura	= "Excluir as opções de som 'Aura' de serem agrupadas por feitiço (elas serão agrupadas na categoria de 'Auras')"
...
L.RenameSpellButton				    = "Renomear"
L.RenameSpellHeader				    = "Definir nome personalizado para %s"
L.GTFOAbilityTitle					= "GTFO"
L.GTFOAbilityDescription			= "Qualquer habilidade que cause dano da qual você deve se afastar"
...
L.LogCurrentMythicRaids				= "Raides míticas atuais" -- Retail Only
L.LogCurrentRaids					= "Raides atuais"
L.LogTWRaids						= "Raides de Caminhada Temporal ou Tempo de Crona" -- Retail Only
L.LogTrivialRaids					= "Raides triviais (de baixo nível)"
L.LogCurrentMPlus					= "Masmorras atuais M+" -- Retail Only
L.LogCurrentMythicZero				= "Masmorras atuais Míticas 0" -- Retail Only
L.LogTWDungeons						= "Masmorras de Caminhada Temporal ou Tempo de Crona" -- Retail Only
L.LogCurrentHeroic					= "Masmorras heroicas atuais"
L.LogDelves							= "Imersões atuais"--Retail Only
L.LogChallenges						= "Desafios especiais atuais"--Retail Only
L.Panel_ExtraFeatures				= "Funcionalidades extra"
L.Area_SoundAlerts					= "Opções de som de alerta"
L.LFDEnhance						= "Reproduzir som para checagem de papéis e campo de batahla/procurando grupo"
L.WorldBossNearAlert				= "Reproduzir som quando chefes mundiais perto de você que você precisa estiverem sendo atacados"
L.RLReadyCheckSound					= "Reproduzir um som quando uma verificação de prontidão for realizada"
L.AutoReplySound					= "Reproduzir som de alerta ao receber o sussurro de resposta automática de DBM"
...
L.AFKHealthWarning					= "Reproduzir som de alerta quando você estiver perdendo vida enquanto estiver LDT"
L.HealthWarningLow					= "Reproduzir som de alerta quando você estiver perdendo vida (quando estiver abaixo de 35%) enquanto estiver LDT"
L.EnteringCombatAlert				= "Reproduzir som de alerta ao entrar em combate"
L.LeavingCombatAlert				= "Reproduzir som de alerta ao sair de combate"
L.TimerGeneral 						= "Opções de cronômetro"
L.SKT_Enabled						= "Sempre exibir um cronômetro de sua vitória recorde"
L.ShowRespawn						= "Exibir o cronômetro de reaparência do chefe após uma derrota"
L.ShowQueuePop						= "Exibir o tempo restante para aceitar uma fila"
...
L.AnnounceConsumables				= "Anunciar verificação de consumíveis no início do combate"
...
--L.ShowSpellDescWhenExpanded = "Show spell description when groups are expanded"
L.Panel_Profile						= "Perfil"
L.Area_CreateProfile				= "Criação de perfil"
L.EnterProfileName					= "Nome do perfil"
L.CreateProfile						= "Criar perfil"
L.Area_ApplyProfile					= "Aplicar perfil"
L.SelectProfileToApply				= "Seleciona o perfil a ser aplicado"
L.Area_CopyProfile					= "Copiar perfil"
L.SelectProfileToCopy				= "Seleciona o perfil a ser copiado"
L.Area_DeleteProfile				= "Remover perfil"
L.SelectProfileToDelete				= "Seleciona o perfil a ser removido"
...
L.ModAllReset						= "Redefinir configurações"
L.ModAllStatReset					= "Redefinir estatísticas"
L.ModAllResetConfirm				= "Tem certeza de que deseja redefinir todas as configurações para %s?"
L.ModAllStatResetConfirm			= "Tem certeza de que deseja redefinir todas as estatísticas para %s?"
L.ModProfileDeleteConfirm			= "Tem certeza de que deseja excluir o perfil de módulo %s?"
L.SelectModProfileCopy				= "Copiar configurações de"
L.SelectModProfileCopySound			= "Copiar sons de"
L.SelectModProfileCopyNote          = "Copiar notas de"
L.SelectModProfileDelete			= "Excluir configurações de"
...
L.Area_ImportExportSpellRenames	    = "Importar/exportar renomes de feitiços"
L.ImportExportSpellRenamesInfo	    = "A importação substituirá seus renomes de feitiços atuais, faça por sua conta e risco."
L.ButtonImportSpellRenames			= "Importar renomes de feitiços"
L.ButtonExportSpellRenames			= "Exportar renomes de feitiços"
L.ExportSpellRenamesFailed			= "Falha ao exportar a string de renomes de feitiços. Os dados podem estar inválidos/corrompidos ou em um formato não suportado."
L.ImportSpellRenamesFailed			= "Falha ao importar a string de renomes de feitiços. Os dados podem estar inválidos/corrompidos ou em um formato não suportado."
L.ImportSpellRenamesWrongType		= "Falha ao importar a string de renomes de feitiços. Este tipo de exportação não é de renomes de feitiços."
L.ImportSpellRenamesUnsupportedVersion	= "Falha ao importar a string de renomes de feitiços. Esta versão de exportação não é suportada."
L.SpellRenamesImported				= "Renomes de feitiços importados."
L.ImportErrorOn						= "Sons personalizados ausentes para a configuração: %s"
L.ImportVoiceMissing				= "Pacote de voz ausente: %s"
L.LegacyProfileImportNotice		    = "Perfil legado importado. Este formato está obsoleto; exporte novamente usando o novo formato."
...
L.ShortTextSpellname				= "Usar renomeações de feitiços no texto de anúncio"
L.SpecWarn_FlashFrameRepeat			= "Repetições"
L.SpecWarn_Flash					= "Piscar a tela"
L.SpecWarn_Vibrate					= "Vibrar controle"
L.SpecWarn_FlashRepeat				= "Repetir piscada"
L.SpecWarn_FlashColor				= "Cor %d"
L.SpecWarn_FlashDur					= "Duração"
L.SpecWarn_FlashAlpha				= "Transparência"
...
L.Panel_PrivateAuras				= "Auras"
L.Area_PersonalPrivateAuras			= "Opções de auras pessoais"
L.EnablePersonalPrivateAuraIcons	= "Exibir ícones de auras pessoais na tela"
L.AlwaysShowPlayerAuras				= "Exibir molduras de aura fora de instâncias"
L.AuraMaxDuration					= "Duração máxima da aura rastreada"
L.SetPAGrowDirection				= "Direção de crescimento"
L.SetPAIconScale					= "Escala do ícone"
L.SetPAMaxIcons						= "Máx. de ícones"--Slider, Reused for personal and tank
L.SetPAIconSpacing					= "Espaçamento do ícone"
L.HidePATooltip						= "Desativar dica do feitiço ao passar o cursor"
L.HidePABorder						= "Desativar borda"
L.OnlyBossOrRoleAuras				= "Mostrar apenas auras de chefe/função (Nota: selecionadas pela Blizzard e podem não mostrar todas as auras importantes)"
L.Area_TankPrivateAuras				= "Opções de auras do co-tanque"
L.EnableTankPrivateAuraIcons		= "Exibir ícones de aura para o primeiro jogador com função de tanque que não seja você"
L.CoTankVisibility					= "Mostrar co-tanque quando:"
L.CoTankVisibilityAuto				= "Em especialização de tanque"
L.CoTankVisibilityAlways				= "Sempre"
L.CoTankVisibilityNever				= "Nunca"
L.ShowSecondCoTank					= "Exibir ícones de aura para o segundo jogador com função de tanque que não seja você"--checkbox
L.CoTankUseHealerInFiveMan			= "Em masmorras de 5 jogadores, rastrear automaticamente o curador no lugar do segundo tanque"
L.CoTankShowPlayerName					= "Mostrar nome do jogador rastreado"
L.CoTankNameFontSize					= "Tamanho da fonte do nome do jogador rastreado"
L.CoTankNameXOffset					= "Deslocamento X do nome do jogador rastreado"
L.CoTankNameYOffset					= "Deslocamento Y do nome do jogador rastreado"
L.CoTankSlot1Player					= "Jogador do primeiro espaço de co-tanque"
L.CoTankSlot2Player					= "Jogador do segundo espaço de co-tanque"
L.CoTankAutomatic					= "Automático"
L.RIGHT								= "Direita"
L.LEFT								= "Esquerda"
L.UP								= "Cima"
L.DOWN								= "Baixo"
L.CENTER_HORIZONTAL					= "Centralizado horizontalmente"
L.CENTER_VERTICAL					= "Centralizado verticalmente"
...
L.SelectChatFrameInfoSelectNow		= "Clique para selecionar %s."
...
L.ShowGuildMessagesPlus				= "Também exibir mensagens de início/vitória/derrota de Mítica+ para grupos da guilda (requer a opção de raide)"
...
L.EventMusicCombined				= "Permitir todas as opções de música nas seleções de masmorra e encontro (requer recarregar IU)"
...
L.Bar_Height						= "Altura da barra"
L.Slider_BarOffSetX 				= "Espaçamento horizontal"
L.Slider_BarOffSetY 				= "Espaçamento vertical"
L.Slider_BarWidth 					= "Largura da barra"
L.Slider_BarScale 					= "Escala da barra"
L.BarSaturation						= "Saturação da barra para cronômetros pequenos"
L.BarBackgroundColor                = "Cor do fundo"
L.BarBackgroundOpacity              = "Opacidade do fundo"
L.EnableBarBorder                   = "Ativar borda da barra"
L.BarBorderSize                     = "Tamanho da borda"
L.BarBorderColor                    = "Cor da borda"
L.Slider_TextOffSetX                = "Deslocamento do texto X"
L.Slider_TextOffSetY                = "Deslocamento do texto Y"
...
L.CBTAdd							= "Adds em breve"
L.CBTAOE							= "Feitiço AOE"
L.CBTTargeted						= "Feitiço de alvo"
...
L.PrivateAuraSoundCombatLockdown	= "Os sons de aura não podem ser alterados em combate."
L.ColorDropGeneric					= "Genérico"
L.ColorDrop1						= "Cor 1"
L.ColorDrop2						= "Cor 2"
L.ColorDrop3						= "Cor 3"
L.ColorDrop4						= "Cor 4"
...
L.CVoiceOne							= "Contagem regressiva 1"
L.CVoiceTwo							= "Contagem regressiva 2"
L.CVoiceThree						= "Contagem regressiva 3"
L.Panel_Appearance	 				= "Aparência da barra"
L.Panel_Behavior	 				= "Comportamento da barra"
L.Panel_TextTimers					= "Temporizadores em texto"
L.Area_TextTimers					= "Texto dos temporizadores próximos (dados das barras do DBM codificadas diretamente, mesmo que não estejam visíveis)"
L.TextTimersEnable					= "Mostrar temporizadores em texto perto do fim"
L.TextTimersThreshold				= "Mostrar com segundos restantes"
L.TextTimersMaxLines				= "Máximo de linhas"
L.TextTimersMaxNameLength			= "Comprimento máximo do nome (0: ilimitado)"
L.TextTimersFontSize				= "Tamanho do texto"
L.TextTimersUrgentThreshold			= "Urgente abaixo de segundos (0: desligado)"
L.TextTimersUrgentColor				= "Cor de urgência"
L.TextTimersIcon					= "Mostrar ícone da habilidade"
L.TextTimersInheritBarColor			= "Herdar as cores inicial e final da barra"
L.TextTimersIconPosition			= "Posição do ícone"
L.TextTimersIconBoth				= "Ícones dos dois lados"
...
L.VarianceTransparency				= "Transparência das barras"
...
L.Bar_Decimal						= "Decimal exibe abaixo"
L.Bar_Alpha							= "Transparência"
L.Bar_EnlargeTime					= "Barras aumentam abaixo"
L.Bar_AppearTime					= "Barras ocultam acima" --Used for when hidden bars show on the small bar anchor
L.Bar_HideLongBars					= "Ocultar barras até ficarem abaixo do limite"
L.BarSpark							= "Barra faísca"
L.BarFlash							= "Piscar quando estiver para expirar"
...
L.ShortTimerText					= "Usar renomeações de feitiços no texto do cronômetro"
...
L.NoTimers							= "Desativar as barras de cronômetro do DBM (os cronômetros em texto continuam visíveis se ativados)"
...
L.SpamBlockNoSpecWarnSound			= "Não reproduzir sons de anúncio especial"
L.Area_Private_Aura_Features		= "Opçoes de auras"
L.SpamBlockNoPrivateAuraSound		= "Não registrar sons de auras"
L.SpamBlockNoPrivateAuraFrame		= "Não exibir quadros de auras"
...
L.SpamBlockNoTLColors				= "Não definir as cores da linha do tempo da Blizzard (Nota: isso também desativa as cores das barras do DBM)"
...
L.PT_Threshold						= "Não reproduzir o áudio do cronômetro acima"
...
--L.HideBossKill = "Hide boss kill toasts"
--L.HideVaultUnlock = "Hide vault unlock toasts"
...
L.HideWatchFrame					= "Ocultar quadro de acompanhamento (objetivos) durante combate contra chefes se nenhum feito estiver sendo rastreado e se não estiver em uma Mítica+"
...
L.NPAuraSize						= "Tamanho em pixels do ícone"
L.NPIcon_BarOffSetX 				= "Deslocamento do ícone X"
L.NPIcon_BarOffSetY 				= "Deslocamento do ícone Y"
L.NPIcon_GrowthDirection 			= "Direção de crescimento dos ícones"
L.NPIcon_Spacing		 			= "Espaçamento dos ícones"
L.NPIcon_MaxTextLen		 			= "Comprimento máx. do texto"
L.NPIconAnchorPoint		 			= "Ponto de ancoragem do ícone"
L.NPDemo							= "Teste (esteja próximo às placas de nome)"
L.FontTypeTimer						= "Fonte do cronômetro"
L.FontTypeText						= "Fonte do texto"
L.AuraDurationFontSize				= "Tamanho da fonte da duração da aura"
L.AuraDurationFontColor				= "Cor da fonte da duração da aura"
L.AuraDurationEmphasizeAt			= "Destacar duração abaixo de"
L.AuraDurationEmphasizeColor		= "Cor da duração destacada"
L.AuraIconZoom						= "Zoom do ícone"
L.AuraShowDecimalSeconds			= "Exibir segundos decimais"
L.AuraDecimalThreshold				= "Exibir decimais abaixo de"
L.AuraStackFontSize					= "Tamanho da fonte de acúmulos da aura"
L.AuraStackFontColor					= "Cor da fonte de acúmulos da aura"
L.AuraShowStacks					= "Exibir texto de acúmulos"
L.AuraShowDispelBorder				= "Exibir borda de dissolução"
L.AuraShowCooldownSwipe				= "Exibir varredura de recarga"
L.AuraSortOrder					= "Ordem das auras"
L.AuraSortDefault					= "Ordenação padrão da Blizzard"
L.AuraSortShortDurationFirst		= "Menor duração primeiro"
L.AuraSortLongDurationFirst		= "Maior duração primeiro"
L.Area_NPGlow						= "Iluminação (Nota: configura a iluminação apenas quando não está usando o Plater.)"
L.NPIcon_GlowBehavior				= "Iluminação dos ícones de recarga"
L.NPIcon_CastGlowBehavior			= "Iluminação dos ícones de lançamento"
...
L.NPIcon_GlowTypeCD					= "Iluminação de recarga"
L.NPIcon_GlowTypeCast				= "Iluminação de lançamento"
...
--L.DisabledForDropdown = "Choose boss mod(s) disable is sent to"
--L.DiabledForBoth = "Disable above features for both DBM and BW"
--L.DiabledForDBM = "Disable above features for only DBM users"
--L.DiabledForBW = "Disable above features for only BW users"
