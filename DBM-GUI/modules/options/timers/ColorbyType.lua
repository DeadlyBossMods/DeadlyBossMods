...
local color1Type1 = BarColors:CreateColorSelect(L.BarStartColorAdd, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.StartColorAR, DBT.DefaultOptions.StartColorAG, DBT.DefaultOptions.StartColorAB)
end)
local color2Type1 = BarColors:CreateColorSelect(L.BarEndColorAdd, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.EndColorAR, DBT.DefaultOptions.EndColorAG, DBT.DefaultOptions.EndColorAB)
end)
...
local color1Type2 = BarColors:CreateColorSelect(L.BarStartColorAOE, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.StartColorAER, DBT.DefaultOptions.StartColorAEG, DBT.DefaultOptions.StartColorAEB)
end)
local color2Type2 = BarColors:CreateColorSelect(L.BarEndColorAOE, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.EndColorAER, DBT.DefaultOptions.EndColorAEG, DBT.DefaultOptions.EndColorAEB)
end)
...
local color1Type3 = BarColors:CreateColorSelect(L.BarStartColorDebuff, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.StartColorDR, DBT.DefaultOptions.StartColorDG, DBT.DefaultOptions.StartColorDB)
end)
local color2Type3 = BarColors:CreateColorSelect(L.BarEndColorDebuff, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.EndColorDR, DBT.DefaultOptions.EndColorDG, DBT.DefaultOptions.EndColorDB)
end)
...
local color1Type4 = BarColors:CreateColorSelect(L.BarStartColorInterrupt, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.StartColorIR, DBT.DefaultOptions.StartColorIG, DBT.DefaultOptions.StartColorIB)
end)
local color2Type4 = BarColors:CreateColorSelect(L.BarEndColorInterrupt, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.EndColorIR, DBT.DefaultOptions.EndColorIG, DBT.DefaultOptions.EndColorIB)
end)
...
local color1Type5 = BarColors:CreateColorSelect(L.BarStartColorRole, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.StartColorRR, DBT.DefaultOptions.StartColorRG, DBT.DefaultOptions.StartColorRB)
end)
local color2Type5 = BarColors:CreateColorSelect(L.BarEndColorRole, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.EndColorRR, DBT.DefaultOptions.EndColorRG, DBT.DefaultOptions.EndColorRB)
end)
...
local color1Type6 = BarColors:CreateColorSelect(L.BarStartColorPhase, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.StartColorPR, DBT.DefaultOptions.StartColorPG, DBT.DefaultOptions.StartColorPB)
end)
local color2Type6 = BarColors:CreateColorSelect(L.BarEndColorPhase, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.EndColorPR, DBT.DefaultOptions.EndColorPG, DBT.DefaultOptions.EndColorPB)
end)
...
local color1Type7 = ImpBarColors:CreateColorSelect(L.BarStartColorUI, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.StartColorUIR, DBT.DefaultOptions.StartColorUIG, DBT.DefaultOptions.StartColorUIB)
end)
local color2Type7 = ImpBarColors:CreateColorSelect(L.BarEndColorUI, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.EndColorUIR, DBT.DefaultOptions.EndColorUIG, DBT.DefaultOptions.EndColorUIB)
end)
...
local color1Type8 = ImpBarColors:CreateColorSelect(L.BarStartColorI2, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.StartColorI2R, DBT.DefaultOptions.StartColorI2G, DBT.DefaultOptions.StartColorI2B)
end)
local color2Type8 = ImpBarColors:CreateColorSelect(L.BarEndColorI2, function(_, r, g, b)
	...
	self:SetColorRGB(DBT.DefaultOptions.EndColorI2R, DBT.DefaultOptions.EndColorI2G, DBT.DefaultOptions.EndColorI2B)
end)
