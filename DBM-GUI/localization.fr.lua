...
L.ModImportFailed					= "Échec de l'importation : aucun réglage trouvé pour %s."
L.ModImportDecodeFailed				= "Échec de l'importation des réglages pour %s. Les données peuvent être invalides/corrompues ou provenir d'un format non pris en charge."
