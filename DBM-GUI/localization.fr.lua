...
L.ModProfileImportFooter			= "Prend en charge les profils de ce boss ou de toute l'instance."
L.ModProfileExportFooter			= "Exporte uniquement les options de ce boss."
L.AddonProfileImportFooter			= "Prend en charge les profils de toute l'instance ou d'un seul boss."
L.AddonProfileExportFooter			= "Exporte les options de toute l'instance."
...
L.ImportProfileWrongTypeInstance	= "Ceci est un profil d'instance. Importez-le depuis la page de statistiques de cette instance, sous %s."
...
L.ImportInstanceProfilePrompt		= "Cette chaîne contient les réglages de toute l'instance. Importer tous les réglages ou seulement ceux de %s ?"
L.ImportInstanceProfileAll			= "Tout importer"
