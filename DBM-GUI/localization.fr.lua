...
L.Tools_GearCheck					= "Vérification d'équipement"
L.Tools_BreakTimer					= "Démarrer le chronomètre de pause"
L.Tools_PizzaTimer					= "Démarrer le chronomètre générique"
L.Tools_BrezArea					= "Chronomètre de résurrection de combat"
L.Tools_ShowBrezFrame				= "Afficher le cadre des charges de résurrection de combat pendant les rencontres de boss et les donjons Mythique+"
--L.Tools_KeystoneArea				= "Keystones"
L.Tools_ShowKeystoneOnComplete		= "Afficher automatiquement le cadre de clé mythique lorsqu’un donjon Mythique+ est terminé"
--L.Tools_AddChallengeTeleports		= "Add teleports to Challenges UI"
L.Tools_OverrideKeystoneSlash		= "Déroger aux commandes slash du cadre de clé mythique (/keystone, /keys et /key)\n(Remarque : DBM tentera de ne jamais déroger à ces commandes pour d’autres addons si cette option n’est pas cochée. Cependant, DBM les enregistrera si l’une d’elles n’est pas utilisée)"
...
L.ModProfileImportFooter			= "Prend en charge les profils de ce boss ou de tout le module."
L.ModProfileExportFooter			= "Exporte uniquement les options de ce boss."
L.AddonProfileImportFooter			= "Prend en charge les profils de tout le module ou d'un seul boss."
L.AddonProfileExportFooter			= "Exporte les options de tout le module."
L.ModImportSuccess					= "Réglages importés pour %s."
L.ModImportFailed				    = "Échec de l'importation des réglages pour %s. Les données peuvent être invalides/corrompues ou provenir d'un format non pris en charge."
L.ImportProfileFailed				= "Échec de l'importation du profil. Les données peuvent être invalides/corrompues ou provenir d'un format non pris en charge."
L.ImportProfileWrongType			= "Cette chaîne d'importation correspond à un autre type de profil."
L.ImportProfileWrongTypeCore		= "Ceci est un profil de réglages du core. Importez-le via Options DBM > %s > %s."
L.ImportProfileWrongTypeInstance	= "Ceci est un profil de module. Importez-le depuis la page de statistiques de ce module, sous %s."
L.ImportProfileWrongTypeBoss		= "Ceci est un profil de module de boss. Importez-le depuis le panneau d'options de ce boss."
L.ImportProfileUnsupportedVersion	= "Cette chaîne d'importation utilise une version de profil non prise en charge."
L.ImportInstanceProfilePrompt		= "Cette chaîne contient les réglages de tout le module. Importer tous les réglages du module ou seulement ceux de %s ?"
L.ImportInstanceProfileAll			= "Importer tous les réglages du module"
L.ImportInstanceProfileBoss			= "Ce boss uniquement"
L.ProfileImported					= "Profil importé."
L.PartialProfileImported			= "Profil importé pour %d modules sur %d ; les modules absents sont restés inchangés."
L.Enable							= "Activer"
...
L.Latency_Text						= "Seuil de latence max. pour synchro"
...
L.Button_ResetWindowSize			= "Réinit. la taille"
L.Editbox_WindowWidth				= "Largeur"
L.Editbox_WindowHeight				= "Hauteur"
...
L.GroupOptionsExcludePrivateAura	= "Exclure les options sonores des 'Auras' du regroupement par sort (elles seront regroupées dans la catégorie 'Auras' à la place)"
...
L.RenameSpellHeader				    = "Définir un nom personnalisé pour %s"
L.GTFOAbilityTitle					= "GTFO"
L.GTFOAbilityDescription			= "Toute capacité qui inflige des dégâts et dont vous devez vous éloigner"
...
L.LFDEnhance						= "Jouer le son d'appel lors des vérifications de rôle et des files d'attente"
L.WorldBossNearAlert				= "Jouer le son d'appel quand un boss mondial proche de vous est engagé"
L.RLReadyCheckSound					= "Jouer le son quand un appel est lancé par le chef de raid"
...
L.AFKHealthWarning					= "Jouer un son d'alerte si vous perdez de la vie alors que vous êtes ABS"
...
L.ShowQueuePop						= "Décompte du temps restant pour accepter une file d'attente"
...
L.AnnounceConsumables				= "Annoncer la vérification des consommables au début du combat"
...
L.EnterProfileName					= "Nom pour le nouveau profil"
L.CreateProfile						= "Créer un profil"
L.Area_ApplyProfile					= "Appliquer le profil"
L.SelectProfileToApply				= "Sélectionner le profil à appliquer"
L.Area_CopyProfile					= "Copier le profil"
L.SelectProfileToCopy				= "Sélectionner le profil à copier"
L.Area_DeleteProfile				= "Supprimer le profil"
...
L.ModAllReset						= "Réinitialiser les réglages"
L.ModAllStatReset					= "Réinitialiser les statistiques"
L.ModAllResetConfirm				= "Êtes-vous sûr de vouloir réinitialiser tous les réglages pour %s?"
L.ModAllStatResetConfirm			= "Êtes-vous sûr de vouloir réinitialiser toutes les statistiques pour %s?"
L.ModProfileDeleteConfirm			= "Êtes-vous sûr de vouloir supprimer le profil de module %s ?"
L.SelectModProfileCopy				= "Copier les réglages depuis"
L.SelectModProfileCopySound			= "Copier les sons depuis"
L.SelectModProfileCopyNote			= "Copier les notes depuis"
...
L.Area_ImportExportSpellRenames	    = "Importer/Exporter les renommages de sorts"
L.ImportExportSpellRenamesInfo	    = "L'importation écrasera vos renommages de sorts actuels, faites-le à vos risques et périls."
L.ButtonImportSpellRenames			= "Importer les renommages de sorts"
L.ButtonExportSpellRenames			= "Exporter les renommages de sorts"
L.ExportSpellRenamesFailed			= "Échec de l'exportation de la chaîne de renommages de sorts. Les données peuvent être invalides/corrompues ou dans un format non pris en charge."
L.ImportSpellRenamesFailed			= "Échec de l'importation de la chaîne de renommages de sorts. Les données peuvent être invalides/corrompues ou dans un format non pris en charge."
L.ImportSpellRenamesWrongType		= "Échec de l'importation de la chaîne de renommages de sorts. Ce type d'export n'est pas un export de renommages de sorts."
L.ImportSpellRenamesUnsupportedVersion	= "Échec de l'importation de la chaîne de renommages de sorts. Cette version d'export n'est pas prise en charge."
L.SpellRenamesImported				= "Renommages de sorts importés."
L.ImportErrorOn						= "Son personnalisé manquant pour : %s"
L.ImportVoiceMissing				= "Paquet de voix manquant : %s"
L.LegacyProfileImportNotice		    = "Profil hérité importé. Ce format est obsolète ; veuillez le réexporter au nouveau format."
...
L.Warn_Duration						= "Durée de l'alerte"
L.None								= "Aucun"
L.Random							= "Aléatoire"
L.Outline							= "Simple"
...
L.ShortTextSpellname				= "Utiliser les renommages de sorts dans le texte des annonces"
L.SpecWarn_FlashFrameRepeat			= "Répétitions"
L.SpecWarn_Flash					= "Clignoter l'écran"
L.SpecWarn_Vibrate					= "Manette vibrante"
L.SpecWarn_FlashRepeat				= "Répéter le clignotement"
L.SpecWarn_FlashColor				= "Couleur %d"
L.SpecWarn_FlashDur					= "Durée"
L.SpecWarn_FlashAlpha				= "Transparence"
...
L.CoTankVisibilityAuto				= "En spécialisation tank"
L.CoTankVisibilityAlways				= "Toujours"
L.CoTankVisibilityNever				= "Jamais"
L.ShowSecondCoTank					= "Afficher les icônes d’aura du second joueur ayant le rôle de tank qui n’est pas vous"--checkbox
L.CoTankUseHealerInFiveMan			= "Dans les donjons à 5 joueurs, suivre automatiquement le soigneur à la place du second tank"
L.CoTankShowPlayerName					= "Afficher le nom du joueur suivi"
L.CoTankNameFontSize					= "Taille de police du nom du joueur suivi"
L.CoTankNameXOffset					= "Décalage X du nom du joueur suivi"
L.CoTankNameYOffset					= "Décalage Y du nom du joueur suivi"
L.CoTankSlot1Player					= "Joueur du premier emplacement de co-tank"
L.CoTankSlot2Player					= "Joueur du second emplacement de co-tank"
L.CoTankAutomatic					= "Automatique"
L.RIGHT								= "Droite"
L.LEFT								= "Gauche"
L.UP								= "Haut"
L.DOWN								= "Bas"
...
L.Tab_GeneralMessages 				= "Messages de discussion"
...
L.Slider_BarOffSetX 				= "Espacement horizontal"
L.Slider_BarOffSetY 				= "Espacement vertical"
L.Slider_BarWidth 					= "Largeur"
L.Slider_BarScale 					= "Échelle"
L.BarSaturation						= "Saturation pour les petits décomptes"
L.BarBackgroundColor                = "Couleur de fond"
L.BarBackgroundOpacity              = "Opacité du fond"
L.EnableBarBorder                   = "Activer la bordure de la barre"
L.BarBorderSize                     = "Taille de la bordure"
L.BarBorderColor                    = "Couleur de la bordure"
L.Slider_TextOffSetX                = "Décalage du texte X"
L.Slider_TextOffSetY                = "Décalage du texte Y"
...
L.CBTAdd							= "Adds imminents"
L.CBTAOE							= "Sort d'AOE"
L.CBTTargeted						= "Sort ciblé"
L.CBTInterrupt						= "Sort interruptible"
L.CBTRole							= "Sort de rôle spécifique"
L.CBTPhase							= "Phase"
...
L.SAThree							= "Son 3"
L.SAFour							= "Son 4"
L.PrivateAuraSoundCombatLockdown	= "Les sons d'aura ne peuvent pas être modifiés en combat."
L.ColorDropGeneric					= "Générique"
L.ColorDrop1						= "Couleur 1"
L.ColorDrop2						= "Couleur 2"
L.ColorDrop3						= "Couleur 3"
L.ColorDrop4						= "Couleur 4"
L.ColorDrop5						= "Couleur 5"
L.ColorDrop6						= "Couleur 6"
L.CDDImportant1						= "Important 1"
L.CDDImportant2						= "Important 2"
L.CVoiceOne							= "Décompte 1"
L.CVoiceTwo							= "Décompte 2"
L.CVoiceThree						= "Décompte 3"
L.Panel_Appearance	 				= "Apparence des barres"
L.Panel_Behavior	 				= "Comportement des barres"
L.Panel_TextTimers = "Décomptes textuels"
L.Area_TextTimers = "Décomptes imminents (barres DBM activées uniquement)"
L.TextTimersEnable = "Afficher les décomptes proches de la fin (désactivé par défaut)"
L.TextTimersThreshold = "Afficher à partir de secondes restantes"
L.TextTimersMaxLines = "Nombre maximal de lignes"
L.TextTimersMaxNameLength = "Longueur maximale du nom (0 : illimitée)"
L.TextTimersFontSize = "Taille du texte"
L.TextTimersUrgentThreshold = "Urgent sous ce nombre de secondes (0 : désactivé)"
...
L.TextTimersLock = "Verrouiller la position"
L.TextTimersTest = "Tester / déplacer le texte"
L.TextTimersReset = "Réinitialiser la position"
...
L.VarianceTransparency				= "Transparence des barres"
...
L.Bar_Decimal						= "Décimales affichées à partir"
L.Bar_Alpha							= "Transparence"
L.Bar_EnlargeTime					= "Barres agrandies à partir"
L.Bar_AppearTime					= "Barres cachées au-dessus" --Used for when hidden bars show on the small bar anchor
...
L.ShortTimerText					= "Utiliser les renommages de sorts dans le texte des chronomètres"
...
L.NoTimers							= "Désactiver les barres de chronomètre DBM (les chronomètres textuels restent visibles si activés)"
...
L.Area_Private_Aura_Features		= "Options des auras"
L.SpamBlockNoPrivateAuraSound		= "Ne pas enregistrer les sons des auras"
L.SpamBlockNoPrivateAuraFrame		= "Ne pas afficher les cadres d'auras"
...
L.SpamBlockNoTLColors				= "Ne pas définir les couleurs de la ligne temporelle de Blizzard (Remarque : cela désactive aussi les couleurs des barres DBM)"
...
L.PT_Threshold						= "Pas de son du décompte au-delà"
...
L.NPAuraSize						= "Taille des pixels de l'aura (carré)"
L.NPIcon_BarOffSetX 				= "Décalage X de l'icône"
L.NPIcon_BarOffSetY 				= "Décalage Y de l'icône"
L.NPIcon_GrowthDirection 			= "Direction de croissance de l'icône"
L.NPIcon_Spacing		 			= "Espacement de l'icône"
L.NPIcon_MaxTextLen		 			= "Longueur max. du texte"
L.NPIconAnchorPoint		 			= "Point d'ancrage de l'icône"
L.NPDemo							= "Test (Soyez près des plaques de nom)"
L.FontTypeTimer						= "Police du chronomètre"
L.FontTypeText						= "Police du texte"
L.AuraDurationFontSize				= "Taille de la police de durée de l'aura"
L.AuraDurationFontColor				= "Couleur de la police de durée de l'aura"
L.AuraDurationEmphasizeAt			= "Mettre en évidence la durée sous"
L.AuraDurationEmphasizeColor		= "Couleur de durée mise en évidence"
L.AuraIconZoom						= "Zoom de l'icône"
L.AuraShowDecimalSeconds			= "Afficher les secondes décimales"
L.AuraDecimalThreshold				= "Afficher les décimales sous"
L.AuraStackFontSize					= "Taille de la police de charges de l'aura"
L.AuraStackFontColor					= "Couleur de la police de charges de l'aura"
L.AuraShowStacks					= "Afficher le texte des charges"
L.AuraShowDispelBorder				= "Afficher la bordure de dissipation"
L.AuraShowCooldownSwipe				= "Afficher le balayage de recharge"
L.AuraSortOrder					= "Ordre de tri des auras"
L.AuraSortDefault					= "Tri Blizzard par défaut"
L.AuraSortShortDurationFirst		= "Durée la plus courte d’abord"
L.AuraSortLongDurationFirst		= "Durée la plus longue d’abord"
L.Area_NPGlow						= "Illumination (Remarque : configure uniquement l'illumination lorsqu'on n'utilise pas Plater)"
L.NPIcon_GlowBehavior				= "Illumination de l'icône"
L.NPIcon_CastGlowBehavior			= "Illumination de l'icône d'incantation"
...
L.NPIcon_GlowTypeCD					= "Illumination de l'icône de recharge"
L.NPIcon_GlowTypeCast				= "Illumination d'incantation"
