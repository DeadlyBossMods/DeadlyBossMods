...
L.Area_TextTimers					= "Texte des décomptes imminents (données des barres DBM codées en dur, même si elles ne sont pas visibles)"
L.TextTimersEnable					= "Afficher les décomptes proches de la fin"
...
L.TextTimersInheritBarColor			= "Reprendre les couleurs de début et de fin de la barre"
