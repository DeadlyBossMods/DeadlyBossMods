...
L.Tools_KeystoneArea				= "쐐기돌"
L.Tools_ShowKeystoneOnComplete		= "신화+가 완료되면 쐐기돌 창 자동 표시"
L.Tools_AddChallengeTeleports		= "평점 UI에 순간이동 주문 추가"
...
L.Reset 							= "초기화"
L.Import							= "가져오기"
L.ButtonExportMod					= "모듈 내보내기"
L.ButtonImportMod					= "모듈 가져오기"
L.ModProfileImportFooter			= "이 보스나 전체 모듈의 프로필을 가져올 수 있습니다."
L.ModProfileExportFooter			= "이 보스의 설정만 내보냅니다."
L.AddonProfileImportFooter			= "전체 모듈 또는 단일 보스의 프로필을 가져올 수 있습니다."
L.AddonProfileExportFooter			= "전체 모듈 설정을 내보냅니다."
L.ModImportSuccess					= "%s의 설정을 가져왔습니다."
L.ModImportFailed				    = "%s의 설정을 가져오지 못했습니다. 데이터가 잘못/손상되었거나 지원되지 않는 형식일 수 있습니다."
L.ImportProfileFailed				= "프로필 문자열을 가져오지 못했습니다. 데이터가 잘못/손상되었거나 지원되지 않는 형식일 수 있습니다."
L.ImportProfileWrongType			= "이 가져오기 문자열은 다른 프로필 유형입니다."
L.ImportProfileWrongTypeCore		= "핵심 설정 프로필입니다. DBM 설정 > %s > %s에서 가져오세요."
L.ImportProfileWrongTypeInstance	= "모듈 프로필입니다. %s의 해당 모듈 통계 페이지에서 가져오세요."
L.ImportProfileWrongTypeBoss		= "보스 모듈 프로필입니다. 해당 보스의 모듈 설정 패널에서 가져오세요."
L.ImportProfileUnsupportedVersion	= "이 가져오기 문자열은 지원되지 않는 프로필 버전을 사용하고 있습니다."
L.ImportInstanceProfilePrompt		= "이 문자열에는 전체 모듈 설정을 포함하고 있습니다. 모든 모듈 설정을 가져올까요 아니면 %s의 설정만 가져올까요?"
L.ImportInstanceProfileAll			= "모든 모듈 설정 가져오기"
L.ImportInstanceProfileBoss			= "이 보스만"
L.ProfileImported					= "프로필을 가져왔습니다."
L.PartialProfileImported			= "%d/%d 모듈의 프로필을 가져왔으며, 없는 모듈은 변경하지 않았습니다."
...
L.Latency_Text						= "동기화 신호를 보낼 최대 지연시간 설정"
...
L.ShowWAKeys						= "보스 모드 활성 조건을 사용하는 WeakAuras 제작 지원을 위해 주문 이름 옆에 주문 키를 표시합니다."
...
L.Area_CombatAlertsRetail			= "전투 경고 설정 (필드 전용)"
...
L.ModAllResetConfirm				= "%s의 모든 설정을 초기화할까요?"
L.ModAllStatResetConfirm			= "%s의 모든 통계를 초기화할까요?"
L.ModProfileDeleteConfirm			= "모듈 프로필 %s|1을;를; 삭제할까요?"
...
L.Area_ImportExportSpellRenames			= "변경된 주문 이름 가져오기/내보내기"
L.ImportExportSpellRenamesInfo			= "가져오기를 하면 현재 변경된 주문 이름을 덮어쓰게 되니 사용에 주의하세요."
L.ButtonImportSpellRenames				= "변경된 주문 이름 가져오기"
L.ButtonExportSpellRenames				= "변경된 주문 이름 내보내기"
L.ExportSpellRenamesFailed				= "변경된 주문 이름 문자열을 내보내지 못했습니다. 데이터가 잘못/손상되었거나 지원되지 않는 형식일 수 있습니다."
L.ImportSpellRenamesFailed				= "변경된 주문 이름 문자열을 가져오지 못했습니다. 데이터가 잘못/손상되었거나 지원되지 않는 형식일 수 있습니다."
L.ImportSpellRenamesWrongType			= "변경된 주문 이름 문자열을 가져오지 못했습니다. 이 내보내기 유형은 변경된 주문 이름의 것이 아닙니다."
L.ImportSpellRenamesUnsupportedVersion		= "변경된 주문 이름 문자열을 가져오지 못했습니다. 이 내보내기 버전은 지원되지 않습니다."
L.SpellRenamesImported					= "변경된 주문 이름을 가져왔습니다."

L.ImportErrorOn						= "프로필 설정에 빠져있는 사용자 지정 효과음: %s"
L.ImportVoiceMissing				= "보이스팩 없음: %s"
L.LegacyProfileImportNotice			= "구형 프로필을 가져왔습니다. 이 형식은 앞으로 사용할 수 없으므로 새 형식으로 다시 내보내기를 해주세요."
...
L.ShortTextSpellname				= "알림 텍스트에 변경한 주문 이름 사용"
L.SpecWarn_FlashFrameRepeat			= "점멸회 반복"
L.SpecWarn_Flash					= "화면 점멸"
L.SpecWarn_Vibrate					= "컨트롤러 진동"
L.SpecWarn_FlashRepeat				= "점멸 효과 반복"
L.SpecWarn_FlashColor				= "점멸 색상 %d"
L.SpecWarn_FlashDur					= "점멸 지속시간"
L.SpecWarn_FlashAlpha				= "점멸 투명도"
...
L.AlwaysShowPlayerAuras				= "인스턴스 밖에서도 오라 프레임 표시"--checkbox
...
L.SetPAIconSpacing					= "아이콘 간격"--Slider, Reused for personal and tank
L.HidePATooltip						= "주문 툴팁 끄기"--checkbox
L.HidePABorder						= "테두리 끄기"--checkbox
L.OnlyBossOrRoleAuras				= "보스/역할 오라만 표시 (블리자드가 선별한 것으로 중요한 오라가 전부 표시되지는 않습니다)"
L.Area_TankPrivateAuras				= "다른 탱커 디버프 오라 설정"
L.EnableTankPrivateAuraIcons		= "나를 제외한 1번 탱커의 오라 아이콘 표시"--checkbox
L.CoTankVisibility					= "다른 탱커 표시 조건:"
L.CoTankVisibilityAuto				= "탱커 전문화일 때"
L.CoTankVisibilityAlways				= "항상"
L.CoTankVisibilityNever				= "안 함"
L.ShowSecondCoTank					= "나를 제외한 2번 탱커의 오라 아이콘 표시"--checkbox
L.CoTankUseHealerInFiveMan			= "5인 던전에선 2번 탱커 대신 힐러를 자동으로 추적"
L.CoTankShowPlayerName					= "추적된 플레이어 이름 표시"
L.CoTankNameFontSize					= "추적된 플레이어 이름 글꼴 크기"
L.CoTankNameXOffset					= "추적된 플레이어 이름 X 위치 조정"
L.CoTankNameYOffset					= "추적된 플레이어 이름 Y 위치 조정"
L.CoTankSlot1Player					= "1번 다른 탱커 슬롯의 플레이어"
L.CoTankSlot2Player					= "2번 다른 탱커 슬롯의 플레이어"
L.CoTankAutomatic					= "자동"
L.RIGHT								= "오른쪽"
L.LEFT								= "왼쪽"
L.UP								= "위쪽"
L.DOWN								= "아래쪽"
L.CENTER_HORIZONTAL					= "가로 중앙"
L.CENTER_VERTICAL					= "세로 중앙"
...
L.WorldBuffAlert					= "내 서버에서 월드 버프 NPC 대사가 시작되면 알림 메시지 표시"
...
L.Area_VoicePackReplace				= "음성팩으로 교체 설정 (사용시 음성팩의 효과음이 출력되며 기본 효과음을 대체)"
L.VPReplaceNote						= "알아두기: 음성팩은 당신이 직접 지정한 경고 효과음을 절대 변경하거나 삭제하지 않습니다.\n이 경우 음성팩으로 교체되는 효과음들은 출력되지 않을 것입니다."
L.ReplacesAnnounce					= "알림 효과음 바꾸기 (참고: 페이즈 변경과 쫄 등장 말고는 음성팩을 사용하는 효과음이 몇 안됩니다)"
L.ReplacesSADefault					= "기본 특수 알림 효과음 바꾸기 (사용자가 직접 지정한 효과음은 절대 바뀌지 않습니다)"
...
L.BarEndColor 						= "종료 색상"
L.Bar_Height						= "바 높이"
L.Slider_BarOffSetX 				= "가로 간격"
L.Slider_BarOffSetY 				= "세로 간격"
L.Slider_BarWidth 					= "바 너비"
L.Slider_BarScale 					= "바 크기"
L.BarSaturation						= "작은 바 채도 (커다란 바 사용시 비활성)"
L.BarBackgroundColor				= "배경색"
L.BarBackgroundOpacity				= "배경 투명도"
L.EnableBarBorder					= "타이머 바 테두리 켜기"
L.BarBorderSize						= "테두리 크기"
L.BarBorderColor					= "테두리 색상"
L.Slider_TextOffSetX				= "텍스트 X 위치 조정"
L.Slider_TextOffSetY				= "텍스트 Y 위치 조정"
...
L.PrivateAuraSoundCombatLockdown		= "전투 중에는 프라이빗 오라 효과음을 바꿀 수 없습니다."
--Timer Dropdowns
...
L.Area_TextTimers = "곧 종료되는 타이머 문자 (활성화된 DBM 바만)"
L.TextTimersEnable = "종료 직전에 문자 타이머 표시 (기본값: 끔)"
...
L.TextTimersLock = "위치 잠금"
L.TextTimersTest = "문자 시험 / 이동"
L.TextTimersReset = "위치 초기화"
...
L.PT_Threshold						= "풀링/휴식/사용자 지정 타이머 초읽기 음성 재생 안함초 까지"

-- Panel: Reduce Information
L.Panel_ReducedInformation			= "정보량 줄이기"

L.Area_SpamFilter_Anounces			= "알림 관련 기능 끄기 및 필터 설정"
L.SpamBlockNoShowTgtAnnounce		= "대상자 알림 중 타인에게 영향이 없는 것은 알림과 효과음 출력하지 않음 (DBM 기능 카테고리에서 전체 끄기를 설정하면 이 설정 무시)"
...
--Cut Scenes
L.Area_Cinematics					= "게임내 컷신 재생 차단"
...
L.NPAuraSize						= "아이콘 픽셀 크기 (정사각형)"
L.NPIcon_BarOffSetX 				= "아이콘 위치 조정 X"
L.NPIcon_BarOffSetY 				= "아이콘 위치 조정 Y"
L.NPIcon_GrowthDirection 			= "아이콘 생성 방향"
L.NPIcon_Spacing		 			= "아이콘 간격"
L.NPIcon_MaxTextLen		 			= "텍스트 최대 길이"
L.NPIconAnchorPoint		 			= "아이콘 기준점"
L.NPDemo							= "테스트 (이름표 보이는데서만 작동)"
L.FontTypeTimer						= "타이머 글꼴 선택"
L.FontTypeText						= "텍스트 글꼴 선택"
L.AuraDurationFontSize				= "지속시간 글꼴 크기"
L.AuraDurationFontColor				= "지속시간 글꼴 색상"
L.AuraDurationEmphasizeAt			= "다음 시간 미만일 때 지속시간 강조"
L.AuraDurationEmphasizeColor		= "강조된 지속시간 색상"
L.AuraIconZoom						= "아이콘 확대"
L.AuraShowDecimalSeconds			= "소수점 초 표시"
L.AuraDecimalThreshold				= "이 시간 이하일 때 소수점 표시"
L.AuraStackFontSize					= "중첩 글꼴 크기"
