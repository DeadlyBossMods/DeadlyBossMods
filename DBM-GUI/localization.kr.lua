...
L.SetPAStackScale					= "중첩 텍스트 크기"--Slider, Reused for personal and tank
L.SetPATextScale					= "텍스트 메시지 크기"--Slider
L.HidePATooltip						= "주문 툴팁 끄기"--checkbox
L.HidePABorder						= "테두리 끄기"--checkbox
L.Area_TankPrivateAuras				= "다른 탱커 디버프 오라 설정"
L.EnableTankPrivateAuraIcons		= "자신이 아닌 첫 번째 탱커 역할의 오라 아이콘 표시"--checkbox
L.ShowSecondCoTank					= "자신이 아닌 두 번째 탱커 역할의 오라 아이콘 표시"--checkbox
L.CoTankUseHealerInFiveMan			= "5인 던전에서 두 번째 탱커 대신 힐러를 자동으로 추적합니다"
L.CoTankShowPlayerName					= "추적 중인 플레이어 이름 표시"
L.CoTankNameFontSize					= "추적 중인 플레이어 이름 글꼴 크기"
L.CoTankNameXOffset					= "추적 중인 플레이어 이름 X 위치 조정"
L.CoTankNameYOffset					= "추적 중인 플레이어 이름 Y 위치 조정"
L.CoTankSlot1Player					= "첫 번째 공동 탱커 칸의 플레이어"
L.CoTankSlot2Player					= "두 번째 공동 탱커 칸의 플레이어"
