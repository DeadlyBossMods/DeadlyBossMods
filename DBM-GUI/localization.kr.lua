...
L.ModProfileImportFooter			= "이 보스나 전체 인스턴스의 프로필을 가져올 수 있습니다."
L.ModProfileExportFooter			= "이 보스의 설정만 내보냅니다."
L.AddonProfileImportFooter			= "전체 인스턴스 또는 단일 보스의 프로필을 가져올 수 있습니다."
L.AddonProfileExportFooter			= "전체 인스턴스 설정을 내보냅니다."
...
L.ImportProfileWrongTypeInstance	= "인스턴스 프로필입니다. %s의 인스턴스 통계 페이지에서 가져오세요."
...
L.ImportInstanceProfilePrompt		= "이 문자열에는 전체 인스턴스 설정을 포함하고 있습니다. 모든 인스턴스 설정을 가져올까요 아니면 %s 설정만 가져올까요?"
