...
L.ModProfileImportFooter			= "현재 우두머리 또는 인스턴스 전체 프로필을 가져올 수 있습니다."
L.ModProfileExportFooter			= "현재 우두머리의 설정만 내보냅니다."
L.AddonProfileImportFooter			= "인스턴스 전체 또는 단일 우두머리 프로필을 가져올 수 있습니다."
L.AddonProfileExportFooter			= "인스턴스 전체 설정을 내보냅니다."
...
L.ImportProfileWrongTypeCore		= "이 문자열은 핵심 설정 프로필입니다. DBM 설정 > %s > %s에서 가져오세요."
L.ImportProfileWrongTypeInstance	= "이 문자열은 인스턴스 프로필입니다. 해당 인스턴스의 통계 페이지에서 %s 항목을 통해 가져오세요."
L.ImportProfileWrongTypeBoss		= "이 문자열은 우두머리 모듈 프로필입니다. 해당 우두머리의 모듈 설정 패널에서 가져오세요."
L.ImportProfileUnsupportedVersion	= "이 가져오기 문자열은 지원되지 않는 프로필 버전을 사용합니다."
L.ImportInstanceProfilePrompt		= "이 문자열에는 인스턴스 전체 설정이 포함되어 있습니다. 전체 설정을 가져오거나 %s 설정만 가져오시겠습니까?"
L.ImportInstanceProfileAll			= "모두 가져오기"
L.ImportInstanceProfileBoss			= "이 보스만"
L.ProfileImported					= "프로필을 가져왔습니다."
L.PartialProfileImported			= "%d/%d 모듈의 프로필을 가져왔으며, 누락된 모듈은 변경하지 않았습니다."
...
L.ModProfileDeleteConfirm			= "모듈 프로필 %s을(를) 삭제할까요?"
