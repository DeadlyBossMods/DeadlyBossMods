...
L.BarEndColor 						= "종료 색상"
L.Bar_Height						= "바 높이: %d"
L.Slider_BarOffSetX 				= "가로 간격: %d"
L.Slider_BarOffSetY 				= "세로 간격: %d"
L.Slider_BarWidth 					= "바 너비: %d"
L.Slider_BarScale 					= "바 크기: %0.2f"
L.BarSaturation						= "작은 바 채도 (커다란 바 사용시 비활성): %0.2f"
L.BarBackgroundColor				= "배경색"
L.BarBackgroundOpacity				= "배경 투명도: %0.2f"
L.EnableBarBorder					= "타이머 바 테두리 켜기"
L.BarBorderSize						= "테두리 크기: %0.1f"
L.BarBorderColor					= "테두리 색상"
L.Slider_TextOffSetX				= "텍스트 X 위치 조정: %d"
L.Slider_TextOffSetY				= "텍스트 Y 위치 조정: %d"
...
L.AuraDurationFontSize				= "오라 지속시간 글꼴 크기: %d"
L.AuraStackFontSize					= "오라 중첩 글꼴 크기: %d"
