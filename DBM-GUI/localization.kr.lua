...
L.ModProfileImportFooter			= "현재 우두머리 또는 모듈 전체 프로필을 가져올 수 있습니다."
L.ModProfileExportFooter			= "현재 우두머리의 설정만 내보냅니다."
L.AddonProfileImportFooter			= "모듈 전체 또는 단일 우두머리 프로필을 가져올 수 있습니다."
L.AddonProfileExportFooter			= "모듈 전체 설정을 내보냅니다."
...
L.ImportProfileWrongTypeInstance	= "이 문자열은 모듈 프로필입니다. 해당 모듈의 통계 페이지에서 %s 항목을 통해 가져오세요."
...
L.ImportInstanceProfilePrompt		= "이 문자열에는 모듈 전체 설정이 포함되어 있습니다. 전체 설정을 가져오거나 %s 설정만 가져오시겠습니까?"
