...
L.OnlyBossOrRoleAuras				= "우두머리/역할 오라만 표시 (참고: 블리자드가 선별하며 모든 중요한 오라를 표시하지 않을 수 있음)"
L.Area_TankPrivateAuras				= "다른 탱커 디버프 오라 설정"
L.EnableTankPrivateAuraIcons		= "나를 제외한 1번 탱커의 오라 아이콘 표시"--checkbox
L.CoTankVisibility					= "공동 탱커 표시 조건:"
