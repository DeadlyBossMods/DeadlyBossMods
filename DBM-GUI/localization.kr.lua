...
L.Area_ImportExportSpellRenames	= "주문 이름 변경 가져오기/내보내기"
L.ImportExportSpellRenamesInfo	= "가져오기를 하면 현재 주문 이름 변경 설정에 덮어쓰게 되니 주의하세요."
L.ButtonImportSpellRenames			= "주문 이름 변경 가져오기"
L.ButtonExportSpellRenames			= "주문 이름 변경 내보내기"
L.ExportSpellRenamesFailed			= "주문 이름 변경 문자열을 내보내지 못했습니다. 데이터가 잘못되었거나 손상되었거나 지원되지 않는 형식일 수 있습니다."
L.ImportSpellRenamesFailed			= "주문 이름 변경 문자열을 가져오지 못했습니다. 데이터가 잘못되었거나 손상되었거나 지원되지 않는 형식일 수 있습니다."
L.ImportSpellRenamesWrongType		= "주문 이름 변경 문자열을 가져오지 못했습니다. 이 내보내기 유형은 주문 이름 변경 데이터가 아닙니다."
L.ImportSpellRenamesUnsupportedVersion	= "주문 이름 변경 문자열을 가져오지 못했습니다. 이 내보내기 버전은 지원되지 않습니다."
L.SpellRenamesImported				= "주문 이름 변경을 가져왔습니다."

L.ImportErrorOn						= "프로필 설정에 빠져있는 사용자 지정 효과음: %s"
L.ImportVoiceMissing				= "보이스팩 없음: %s"
L.LegacyProfileImportNotice		= "구형 프로필을 가져왔습니다. 이 형식은 더 이상 권장되지 않으니 새 형식으로 다시 내보내세요."
