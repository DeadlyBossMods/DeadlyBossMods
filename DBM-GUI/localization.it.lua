...
L.Tools_GearCheck					= "Controllo equipaggiamento"
...
L.Reset 							= "Resetta"
L.Import							= "Import"
L.ButtonExportMod					= "Esporta modulo"
L.ButtonImportMod					= "Importa modulo"
L.ModProfileImportFooter			= "Supporta profili per questo boss o per l'intero modulo."
L.ModProfileExportFooter			= "Esporta solo le opzioni di questo boss."
L.AddonProfileImportFooter			= "Supporta profili per l'intero modulo o per un singolo boss."
L.AddonProfileExportFooter			= "Esporta le opzioni dell'intero modulo."
L.ModImportSuccess					= "Impostazioni importate per %s."
L.ModImportFailed				    = "Impossibile importare le impostazioni per %s. I dati potrebbero essere non validi/corrotti o in un formato non supportato."
L.ImportProfileFailed				= "Impossibile importare la stringa del profilo. I dati potrebbero essere non validi/corrotti o in un formato non supportato."
L.ImportProfileWrongType			= "Questa stringa di importazione appartiene a un tipo di profilo diverso."
L.ImportProfileWrongTypeCore		= "Questo è un profilo delle impostazioni core. Importalo da Opzioni DBM > %s > %s."
L.ImportProfileWrongTypeInstance	= "Questo è un profilo modulo. Importalo dalla pagina delle statistiche del modulo, in %s."
L.ImportProfileWrongTypeBoss		= "Questo è un profilo modulo boss. Importalo dal pannello delle opzioni di quel boss."
L.ImportProfileUnsupportedVersion	= "Questa stringa di importazione usa una versione del profilo non supportata."
L.ImportInstanceProfilePrompt		= "Questa stringa contiene le impostazioni dell'intero modulo. Importare tutte le impostazioni o solo quelle di %s?"
L.ImportInstanceProfileAll			= "Importa tutte le impostazioni del modulo"
L.ImportInstanceProfileBoss			= "Solo questo boss"
L.ProfileImported					= "Profilo importato."
L.PartialProfileImported			= "Profilo importato per %d moduli su %d; i moduli mancanti sono rimasti invariati."
...
L.Statistic_BestClear			    = "Migliore Clear:"
...
L.Latency_Text						= "Soglia latenza sincronizzazione"
...
L.RenameSpellButton				= "Rinomina"
L.RenameSpellHeader				= "Imposta nome personalizzato per %s"
...
L.AnnounceConsumables				= "Annuncia controllo consumabili all'inizio del combattimento"
...
L.ModAllResetConfirm				= "Sei sicuro di voler ripristinare tutte le impostazioni per %s?"
L.ModAllStatResetConfirm			= "Sei sicuro di voler ripristinare tutte le statistiche per %s?"
L.ModProfileDeleteConfirm			= "Sei sicuro di voler eliminare il profilo modulo %s?"
...
L.Area_ImportExportSpellRenames	= "Importa/Esporta rinomini incantesimi"
L.ImportExportSpellRenamesInfo	= "L'importazione sovrascriverà i tuoi rinomini incantesimi attuali, procedi a tuo rischio."
L.ButtonImportSpellRenames			= "Importa rinomini incantesimi"
L.ButtonExportSpellRenames			= "Esporta rinomini incantesimi"
L.ExportSpellRenamesFailed			= "Impossibile esportare la stringa dei rinomini incantesimi. I dati potrebbero essere non validi/corrotti o in un formato non supportato."
L.ImportSpellRenamesFailed			= "Impossibile importare la stringa dei rinomini incantesimi. I dati potrebbero essere non validi/corrotti o in un formato non supportato."
L.ImportSpellRenamesWrongType		= "Impossibile importare la stringa dei rinomini incantesimi. Questo tipo di esportazione non riguarda i rinomini incantesimi."
L.ImportSpellRenamesUnsupportedVersion	= "Impossibile importare la stringa dei rinomini incantesimi. Questa versione di esportazione non è supportata."
L.SpellRenamesImported				= "Rinomini incantesimi importati."
L.ImportErrorOn						= "Custom sounds missing for setting: %s"
L.ImportVoiceMissing				= "Missing voice pack: %s"
L.LegacyProfileImportNotice		= "Profilo legacy importato. Questo formato è deprecato; riesportalo usando il nuovo formato."
...
L.SpecWarn_FlashFrameRepeat			= "Ripeti volte"
...
L.SpecWarn_FlashDur					= "Durata flash"
L.SpecWarn_FlashAlpha				= "Trasp. flash"
...
L.AlwaysShowPlayerAuras				= "Mostra i riquadri delle aure fuori dalle istanze"
L.AuraMaxDuration					= "Durata massima delle aure monitorate"
...
L.OnlyBossOrRoleAuras				= "Mostra solo aure di boss/ruolo (Nota: selezionate da Blizzard, potrebbero non mostrare tutte le aure importanti)"
L.Area_TankPrivateAuras				= "Co-Tank Private Aura Options"
L.EnableTankPrivateAuraIcons		= "Mostra le icone dell'aura per il primo giocatore con ruolo da tank che non sei tu"--checkbox
L.CoTankVisibility					= "Mostra il co-tank quando:"
L.CoTankVisibilityAuto				= "Con specializzazione da tank"
L.CoTankVisibilityAlways				= "Sempre"
L.CoTankVisibilityNever				= "Mai"
L.ShowSecondCoTank					= "Mostra le icone dell'aura per il secondo giocatore con ruolo da tank che non sei tu"--checkbox
L.CoTankUseHealerInFiveMan			= "Nelle spedizioni da 5 giocatori, traccia automaticamente il guaritore al posto del secondo tank"
L.CoTankShowPlayerName					= "Mostra il nome del giocatore monitorato"
L.CoTankNameFontSize					= "Dimensione del carattere del nome del giocatore monitorato"
L.CoTankNameXOffset					= "Scostamento X del nome del giocatore monitorato"
L.CoTankNameYOffset					= "Scostamento Y del nome del giocatore monitorato"
L.CoTankSlot1Player					= "Giocatore del primo spazio co-tank"
L.CoTankSlot2Player					= "Giocatore del secondo spazio co-tank"
L.CoTankAutomatic					= "Automatico"
L.RIGHT								= "Right"
L.LEFT								= "Left"
L.UP								= "Up"
L.DOWN								= "Down"
L.CENTER_HORIZONTAL					= "Centrato orizzontalmente"
L.CENTER_VERTICAL					= "Centrato verticalmente"
...
L.Bar_Height						= "Altezza barra"
L.Slider_BarOffSetX 				= "Spaziatura orizzontale"
L.Slider_BarOffSetY 				= "Spaziatura verticale"
L.Slider_BarWidth 					= "Lunghezza Barra"
L.Slider_BarScale 					= "Scala Barra"
L.BarSaturation						= "Saturazione barra per timer piccoli"
...
L.Panel_TextTimers					= "Timer testuali"
L.Area_TextTimers					= "Testo dei timer imminenti (dati delle barre DBM programmate nel codice, anche se le barre non sono visibili)"
L.TextTimersEnable					= "Mostra i timer testuali in scadenza"
L.TextTimersThreshold				= "Mostra con secondi rimanenti"
L.TextTimersMaxLines				= "Numero massimo di righe"
L.TextTimersMaxNameLength			= "Lunghezza massima del nome (0: illimitata)"
L.TextTimersFontSize				= "Dimensione del testo"
L.TextTimersUrgentThreshold			= "Urgente sotto i secondi (0: disattivato)"
L.TextTimersUrgentColor				= "Colore urgente"
L.TextTimersIcon					= "Mostra icona abilità"
L.TextTimersInheritBarColor			= "Eredita i colori iniziale e finale della barra"
L.TextTimersIconPosition			= "Posizione icona"
L.TextTimersIconBoth				= "Icone su entrambi i lati"
...
L.Bar_Decimal						= "Decimali mostrati dopo tempo"
L.Bar_Alpha							= "Trasparenza"
L.Bar_EnlargeTime					= "Allargamento barra sotto i"
L.Bar_AppearTime					= "Le barre vengono mostrate sopra questa soglia"--Used for when hidden bars show on the small bar anchor
L.Bar_HideLongBars					= "Nascondi le barre finché non scendono sotto la soglia"
...
L.NoTimers							= "Disattiva le barre dei timer DBM (i timer testuali restano visibili se attivati)"
...
L.PT_Threshold						= "No audio conto alla rovescia Pull/Pausa/Temp. Personale sopra"
...
L.AuraDurationFontColor				= "Aura duration font color"
L.AuraDurationEmphasizeAt			= "Enfatizza durata sotto"
L.AuraDurationEmphasizeColor		= "Colore durata evidenziata"
L.AuraIconZoom						= "Zoom icona"
L.AuraShowDecimalSeconds			= "Mostra secondi decimali"
L.AuraDecimalThreshold				= "Mostra decimali sotto"
L.AuraStackFontSize					= "Aura stack font size"
L.AuraStackFontColor					= "Aura stack font color"
L.AuraShowStacks						= "Show stack text"
L.AuraShowDispelBorder				= "Show dispel border"
L.AuraShowCooldownSwipe				= "Mostra effetto di ricarica"
L.AuraSortOrder						= "Ordinamento delle aure"
L.AuraSortDefault						= "Ordinamento predefinito di Blizzard"
L.AuraSortShortDurationFirst		= "Durata più breve prima"
L.AuraSortLongDurationFirst		= "Durata più lunga prima"
...
L.Area_Style						= "Style"
L.FontSize							= "Dimensioni carattere"
