...
L.ModProfileImportFooter			= "Supporta profili per questo boss o per l'intera istanza."
L.ModProfileExportFooter			= "Esporta solo le opzioni di questo boss."
L.AddonProfileImportFooter			= "Supporta profili per l'intera istanza o per un singolo boss."
L.AddonProfileExportFooter			= "Esporta le opzioni dell'intera istanza."
...
L.ImportProfileWrongTypeInstance	= "Questo è un profilo istanza. Importalo dalla pagina delle statistiche dell'istanza, in %s."
...
L.ImportInstanceProfilePrompt		= "Questa stringa contiene le impostazioni dell'intera istanza. Importare tutte le impostazioni o solo quelle di %s?"
L.ImportInstanceProfileAll			= "Importa tutto"
