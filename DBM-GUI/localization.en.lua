...
L.Area_TextTimers = "Upcoming timer text (enabled DBM bars only)"
...
L.TextTimersLock = "Lock position"
L.TextTimersTest = "Test / move text"
L.TextTimersReset = "Reset position"
