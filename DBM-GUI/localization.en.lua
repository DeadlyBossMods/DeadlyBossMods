...
L.Tools_KeystoneArea				= "Keystones"
L.Tools_ShowKeystoneOnComplete		= "Auto show Keystone frame when a Mythic+ run is completed"
L.Tools_AddChallengeTeleports		= "Add teleports to Challenges UI"
...
L.ModProfileImportFooter			= "Supports importing profiles for this encounter or the entire module."
L.ModProfileExportFooter			= "Exports options for this encounter only."
L.AddonProfileImportFooter			= "Supports importing profiles for the entire module or a single encounter."
L.AddonProfileExportFooter			= "Exports options for the entire module."
...
L.ImportProfileWrongTypeInstance	= "This is a module profile. Import it from that module's Statistics page under %s."
...
L.ImportInstanceProfilePrompt		= "This string contains settings for the entire module. Import all module settings or only settings for %s?"
L.ImportInstanceProfileAll			= "Import all module settings"
...
L.ShowWAKeys						= "Show Spell keys next to spell names to assist in writing WeakAuras using Boss Mod triggers."
...
L.ModAllResetConfirm				= "Are you sure you want to reset all settings for %s?"
L.ModAllStatResetConfirm			= "Are you sure you want to reset all stats for %s?"
L.ModProfileDeleteConfirm			= "Are you sure you want to delete the mod profile %s?"
...
L.Area_ImportExportSpellRenames	= "Import/Export spell renames"
L.ImportExportSpellRenamesInfo	= "Importing will overwrite your current spell renames, do at your own risk."
L.ButtonImportSpellRenames			= "Import spell renames"
L.ButtonExportSpellRenames			= "Export spell renames"
L.ExportSpellRenamesFailed			= "Failed to export spell rename string. The data may be invalid/corrupted or from an unsupported format."
L.ImportSpellRenamesFailed			= "Failed to import spell rename string. The data may be invalid/corrupted or from an unsupported format."
L.ImportSpellRenamesWrongType		= "Failed to import spell rename string. This export type is not spell renames."
L.ImportSpellRenamesUnsupportedVersion	= "Failed to import spell rename string. This export version is not supported."
L.SpellRenamesImported				= "Spell renames imported."
...
L.Warn_Duration						= "Announcement duration"
L.None								= "None"
L.Random							= "Random"
L.Outline							= "Outline"
...
L.ShortTextSpellname				= "Use spell renames on announcement text"
L.SpecWarn_FlashFrameRepeat			= "Flash repeat count"
...
L.SpecWarn_FlashDur					= "Flash duration"
L.SpecWarn_FlashAlpha				= "Flash alpha"
...
L.CoTankVisibilityAuto				= "In tanking spec"
L.CoTankVisibilityAlways			= "Always"
L.CoTankVisibilityNever				= "Never"
L.ShowSecondCoTank					= "Show aura icons for the second tank-role player that isn't you"--checkbox
L.CoTankUseHealerInFiveMan			= "In 5-player dungeons, automatically track the healer in place of the second tank"
L.CoTankShowPlayerName				= "Show tracked player name"
L.CoTankNameFontSize				= "Tracked player name font size"
L.CoTankNameXOffset					= "Tracked player name offset X"
L.CoTankNameYOffset					= "Tracked player name offset Y"
L.CoTankSlot1Player					= "First co-tank slot player"
L.CoTankSlot2Player					= "Second co-tank slot player"
L.CoTankAutomatic					= "Automatic"
L.RIGHT								= "Right"
L.LEFT								= "Left"
L.UP								= "Up"
L.DOWN								= "Down"
...
L.Slider_BarOffSetX 				= "Horizontal Spacing"
L.Slider_BarOffSetY 				= "Vertical Spacing"
L.Slider_BarWidth 					= "Bar width"
L.Slider_BarScale 					= "Bar scale"
L.BarSaturation						= "Bar saturation for small timers (When huge bars are disabled)"
L.BarBackgroundColor				= "Background color"
L.BarBackgroundOpacity				= "Background opacity"
L.EnableBarBorder					= "Enable bar border"
L.BarBorderSize						= "Border size"
L.BarBorderColor					= "Border color"
L.Slider_TextOffSetX				= "Text offset X"
L.Slider_TextOffSetY				= "Text offset Y"
...
L.Panel_TextTimers					= "Text Timers"
L.Area_TextTimers					= "Upcoming timer text (data from DBM hardcoded bars, even if bars not visible)"
L.TextTimersEnable					= "Show text timers near expiration (off by default)"
L.TextTimersThreshold				= "Show when seconds remaining"
L.TextTimersMaxLines				= "Maximum lines"
L.TextTimersMaxNameLength			= "Maximum name length (0: unlimited)"
L.TextTimersFontSize				= "Text size"
L.TextTimersUrgentThreshold			= "Urgent below seconds (0: off)"
L.TextTimersUrgentColor				= "Urgent color"
L.TextTimersIcon					= "Show ability icon"
L.TextTimersInheritBarColor			= "Inherit bar start and end color"
L.TextTimersIconPosition			= "Icon position"
L.TextTimersIconBoth				= "Icons on both sides"
...
L.VarianceTransparency				= "Bar transparency"
...
L.Bar_Decimal						= "Decimal shows below time"
L.Bar_Alpha							= "Alpha"
L.Bar_EnlargeTime					= "Bar enlarges below time"
L.Bar_AppearTime					= "Bar are hidden above time"--Used for when hidden bars show on the small bar anchor
...
L.ShortTimerText					= "Use spell renames on timer text"
...
L.NoTimers							= "Disable DBM timer bars (Text Timers still show if enabled)"
...
L.PT_Threshold						= "Do not play Pull/Break/Custom Timer countdown audio above"
...
L.NPAuraSize						= "Icon Pixel size (squared)"
L.NPIcon_BarOffSetX 				= "Icon Offset X"
L.NPIcon_BarOffSetY 				= "Icon Offset Y"
L.NPIcon_GrowthDirection 			= "Icon Growth Direction"
L.NPIcon_Spacing		 			= "Icon Spacing"
L.NPIcon_MaxTextLen		 			= "Max. Text Length"
...
L.AuraDurationFontSize				= "Duration font size"
L.AuraDurationFontColor				= "Duration font color"
L.AuraDurationEmphasizeAt			= "Emphasize duration below"
L.AuraDurationEmphasizeColor		= "Emphasized duration color"
L.AuraIconZoom						= "Icon zoom"
L.AuraShowDecimalSeconds			= "Show decimal seconds"
L.AuraDecimalThreshold				= "Show decimals below"
L.AuraStackFontSize					= "Stack font size"
L.AuraStackFontColor				= "Stack font color"
L.AuraShowStacks					= "Show stack text"
L.AuraShowDispelBorder				= "Show dispel border"
L.AuraShowCooldownSwipe				= "Show cooldown swipe"
