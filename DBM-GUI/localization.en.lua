...
L.AutologBosses				= "Automatically record boss encounters using blizzard combat log (Using /pull before bosses is required for |HDBM:generic|h|cff3588ffhttp://www.warcraftlogs.com|r compatability)"
