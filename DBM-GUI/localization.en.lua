...
L.AutologBosses				= "Automatically record boss encounters using blizzard combat log (Using /pull before bosses is required for <a href=\"http://www.warcraftlogs.com\">|cff3588ffwarcraftlogs.com|r</a> compatability)"
