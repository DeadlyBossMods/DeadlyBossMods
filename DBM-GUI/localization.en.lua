...
L.ShowGuildMessages 		= "Show guild engage/kill/wipe messages for raids in chat frame"
L.ShowGuildMessagesPlus		= "Also show guild Mythic+ engage/kill/wipe messages (requires raid option)"
