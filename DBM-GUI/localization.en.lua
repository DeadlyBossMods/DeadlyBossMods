...
L.SetPAStackScale					= "Stack text scale"--Slider, Reused for personal and tank
L.SetPATextScale					= "Text message scale"--Slider
...
L.EnableTankPrivateAuraIcons		= "Show aura icons for first tank role that isn't you"--checkbox
L.ShowSecondCoTank					= "Show aura icons for second tank role that isn't you"--checkbox
