...
L.SearchMatches             = "%d |4coincidencia:coincidencias;"
...
L.SpecialWarnHeaderMedium			= "Tipo 1: Anuncios para mecánicas que Blizzard clasifica como 'moderadas'"
L.SpecialWarnHeaderCritical			= "Tipo 2: Anuncios para mecánicas que Blizzard clasifica como 'críticas'"

-- Panel: Private Auras Frame
L.Panel_PrivateAuras				= "Auras privadas"
L.Area_PersonalPrivateAuras         = "Opciones de auras privadas personales"
L.EnablePersonalPrivateAuraIcons    = "Mostrar iconos de auras privadas personales en pantalla"
L.EnablePersonalPrivateAuraText     = "Mostrar mensajes de texto de auras privadas personales en pantalla"
L.UpscaleDurationText               = "Aumentar la escala del texto de duración"
L.SetPAGrowDirection                = "Dirección de crecimiento"
L.SetPAIconScale                    = "Escala del icono: %d"
L.SetPAIconSpacing                  = "Espaciado del icono: %d"
L.SetPAStackScale                   = "Escala de acumulaciones: %d"
...
L.PullVoice					= "Voz para temporizador de inicio"
L.VoicePackChoice			= "Paquete de voz para alertas de voz"
L.MissingVoicePack			= "Paquete de voz faltante (%s)"
L.CountdownStartTime        = "Establecer el tiempo de inicio de la cuenta atrás para los temporizadores de Blizzard"
L.CountStart                = "%d |4segundos restantes:segundo restante;"
...
L.Area_Private_Aura_Features        = "Opciones de auras privadas"
L.SpamBlockNoPrivateAuraSound       = "No registrar sonidos de auras privadas"
L.SpamBlockNoPrivateAuraFrame       = "No mostrar marcos de auras privadas"
