...
L.LFDEnhance				= "Reproducir sonido de comprobación de rol y destellar el icono del juego para comprobaciones de rol y avisos de CB/buscador de mazmorras en el canal de audio principal o diálogo (es decir, los sonidos funcionan incluso si los efectos de sonido están desactivados y, en general, son más fuertes)."
