...
L.SpecWarn_AlwaysVoice		= "Reproducir siempre todas las alertas de voz (se ignora las opciones de sonido)"
...
L.SpamSpecRoleDispel				= "Filtrar las alertas 'disipar' (sin texto ni sonido)"
L.SpamSpecRoleInterrupt				= "Filtrar las alertas 'interrumpir' (sin texto ni sonido)"
L.SpamSpecRoleDefensive				= "Filtrar las alertas 'defensiva' (sin texto ni sonido)"
L.SpamSpecRoleTaunt					= "Filtrar las alertas 'provocar' (sin texto ni sonido)"
L.SpamSpecRoleSoak					= "Filtrar las alertas 'daño' (sin texto ni sonido)"
L.SpamSpecRoleStack					= "Filtrar las alertas 'acumulaciones de perjuicios' (sin texto ni sonido)"
L.SpamSpecRoleSwitch				= "Filtrar las alertas 'cambia de objetivo' y 'bichos' (sin texto ni sonido)"
L.SpamSpecRoleGTFO					= "Filtrar las alertas 'correr' (sin texto ni sonido)"
