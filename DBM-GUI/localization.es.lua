...
L.Area_TextTimers					= "Texto de temporizadores próximos (datos de barras programadas en DBM, aunque las barras no estén visibles)"
L.TextTimersEnable					= "Mostrar temporizadores de texto al terminar"
...
L.TextTimersInheritBarColor			= "Heredar el color inicial y final de la barra"
