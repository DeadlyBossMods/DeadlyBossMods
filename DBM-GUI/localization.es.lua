...
L.Tools_GearCheck					= "Verificación de equipo"
L.Tools_BreakTimer					= "Iniciar temporizador de descanso"
L.Tools_PizzaTimer					= "Iniciar temporizador genérico"
L.Tools_BrezArea					= "Temporizador de resurrección en combate"
L.Tools_ShowBrezFrame				= "Mostrar el marco de cargas de resurrección en combate durante encuentros de jefe y mazmorras Mítica+"
--L.Tools_KeystoneArea				= "Keystones"
L.Tools_ShowKeystoneOnComplete		= "Mostrar automáticamente el marco de piedra angular al completar una Mítica+"
--L.Tools_AddChallengeTeleports		= "Add teleports to Challenges UI"
L.Tools_OverrideKeystoneSlash		= "Sobrescribir comandos de barra para el marco de piedra angular (/keystone, /keys y /key)\n(Nota: DBM intentará no sobrescribir ninguno de estos para otros addons si esta opción no está activada. Sin embargo, DBM los registrará si alguno no está en uso)"
...
L.ModProfileImportFooter			= "Permite importar perfiles de este encuentro o de todo el módulo."
L.ModProfileExportFooter			= "Exporta únicamente las opciones de este encuentro."
L.AddonProfileImportFooter			= "Permite importar perfiles de todo el módulo o de un solo encuentro."
L.AddonProfileExportFooter			= "Exporta las opciones de todo el módulo."
L.ModImportSuccess					= "Configuración importada para %s."
L.ModImportFailed				    = "No se pudo importar la configuración para %s. Los datos pueden ser inválidos/corruptos o de un formato no compatible."
...
L.ImportProfileWrongType			= "Esta cadena de importación corresponde a otro tipo de perfil."
L.ImportProfileWrongTypeCore		= "Este es un perfil de ajustes del núcleo. Impórtalo desde Opciones de DBM > %s > %s."
L.ImportProfileWrongTypeInstance	= "Este es un perfil de módulo. Impórtalo desde la página de estadísticas de ese módulo, en %s."
L.ImportProfileWrongTypeBoss		= "Este es un perfil de módulo de jefe. Impórtalo desde el panel de opciones de ese jefe."
L.ImportProfileUnsupportedVersion	= "Esta cadena de importación usa una versión de perfil no compatible."
L.ImportInstanceProfilePrompt		= "Esta cadena contiene ajustes para todo el módulo. ¿Importar todos los ajustes o solo los de %s?"
L.ImportInstanceProfileAll			= "Importar todos los ajustes del módulo"
L.ImportInstanceProfileBoss			= "Solo este jefe"
L.ProfileImported					= "Perfil importado."
L.PartialProfileImported			= "Perfil importado para %d de %d módulos; los módulos ausentes no se modificaron."
L.Enable							= ENABLE
L.Disable							= DISABLE
...
L.Statistic_BestClear			    = "Récord actual:"
...
L.Latency_Text						= "Latencia máx. para sincronización"
...
L.GroupOptionsExcludePrivateAura	= "Excluir que las opciones de sonido 'Aura' se agrupan por hechizo (en su lugar, se agruparán en su propia categoría 'Auras')"
...
L.RenameSpellButton				    = "Renombrar"
L.RenameSpellHeader				    = "Establecer nombre personalizado para %s"
L.GTFOAbilityTitle					= "GTFO"
L.GTFOAbilityDescription			= "Cualquier facultad que inflija daño de la que debas alejarte"
--L.ShowSpellDescWhenExpanded		= "[TODO: Falta traducción] (Continue showing spell description when groups are expanded)"
...
L.AnnounceConsumables				= "Anunciar verificación de consumibles al inicio del combate"
...
L.Area_CreateProfile				= "Creación de perfil"
L.EnterProfileName					= "Nombre del perfil"
L.CreateProfile						= "Crear perfil"
L.Area_ApplyProfile					= "Aplicar perfil"
L.SelectProfileToApply				= "Selecciona el perfil a aplicar"
L.Area_CopyProfile					= "Copiar perfil"
L.SelectProfileToCopy				= "Selecciona el perfil a copiar"
L.Area_DeleteProfile				= "Borrar perfil"
L.SelectProfileToDelete				= "Selecciona el perfil a borrar"
...
L.ModAllResetConfirm				= "¿Estás seguro de que quieres restablecer toda la configuración de %s?"
L.ModAllStatResetConfirm			= "¿Estás seguro de que quieres restablecer todas las estadísticas de %s?"
L.ModProfileDeleteConfirm			= "¿Estás seguro de que quieres borrar el perfil de módulo %s?"
L.SelectModProfileCopy				= "Copiar configuración de"
L.SelectModProfileCopySound			= "Copiar sonidos de"
...
L.Area_ImportExportSpellRenames	    = "Importar/Exportar renombres de hechizos"
L.ImportExportSpellRenamesInfo	    = "La importación sobrescribirá tus renombres de hechizos actuales, hazlo bajo tu propio riesgo."
L.ButtonImportSpellRenames			= "Importar renombres de hechizos"
L.ButtonExportSpellRenames			= "Exportar renombres de hechizos"
L.ExportSpellRenamesFailed			= "No se pudo exportar la cadena de renombres de hechizos. Los datos pueden ser inválidos/corruptos o estar en un formato no compatible."
L.ImportSpellRenamesFailed			= "No se pudo importar la cadena de renombres de hechizos. Los datos pueden ser inválidos/corruptos o estar en un formato no compatible."
L.ImportSpellRenamesWrongType		= "No se pudo importar la cadena de renombres de hechizos. Este tipo de exportación no corresponde a renombres de hechizos."
L.ImportSpellRenamesUnsupportedVersion	= "No se pudo importar la cadena de renombres de hechizos. Esta versión de exportación no es compatible."
L.SpellRenamesImported				= "Renombres de hechizos importados."
L.ImportErrorOn						= "Faltan sonidos personalizados para configurar: %s"
L.ImportVoiceMissing				= "Paquete de voz faltante: %s"
L.LegacyProfileImportNotice		    = "Se importó un perfil heredado. Este formato está obsoleto; vuelve a exportarlo usando el formato nuevo."
...
L.ShortTextSpellname                = "Usar renombres de hechizos en el texto de anuncios"
L.SpecWarn_FlashFrameRepeat			= "Repeticiones"
L.SpecWarn_Flash					= "Destello"
L.SpecWarn_Vibrate					= "Controlador de vibración"
L.SpecWarn_FlashRepeat				= "Repetir destello"
L.SpecWarn_FlashColor				= "Color %d"
L.SpecWarn_FlashDur					= "Duración"
L.SpecWarn_FlashAlpha				= "Transparencia"
...
L.CoTankVisibilityAuto				= "En especialización de tanque"
L.CoTankVisibilityAlways				= "Siempre"
L.CoTankVisibilityNever				= "Nunca"
L.ShowSecondCoTank					= "Mostrar iconos de aura para el segundo jugador con rol de tanque que no seas tú"--checkbox
L.CoTankUseHealerInFiveMan			= "En mazmorras de 5 jugadores, rastrear automáticamente al sanador en lugar del segundo tanque"
L.CoTankShowPlayerName					= "Mostrar el nombre del jugador rastreado"
L.CoTankNameFontSize					= "Tamaño de fuente del nombre del jugador rastreado"
L.CoTankNameXOffset					= "Desplazamiento X del nombre del jugador rastreado"
L.CoTankNameYOffset					= "Desplazamiento Y del nombre del jugador rastreado"
L.CoTankSlot1Player					= "Jugador de la primera ranura de co-tanque"
L.CoTankSlot2Player					= "Jugador de la segunda ranura de co-tanque"
...
L.CheckGear							= "Mostrar alerta al iniciar un encuentro cuando tu nivel de equipo sea como mínimo 40 niveles menor que el de tu inventario o no tengas equipada tu arma principal"
...
L.Area_VPLearnMore					= "Obtén más información sobre los paquetes de voz y cómo usar estas opciones"
...
L.Bar_Height						= "Altura de barras"
L.Slider_BarOffSetX 				= "Espaciado horizontal"
L.Slider_BarOffSetY 				= "Espaciado vertical"
L.Slider_BarWidth 					= "Anchura de barras"
L.Slider_BarScale 					= "Escala de barras"
L.BarSaturation						= "Saturación de barras para temporizadores pequeños"
L.BarBackgroundColor                = "Color de fondo"
L.BarBackgroundOpacity              = "Opacidad del fondo"
L.EnableBarBorder                   = "Activar borde de la barra"
L.BarBorderSize                     = "Tamaño del borde"
L.BarBorderColor                    = "Color del borde"
L.Slider_TextOffSetX                = "Desplazamiento del texto X"
L.Slider_TextOffSetY                = "Desplazamiento del texto Y"
L.MidnightNote						= "Nota: Debido a las restricciones de API en Midnight. DBM no puede soportar diferentes colores de inicio y fin. Solo se usará el color de inicio."
L.BarStartColorAdd					= "Color inicial 1 (esbirros)"
L.BarEndColorAdd					= "Color final 1 (esbirros)"
L.BarStartColorAOE					= "Color inicial 2 (AoE)"
L.BarEndColorAOE					= "Color final 2 (AoE)"
...
L.Bar7ForceLarge					= "Usar barras grandes"
L.Bar7CustomInline					= "Usar icono '!' personalizado"
L.CBTGeneric						= "Genérico"
L.CBTAdd							= "Esbirros en breve"
L.CBTAOE							= "Hechizo de área de efecto"
L.CBTTargeted						= "Hechizo de objetivo"
L.CBTInterrupt						= "Hechizo interrumpible"
L.CBTRole							= "Hechizo de rol específico"
L.CBTPhase							= "Fase"
...
L.SAThree							= "Sonido 3"
L.SAFour							= "Sonido 4"
L.PrivateAuraSoundCombatLockdown	= "Los sonidos de aura no se pueden cambiar en combate."
...
L.Panel_TextTimers = "Temporizadores de texto"
L.Area_TextTimers = "Texto de temporizadores próximos (solo barras activadas de DBM)"
L.TextTimersEnable = "Mostrar temporizadores de texto al terminar (desactivado por defecto)"
L.TextTimersThreshold = "Mostrar con segundos restantes"
L.TextTimersMaxLines = "Máximo de líneas"
L.TextTimersMaxNameLength = "Longitud máxima del nombre (0: sin límite)"
L.TextTimersFontSize = "Tamaño del texto"
L.TextTimersUrgentThreshold = "Urgente por debajo de segundos (0: desactivado)"
...
L.TextTimersLock = "Bloquear posición"
L.TextTimersTest = "Probar / mover texto"
L.TextTimersReset = "Restablecer posición"
...
L.VarianceTransparency				= "Transparencia"
...
L.Bar_Decimal						= "Mostrar decimales bajo"
L.Bar_Alpha							= "Transparencia"
L.Bar_EnlargeTime					= "Agrandar barras bajo"
L.Bar_AppearTime					= "Ocultar barras encima"--Used for when hidden bars show on the small bar anchor
...
L.NoBarFade							= "Usar color inicial para barras pequeñas y final para grandes, sin cambios graduales"
L.BarInlineIcons					= "Mostrar iconos del diario"
L.DisableRightClickBar				= "Desactivar clic derecho para cancelar temporizadores"
L.ShortTimerText                    = "Usar renombres de hechizos en el texto del temporizador"
...
L.KeepBar							= "Mantener temporizador activo hasta que se lance la facultad"
...
L.NoTimers							= "Desactivar las barras de temporizador de DBM (los temporizadores de texto se siguen mostrando si están activados)"
...
L.Area_Private_Aura_Features		= "Opciones de auras"
L.SpamBlockNoPrivateAuraSound		= "No registrar sonidos de auras"
L.SpamBlockNoPrivateAuraFrame		= "No mostrar marcos de auras"
...
L.SpamBlockNoTLColors				= "No establecer colores de la línea temporal de Blizzard (Nota: también desactiva los colores de barras de DBM)"
...
L.PT_Threshold						= "No reproducir sonidos por encima"
...
--L.HideBossKill					= "[TODO: Falta traducción] (Hide boss kill toasts)"
--L.HideVaultUnlock				    = "[TODO: Falta traducción] (Hide vault unlock toasts)"
...
--L.DisabledForDropdown				= "[TODO: Falta traducción] (Choose boss mod(s) disable is sent to)"
--L.DiabledForBoth					= "[TODO: Falta traducción] (Disable above features for both DBM and BW)"
--L.DiabledForDBM					= "[TODO: Falta traducción] (Disable above features for only DBM users)"
--L.DiabledForBW					= "[TODO: Falta traducción] (Disable above features for only BW users)"
...
L.NPAuraSize						= "Tamaño del aura"
L.NPIcon_BarOffSetX 				= "Desplazamiento X"
L.NPIcon_BarOffSetY 				= "Desplazamiento Y"
L.NPIcon_GrowthDirection 			= "Dirección de crecimiento"
L.NPIcon_Spacing		 			= "Espaciado del icono"
L.NPIcon_MaxTextLen		 			= "Longitud del texto máx."
L.NPIconAnchorPoint		 			= "Punto de anclaje"
L.NPDemo							= "Probar (Acercarse de placas de nombre)"
L.FontTypeTimer						= "Fuente del temporizador"
L.FontTypeText						= "Fuente del texto"
L.AuraDurationFontSize				= "Tamaño de fuente de duración del aura"
L.AuraDurationFontColor				= "Color de fuente de duración del aura"
L.AuraDurationEmphasizeAt			= "Resaltar duración por debajo de"
L.AuraDurationEmphasizeColor		= "Color de duración resaltada"
L.AuraIconZoom						= "Zoom del icono"
L.AuraShowDecimalSeconds			= "Mostrar segundos decimales"
L.AuraDecimalThreshold				= "Mostrar decimales por debajo de"
L.AuraStackFontSize					= "Tamaño de fuente de acumulaciones del aura"
L.AuraStackFontColor					= "Color de fuente de acumulaciones del aura"
L.AuraShowStacks					= "Mostrar texto de acumulaciones"
L.AuraShowDispelBorder				= "Mostrar borde de disipación"
L.AuraShowCooldownSwipe				= "Mostrar barrido de reutilización"
L.AuraSortOrder					= "Orden de las auras"
L.AuraSortDefault					= "Orden predeterminado de Blizzard"
L.AuraSortShortDurationFirst		= "Duración más corta primero"
L.AuraSortLongDurationFirst		= "Duración más larga primero"
L.Area_NPGlow						= "Resplandor (Nota: solo configura cuando no se usa Plater)"
