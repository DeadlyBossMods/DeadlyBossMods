...
-- sunlcy@NGA
-- Mini Dragon <流浪者酒馆-Brilla@金色平原> 20260626
...
L.Reset 							= "重置"
L.Import							= "导入"
L.ButtonExportMod					= "导出模块"
L.ButtonImportMod					= "导入模块"
L.ModProfileImportFooter			= "支持导入当前首领或整个模块的配置。"
L.ModProfileExportFooter			= "仅导出当前首领的选项。"
L.AddonProfileImportFooter			= "支持导入整个模块或单个首领的配置。"
L.AddonProfileExportFooter			= "导出整个模块的选项。"
L.ModImportSuccess					= "已为%s导入设置。"
L.ModImportFailed				    = "无法导入%s的设置。数据可能无效/损坏或来自不支持的格式。"
L.ImportProfileFailed				= "无法导入配置文件字符串。数据可能无效/损坏或来自不支持的格式。"
L.ImportProfileWrongType			= "此导入字符串属于其他配置文件类型。"
L.ImportProfileWrongTypeCore		= "这是核心设置配置。请前往DBM选项 > %s > %s进行导入。"
L.ImportProfileWrongTypeInstance	= "这是模块配置。请前往对应模块的统计页面，在%s中导入。"
L.ImportProfileWrongTypeBoss		= "这是首领模块配置。请前往对应首领的模块选项面板导入。"
L.ImportProfileUnsupportedVersion	= "此导入字符串使用了不受支持的配置文件版本。"
L.ImportInstanceProfilePrompt		= "此字符串包含整个模块的设置。要导入全部模块设置，还是只导入%s的设置？"
L.ImportInstanceProfileAll			= "导入全部模块设置"
L.ImportInstanceProfileBoss			= "仅此首领"
L.ProfileImported					= "已导入配置文件。"
L.PartialProfileImported			= "已导入%d/%d个模块的配置；缺失的模块保持不变。"
...
L.Latency_Text						= "设定团队之间DBM最高延迟阈值"
...
L.RenameSpellButton					= "重命名"
L.RenameSpellHeader					= "为%s设置自定义名称"
L.GTFOAbilityTitle					= "GTFO"
L.GTFOAbilityDescription			= "任何会对你造成伤害且需要躲开的技能"
...
L.Area_CombatAlertsRetail			= "战斗警报选项 (仅副本外)"
...
L.AnnounceConsumables				= "在战斗开始时通报消耗品检查"
...
L.ModAllStatReset					= "重置所有Boss模块数据"
L.ModAllResetConfirm				= "确定要重置 %s 的所有Boss模块选项吗？"
L.ModAllStatResetConfirm			= "确定要重置 %s 的所有Boss模块数据吗？"
L.ModProfileDeleteConfirm			= "确定要删除模块配置 %s 吗？"
...
L.Area_ImportExportSpellRenames	= "导入导出法术重命名"
L.ImportExportSpellRenamesInfo	= "导入会覆盖你当前的法术重命名设置，请谨慎使用。"
L.ButtonImportSpellRenames			= "导入法术重命名"
L.ButtonExportSpellRenames			= "导出法术重命名"
L.ExportSpellRenamesFailed			= "导出法术重命名字符串失败。数据可能无效/损坏，或来自不支持的格式。"
L.ImportSpellRenamesFailed			= "导入法术重命名字符串失败。数据可能无效/损坏，或来自不支持的格式。"
L.ImportSpellRenamesWrongType		= "导入法术重命名字符串失败。该导出类型不是法术重命名数据。"
L.ImportSpellRenamesUnsupportedVersion	= "导入法术重命名字符串失败。该导出版本不受支持。"
L.SpellRenamesImported				= "法术重命名已导入。"
L.ImportErrorOn						= "自定义语音缺失：%s"
L.ImportVoiceMissing				= "找不要语音包：%s"
L.LegacyProfileImportNotice		= "已导入旧版配置。该格式已弃用，请使用新格式重新导出。"
...
L.RaidWarnColor 					= "颜色"--Only one used in midnight
...
L.SetPAIconSpacing					= "图标间距"
L.HidePATooltip						= "禁用鼠标悬停时的法术提示框"
L.HidePABorder						= "禁用边框"
L.OnlyBossOrRoleAuras				= "仅显示首领/职责光环（注意：由暴雪筛选，可能不会显示所有重要光环）"
L.Area_TankPrivateAuras				= "副坦私人光环选项"
L.EnableTankPrivateAuraIcons		= "显示第一个非你的坦克职责玩家的光环图标"
L.CoTankVisibility					= "显示副坦的条件："
L.CoTankVisibilityAuto				= "使用坦克专精时"
L.CoTankVisibilityAlways				= "始终"
L.CoTankVisibilityNever				= "从不"
L.ShowSecondCoTank					= "显示第二个非你的坦克职责玩家的光环图标"--checkbox
L.CoTankUseHealerInFiveMan			= "在5人地下城中，自动追踪治疗者而不是第二名坦克"
L.CoTankShowPlayerName					= "显示被追踪玩家的名字"
L.CoTankNameFontSize					= "被追踪玩家名字字体大小"
L.CoTankNameXOffset					= "被追踪玩家名字 X 偏移"
L.CoTankNameYOffset					= "被追踪玩家名字 Y 偏移"
L.CoTankSlot1Player					= "第一协同坦克栏位玩家"
L.CoTankSlot2Player					= "第二协同坦克栏位玩家"
L.CoTankAutomatic					= "自动"
L.RIGHT								= "右"
L.LEFT								= "左"
L.UP								= "上"
L.DOWN								= "下"
...
L.CountdownStartTime				= "设置倒计时计时器为暴雪计时器"
L.CountStart						= "剩 %d 秒"
...
L.BarEndColor 						= "结束颜色"
L.Bar_Height						= "计时条高度"
L.Slider_BarOffSetX 				= "水平间距"
L.Slider_BarOffSetY 				= "垂直间距"
L.Slider_BarWidth 					= "宽度"
L.Slider_BarScale 					= "缩放"
L.BarSaturation						= "小型计时条的饱和度 (当大型计时条被禁用时)"
L.BarBackgroundColor				= "背景颜色"
L.BarBackgroundOpacity				= "背景颜色透明度"
L.EnableBarBorder					= "显示计时条边框"
L.BarBorderSize						= "边框粗细"
L.BarBorderColor					= "边框颜色"
L.Slider_TextOffSetX				= "文字 X 偏移"
L.Slider_TextOffSetY				= "文字 Y 偏移"
...
L.PrivateAuraSoundCombatLockdown	= "战斗中无法改变私人光环的声音"
...
L.Panel_TextTimers					= "文字计时器"
L.Area_TextTimers					= "即将结束的计时文字（数据来自 DBM 硬编码计时条，即使计时条不可见）"
L.TextTimersEnable					= "临近结束时显示文字计时器"
L.TextTimersThreshold				= "剩余多少秒时显示"
L.TextTimersMaxLines				= "最大行数"
L.TextTimersMaxNameLength			= "名称最大长度（0：无限制）"
L.TextTimersFontSize				= "文字大小"
L.TextTimersUrgentThreshold			= "紧急阈值秒数（0：关闭）"
L.TextTimersUrgentColor				= "紧急颜色"
L.TextTimersIcon					= "显示技能图标"
L.TextTimersInheritBarColor			= "继承计时条的起始和结束颜色"
L.TextTimersIconPosition			= "图标位置"
L.TextTimersIconBoth				= "两侧图标"
...
L.AreaTitle_BarSetupVariance		= "渐变计时条设置"
L.EnableHugeBar 					= "开启大型计时条（2号计时条）"
L.EnableVarianceBar 				= "展开计时条以显示技能的最大排队时间"
L.VarianceColor						= "渐变颜色"
L.VarianceTransparency				= "计时条透明度"
L.VarianceTimerTextBehavior			= "设置渐变时条文本行为"
L.ZeroatWindowEnds					= "文本在CD结束时归零"
L.ZeroatWindowStartPause			= "文本在CD结束时归零并暂停"
...
L.Bar_Decimal						= "显示低于阈值的小数值"
L.Bar_Alpha							= "透明度"
L.Bar_EnlargeTime					= "低于阈值时放大计时条"
L.Bar_AppearTime					= "隐藏高于阈值的计时条"--Used for when hidden bars show on the small bar anchor
...
L.NoTimers							= "关闭DBM计时条（启用文字计时器时仍会显示）"
...
L.Area_Private_Aura_Features		= "私人光环选项"
L.SpamBlockNoPrivateAuraSound		= "不要注册私人光环声音"
L.SpamBlockNoPrivateAuraFrame		= "不显示私人光环框"
...
L.SpamBlockNoTLColors				= "不要设置暴雪时间轴颜色（注意：这也会禁用 DBM 计时条颜色）"
...
L.Tab_PrivacyMidnight				= "插件通信隐私设置"
...
L.Plater_Config						= "打开 Plater 配置"
L.ThreatPlates_Config				= "打开 Threat Plates 配置"
L.Area_NPStyle						= "样式(注意：仅在DBM管理姓名版时配置。)"
L.NPAuraText						= "在姓名版图标上显示计时器"
L.NPAuraSize						= "技能图标大小 (比例)"
L.NPIcon_BarOffSetX 				= "技能图标X轴偏移"
L.NPIcon_BarOffSetY 				= "技能图标Y轴偏移"
L.NPIcon_GrowthDirection 			= "技能图标出现方向"
L.NPIcon_Spacing		 			= "图标间隔"
L.NPIcon_MaxTextLen		 			= "最大文本长度"
L.NPIconAnchorPoint		 			= "图标锚点"
L.NPDemo							= "测试 (靠近姓名版)"
L.FontTypeTimer						= "选择计时器字体"
L.FontTypeText						= "选择文字字体"
L.AuraDurationFontSize				= "光环持续时间字体大小"
L.AuraDurationFontColor				= "光环持续时间字体颜色"
L.AuraDurationEmphasizeAt			= "低于此时间时强调持续时间"
L.AuraDurationEmphasizeColor		= "强调的持续时间颜色"
L.AuraIconZoom						= "图标缩放"
L.AuraShowDecimalSeconds			= "显示小数秒数"
L.AuraDecimalThreshold				= "低于此值显示小数"
L.AuraStackFontSize					= "光环层数字体大小"
L.AuraStackFontColor					= "光环层数字体颜色"
L.AuraShowStacks					= "显示层数文本"
L.AuraShowDispelBorder				= "显示驱散边框"
L.AuraShowCooldownSwipe				= "显示冷却扇形动画"
L.AuraSortOrder						= "光环排序方式"
L.AuraSortDefault					= "暴雪默认排序"
L.AuraSortShortDurationFirst		= "持续时间短的优先"
L.AuraSortLongDurationFirst		    = "持续时间长的优先"
