...
L.SpecWarn_FlashFrameRepeat			= "重复 次 (如果开启的话)"
...
L.Bar_Decimal						= "秒以内显示小数点"
L.Bar_Alpha							= "透明度"
L.Bar_EnlargeTime					= "在 秒后计时条变大"
L.Bar_AppearTime					= "隐藏 秒之外的计时条"--Used for when hidden bars show on the small bar anchor
