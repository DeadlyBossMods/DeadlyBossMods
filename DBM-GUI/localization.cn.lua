...
L.Slider_BarOffSetX 				= "水平间距: %d"
L.Slider_BarOffSetY 				= "垂直间距: %d"
L.Slider_BarWidth 					= "宽度: %d"
L.Slider_BarScale 					= "缩放: %0.2f"
L.BarSaturation						= "小型计时条的饱和度 (当大型计时条被禁用时): %0.2f"
L.BarBackgroundColor				= "背景颜色"
L.BarBackgroundOpacity				= "背景颜色透明度: %0.2f"
L.EnableBarBorder					= "显示计时条边框"
L.BarBorderSize						= "边框粗细: %0.1f"
L.BarBorderColor					= "边框颜色"
L.Slider_TextOffSetX				= "文字 X 偏移: %d"
L.Slider_TextOffSetY				= "文字 Y 偏移: %d"
