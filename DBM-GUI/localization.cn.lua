...
L.ModProfileImportFooter			= "支持导入当前首领或整个副本的配置。"
L.ModProfileExportFooter			= "仅导出当前首领的选项。"
L.AddonProfileImportFooter			= "支持导入整个副本或单个首领的配置。"
L.AddonProfileExportFooter			= "导出整个副本的选项。"
...
L.ImportProfileWrongTypeInstance	= "这是副本配置。请前往对应副本的统计页面，在%s中导入。"
L.ImportProfileWrongTypeBoss		= "这是首领模块配置。请前往对应首领的模块选项面板导入。"
L.ImportProfileUnsupportedVersion	= "此导入字符串使用了不受支持的配置文件版本。"
L.ImportInstanceProfilePrompt		= "此字符串包含整个副本的设置。要导入全部副本设置，还是只导入%s的设置？"
L.ImportInstanceProfileAll			= "全部导入"
