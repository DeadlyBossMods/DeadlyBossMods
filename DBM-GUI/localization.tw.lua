...
L.ModProfileImportFooter			= "支援匯入目前首領或整個模組的設定檔。"
L.ModProfileExportFooter			= "僅匯出目前首領的選項。"
L.AddonProfileImportFooter			= "支援匯入整個模組或單一首領的設定檔。"
L.AddonProfileExportFooter			= "匯出整個模組的選項。"
...
L.ImportProfileWrongTypeInstance	= "這是模組設定檔。請前往對應模組的統計頁面，在%s中匯入。"
L.ImportProfileWrongTypeBoss		= "這是首領模組設定檔。請前往對應首領的模組選項面板匯入。"
L.ImportProfileUnsupportedVersion	= "此匯入字串使用了不支援的設定檔版本。"
L.ImportInstanceProfilePrompt		= "此字串包含整個模組的設定。要匯入全部模組設定，還是只匯入%s的設定？"
L.ImportInstanceProfileAll			= "匯入全部模組設定"
...
L.GroupOptionsExcludePrivateAura	= "按照技能分組排除“光環”選項 (它們將一起分類為自己的“光環”類別)"
...
L.GTFOAbilityTitle                  = "地板技能提醒"
L.GTFOAbilityDescription            = "任何你應該遠離以避免造成傷害的任何技能"
...
L.ModAllStatReset					= "重置所有模組數據"
L.ModAllResetConfirm				= "確定要重置 %s 的所有設定嗎？"
L.ModAllStatResetConfirm			= "確定要重置 %s 的所有模組數據嗎？"
L.ModProfileDeleteConfirm			= "確定要刪除模組設定檔 %s 嗎？"
...
L.CoTankVisibilityAuto				= "使用坦克專精時"
L.CoTankVisibilityAlways				= "永遠"
L.CoTankVisibilityNever				= "永不"
L.ShowSecondCoTank					= "顯示第二個非你自己的坦克職責玩家的光環圖示"--checkbox
L.CoTankUseHealerInFiveMan			= "在5人地城中，自動追蹤治療者而非第二名坦克"
L.CoTankShowPlayerName					= "顯示追蹤中的玩家名稱"
L.CoTankNameFontSize					= "追蹤中玩家名稱的字體大小"
L.CoTankNameXOffset					= "追蹤中玩家名稱的 X 偏移"
L.CoTankNameYOffset					= "追蹤中玩家名稱的 Y 偏移"
L.CoTankSlot1Player					= "第一個協同坦克欄位的玩家"
L.CoTankSlot2Player					= "第二個協同坦克欄位的玩家"
L.CoTankAutomatic					= "自動"
L.RIGHT								= "右"
L.LEFT								= "左"
L.UP								= "上"
L.DOWN								= "下"
...
L.BarEndColor 						= "結束顏色"
L.Bar_Height						= "計時條高度"
L.Slider_BarOffSetX 				= "水平間距"
L.Slider_BarOffSetY 				= "垂直間距"
L.Slider_BarWidth 					= "寬度"
L.Slider_BarScale 					= "尺寸"
L.BarSaturation						= "小型計時條的飽和度 (當大計時條被停用時)"
L.BarBackgroundColor				= "背景顏色"
L.BarBackgroundOpacity				= "背景透明度"
L.EnableBarBorder					= "啟用條邊框"
L.BarBorderSize						= "邊框大小"
L.BarBorderColor					= "邊框顏色"
L.Slider_TextOffSetX				= "文字水平偏移"
L.Slider_TextOffSetY				= "文字垂直偏移"
...
L.Panel_TextTimers					= "文字計時器"
L.Area_TextTimers					= "即將結束的計時文字（資料來自 DBM 硬編碼計時條，即使計時條不可見）"
L.TextTimersEnable					= "接近結束時顯示文字計時器"
L.TextTimersThreshold				= "剩餘幾秒時顯示"
L.TextTimersMaxLines				= "最多行數"
L.TextTimersMaxNameLength			= "名稱最大長度（0：無限制）"
L.TextTimersFontSize				= "文字大小"
L.TextTimersUrgentThreshold			= "緊急門檻秒數（0：關閉）"
L.TextTimersUrgentColor				= "緊急顏色"
L.TextTimersIcon					= "顯示技能圖示"
L.TextTimersInheritBarColor			= "沿用計時條的起始與結束顏色"
L.TextTimersIconPosition			= "圖示位置"
L.TextTimersIconBoth				= "兩側圖示"
...
L.Bar_Decimal						= "秒以下顯示小數點"
L.Bar_Alpha							= "透明度"
L.Bar_EnlargeTime					= "計時條時間低於時放大"
L.Bar_AppearTime					= "計時條時間高於時隱藏"
...
L.NoTimers							= "停用DBM計時條（啟用文字計時器時仍會顯示）"
...
L.Area_Private_Aura_Features		= "光環功能"
L.SpamBlockNoPrivateAuraSound		= "不登記光環音效"
L.SpamBlockNoPrivateAuraFrame		= "不顯示光環框架"
...
L.PT_Threshold						= "不要播放高於閾值的休息/開戰/自訂倒數計時器音效"
...
L.NPAuraSize						= "光環像素大小 (平方)"
L.NPIcon_BarOffSetX 				= "圖示水平偏移"
L.NPIcon_BarOffSetY 				= "圖示垂直偏移"
L.NPIcon_GrowthDirection 			= "圖示增長方向"
L.NPIcon_Spacing		 			= "圖示間距"
L.NPIcon_MaxTextLen		 			= "最大文字長度"
L.NPIconAnchorPoint		 			= "圖示定位點"
L.NPDemo							= "測試 (靠近名條)"
L.FontTypeTimer						= "選擇計時器字體"
L.FontTypeText						= "選擇文字字體"
L.AuraDurationFontSize				= "光環持續時間文字大小"
L.AuraDurationFontColor				= "光環持續時間文字顏色"
L.AuraDurationEmphasizeAt			= "持續時間低於此值時強調"
L.AuraDurationEmphasizeColor		= "強調的持續時間顏色"
L.AuraIconZoom						= "圖示縮放"
L.AuraShowDecimalSeconds			= "顯示小數秒數"
L.AuraDecimalThreshold				= "低於此值顯示小數"
L.AuraStackFontSize					= "光環層數文字大小"
L.AuraStackFontColor					= "光環層數文字顏色"
L.AuraShowStacks					= "顯示層數文字"
L.AuraShowDispelBorder				= "顯示驅散邊框"
L.AuraShowCooldownSwipe				= "顯示冷卻掃過動畫"
L.AuraSortOrder						= "光環排序方式"
L.AuraSortDefault					= "暴雪預設排序"
L.AuraSortShortDurationFirst		= "持續時間短的優先"
L.AuraSortLongDurationFirst		    = "持續時間長的優先"
