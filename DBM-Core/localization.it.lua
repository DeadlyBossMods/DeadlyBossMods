...
DBM_CORE_RANGECHECK_HEADER			= "Distanziometro (%dm)"
DBM_CORE_RANGECHECK_HEADERT			= "Distanziometro (%dm-%dP)"
DBM_CORE_RANGECHECK_RHEADER			= "Distanziometro Inverso (%dD)"
DBM_CORE_RANGECHECK_RHEADERT		= "Distanziometro Inverso (%dm-%dP)"
...
DBM_CORE_RANGERADAR_IN_RANGE_TEXT	= "%d vicini (%0.1fm)" -- Multi
