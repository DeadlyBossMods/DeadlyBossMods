...
local L = DBM_CORE_L
L.AURA_FONT_RESET	= "Sono state rilevate impostazioni non valide per il carattere del testo delle aure; sono state ripristinate a quelle predefinite."
...
L.NEWS_UPDATE_REPEAT	= "|h|c11ff1111Notizie|r|h: DBM è stato aggiornato con modifiche alla struttura dei mod, così classic e mainline possono ora usare moduli unificati (identici). Questo significa che i moduli incursione di Vanilla (incluso SoD), TBC, Wrath e Cata devono ora essere scaricati separatamente usando gli stessi pacchetti della versione retail. Ti trovi in un'incursione con un modulo mancante. Questo messaggio continuerà a mostrarsi (e non avrai avvisi funzionanti per questa zona) finché non installerai il modulo incursione mancante."

L.COPY_URL_DIALOG_NEWS	= "Per leggere le ultime notizie, visita il link sottostante"
...
L.MOD_MISSING				= "Nessun modulo incursione"
L.NOT_INSTALLED				= "Non installato"

L.COPY_URL_DIALOG	= "Copia URL"
L.COPY_WA_DIALOG	= "Copia Chiave Incantesimo"

--Post Patch 7.1
L.TEXT_ONLY_RANGE	= "Il distanziometro è limitato al solo testo, poiché Blizzard ha disabilitato alcune funzionalità in quest'area."
...
L.GUILD_COMBAT_STARTED			= "%s è stato ingaggiato dal gruppo di gilda di %s"
...
L.RAID_DOWN						= "%s completato in %s!"
L.RAID_DOWN_L					= "%s completato in %s! Il tuo completamento più veloce ha richiesto %s."
L.RAID_DOWN_NR					= "%s completato in %s! È un nuovo record! (Il precedente era %s)."
L.GUILD_BOSS_DOWN				= "%s è stato sconfitto dal gruppo di gilda di %s dopo %s!"
...
L.COMBAT_ENDED					= "Combattimento contro %s terminato dopo %s."
L.COMBAT_ENDED_LONG				= "Combattimento contro %s terminato dopo %s. Hai totalizzato %d disfatte a questa difficoltà."
L.GUILD_COMBAT_ENDED_AT			= "Il gruppo di gilda di %s ha subito una disfatta contro %s (%s) dopo %s."
L.GUILD_COMBAT_ENDED			= "Il gruppo di gilda di %s ha subito una disfatta contro %s dopo %s."
...
L.MOVIE_NOTSKIPPED	= L.DBM .. " ha rilevato una scena tagliata che può essere saltata, ma NON l\'ha saltata a causa di un bug di Blizzard. Quando questo bug verrà risolto, il salto verrà riabilitato"
...
L.LOWHEALTH_WARNING	= "Vita bassa (%d percento di vita rimanente), esecuzione avviso sonoro. Puoi disabilitare questa opzione in 'funzionalità aggiuntive'."
L.ENTERING_COMBAT	= "Ingresso in combattimento"
L.LEAVING_COMBAT	= "Uscita dal combattimento"

L.RAID_DIFFICULTY_CHANGED		= "Il livello di difficoltà dell'incursione è stato impostato su %s."
L.DUNGEON_DIFFICULTY_CHANGED	= "Il livello di difficoltà della spedizione è stato impostato su %s."
...
L.NOTE_SHARE_LINK		= "Clicca qui per aprire la nota"
...
L.WORLDBUFF_STARTED		= "Il buff %s è iniziato sul tuo reame per la fazione %s (Inviato da %s)."
...
L.OPTION_CATEGORY_SPECWARNINGS		= "Annunci Speciali"
...
L.OPTION_CATEGORY_PAURAS		= "Aure Private"
...
L.RENAME					= " (|cff359030Rinomina:|r |cff71d5ff%s|r)"
...
L.UPDATEREMINDER_HEADER_SUBMODULE	= "Il tuo modulo %s è obsoleto.\nLa versione %s è disponibile per il download tramite Curse, Wago, WoWI o dalla pagina GitHub Releases"
...
L.UPDATEREMINDER_DISABLETEST		= "AVVISO: Poiché la tua versione di " .. L.DEADLY_BOSS_MODS .. " è obsoleta e questo è un reame di test/beta, è stata forzatamente disabilitata e non può essere usata finché non verrà aggiornata. Questo per assicurarsi che i mod obsoleti non vengano usati per generare feedback di test"
...
L.OUTDATEDSPELLTIMERS				= "AVVISO: DBM-SpellTimers rompe " .. L.DBM .. " e deve essere disabilitato affinché " .. L.DBM .. " funzioni correttamente."
L.OUTDATEDRLT						= "AVVISO: DBM-RaidLeadTools rompe " .. L.DBM .. ". DBM-RaidLeadTools non è più supportato e deve essere rimosso affinché " .. L.DBM .. " funzioni correttamente."
...
L.DBM_INSTALL_REMINDER_DISABLE2		= "Non mostrare più questo messaggio per questo pacchetto." -- Used for unimportant mods, i.e., dungeons
L.DBM_INSTALL_REMINDER_DL_WAGO		= "Premi " .. (IsMacClient() and "Cmd-C" or "Ctrl-C") .. " per copiare il link di Wago.io negli appunti."
L.DBM_INSTALL_REMINDER_DL_CURSE		= "Premi " .. (IsMacClient() and "Cmd-C" or "Ctrl-C") .. " per copiare il link di Curseforge negli appunti."
L.DBM_INSTALL_PACKAGE_VANILLA		= "Pacchetto Vanilla e Season of Discovery"
L.DBM_INSTALL_PACKAGE_BCC			= "Pacchetto Burning Crusade"
L.DBM_INSTALL_PACKAGE_WRATH			= "Pacchetto Wrath"
...
L.INFOFRAME_SETCOLS			= "Imposta colonne massime"
L.INFOFRAME_LINESDEFAULT	= "Imposta per mod"
L.INFOFRAME_LINES_TO		= "%d linee"
L.INFOFRAME_COLS_TO			= "%d colonne"
...
L.AUTO_ANNOUNCE_TEXTS.incoming		= "%s debuff in arrivo"
L.AUTO_ANNOUNCE_TEXTS.incomingcount	= "%s debuff in arrivo (%%s)"
...
L.AUTO_ANNOUNCE_TEXTS.countdown		= "%s tra %%ds"
...
L.AUTO_ANNOUNCE_OPTIONS.targetNF		= "Annuncia bersagli di $spell:%s (ignora il filtro globale dei bersagli)"
...
L.AUTO_ANNOUNCE_OPTIONS.incoming		= "Annuncia quando $spell:%s ha debuff in arrivo"
L.AUTO_ANNOUNCE_OPTIONS.incomingcount	= "Annuncia (con conteggio) quando $spell:%s ha debuff in arrivo"
...
L.AUTO_ANNOUNCE_OPTIONS.sooncount		= "Mostra preavvisi per $spell:%s (con conteggio)"
L.AUTO_ANNOUNCE_OPTIONS.countdown		= "Mostra spam di conto alla rovescia del preavviso per $spell:%s"
...
L.AUTO_SPEC_WARN_TEXTS.youposcount		= "%s (%%s) (Posizione: %%s) su di te"
...
L.AUTO_SPEC_WARN_TEXTS.soakcount		= "%s - entraci (%%s)"
L.AUTO_SPEC_WARN_TEXTS.jump				= "%s - salta"
L.AUTO_SPEC_WARN_TEXTS.run				= "%s - scappa"
L.AUTO_SPEC_WARN_TEXTS.runcount			= "%s - scappa (%%s)"
...
L.AUTO_SPEC_WARN_OPTIONS.youposcount	= "Mostra avviso speciale (con posizione e conteggio) quando affetto da $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.soakcount		= "Mostra avviso speciale (con conteggio) per entrarci con $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.runcount		= "Mostra avviso speciale (con conteggio) per scappare da $spell:%s"
...
L.AUTO_TIMER_TEXTS.intermission			= "Interfase"
L.AUTO_TIMER_TEXTS.intermissioncount	= "Interfase %%s"
L.AUTO_TIMER_TEXTS.adds					= "Adds"
L.AUTO_TIMER_TEXTS.addscount			= "Adds (%%s)"
...
L.AUTO_TIMER_OPTIONS.targetcount		= "Mostra temporizzatore (con conteggio) debuff di $spell:%s"
...
L.AUTO_TIMER_OPTIONS.cdnp				= "Mostra temporizzatore solo sulla Barra del Nome per la ricarica di $spell:%s"
...
L.AUTO_TIMER_OPTIONS.cdcombo			= "Mostra temporizzatore per la ricarica di combo di abilità" --Used for combining 2 abilities into a single timer
...
L.AUTO_TIMER_OPTIONS.nextnp				= "Mostra temporizzatore solo sulla Barra del Nome per la prossima $spell:%s"
...
L.AUTO_TIMER_OPTIONS.nextcombo			= "Mostra temporizzatore per la prossima combo di abilità" --Used for combining 2 abilities into a single timer
...
L.AUTO_TIMER_OPTIONS.stagecount			= "Mostra temporizzatore (con conteggio) per la prossima fase"
L.AUTO_TIMER_OPTIONS.stagecountcycle	= "Mostra temporizzatore (con conteggio fase e ciclo) per la prossima fase"
L.AUTO_TIMER_OPTIONS.stagecontext		= "Mostra temporizzatore per la prossima fase di $spell:%s"
L.AUTO_TIMER_OPTIONS.stagecontextcount	= "Mostra temporizzatore (con conteggio) per la prossima fase di $spell:%s"
L.AUTO_TIMER_OPTIONS.intermission		= "Mostra temporizzatore per la prossima interfase"
L.AUTO_TIMER_OPTIONS.intermissioncount	= "Mostra temporizzatore (con conteggio) per la prossima interfase"
L.AUTO_TIMER_OPTIONS.adds				= "Mostra temporizzatore add in arrivo"
L.AUTO_TIMER_OPTIONS.addscount			= "Mostra temporizzatore add (con conteggio) in arrivo"
...
L.AUTO_ICONS_OPTION_TARGETS_TANK_A 		= "Imposta icone sui bersagli di $spell:%s con priorità tank su melee su ranged e fallback alfabetico"
L.AUTO_ICONS_OPTION_TARGETS_TANK_R 		= "Imposta icone sui bersagli di $spell:%s con priorità tank su melee su ranged e fallback sul roster dell'incursione"
L.AUTO_ICONS_OPTION_TARGETS_MELEE_A 	= "Imposta icone sui bersagli di $spell:%s con priorità melee e fallback alfabetico"
L.AUTO_ICONS_OPTION_TARGETS_MELEE_R 	= "Imposta icone sui bersagli di $spell:%s con priorità melee e fallback sul roster dell'incursione"
L.AUTO_ICONS_OPTION_TARGETS_RANGED_A 	= "Imposta icone sui bersagli di $spell:%s con priorità ranged e fallback alfabetico"
L.AUTO_ICONS_OPTION_TARGETS_RANGED_R 	= "Imposta icone sui bersagli di $spell:%s con priorità ranged e fallback sul roster dell'incursione"
L.AUTO_ICONS_OPTION_TARGETS_ALPHA 		= "Imposta icone sui bersagli di $spell:%s con priorità alfabetica"
L.AUTO_ICONS_OPTION_TARGETS_ROSTER 		= "Imposta icone sui bersagli di $spell:%s con priorità sul roster dell'incursione"
L.AUTO_ICONS_OPTION_TARGETS_MRH 		= "Imposta icone sui bersagli di $spell:%s con priorità melee su ranged su healer e fallback sul roster dell'incursione"
L.AUTO_ICONS_OPTION_TARGETS_TOH 		= "Imposta icone sui bersagli di $spell:%s con priorità tank su DPS su healer e fallback sul roster dell'incursione"
L.AUTO_ICONS_OPTION_NPCS				= "Imposta icone su $spell:%s"
L.AUTO_ICONS_OPTION_CONFLICT			= " (Potrebbe entrare in conflitto con altre opzioni)"
...
L.AUTO_YELL_OPTION_TEXT.shortposition	= "Urla (con posizione) quando affetto da $spell:%s"
L.AUTO_YELL_OPTION_TEXT.combo			= "Urla (con testo personalizzato) quando affetto da $spell:%s e altre allo stesso tempo"
L.AUTO_YELL_OPTION_TEXT.repeatplayer	= "Urla ripetutamente (con nome giocatore) quando affetto da $spell:%s"
L.AUTO_YELL_OPTION_TEXT.repeaticon		= "Urla ripetutamente (con icona) quando affetto da $spell:%s"
...
L.AUTO_NAMEPLATE_OPTION_TEXT_FORCED		= "Mostra le Aure della Barra del Nome per $spell:%s usando solo " .. L.DBM
...
L.AUTO_INFO_FRAME_OPTION_TEXT3			= "Mostra riquadro informativo per $spell:%s (quando viene raggiunta la soglia di %%s)"
L.AUTO_READY_CHECK_OPTION_TEXT			= "Riproduti il suono controllo gruppo al pull del boss (anche se non bersagliato)"
L.AUTO_GOSSIP_BUFFS						= "Seleziona automaticamente la/le scelta/e di dialogo per i buff da NPC o da professione"
L.AUTO_GOSSIP_PERFORM_ACTION			= "Seleziona automaticamente la/le scelta/e di dialogo per eseguire azioni (come usare i trasporti)"
L.AUTO_GOSSIP_START_ENCOUNTER			= "Seleziona automaticamente la scelta di dialogo per iniziare l'incontro"
L.AUTO_SPEEDCLEAR_OPTION_TEXT			= "Mostra temporizzatore per il completamento più veloce di questa zona"
L.AUTO_PRIVATEAURA_OPTION_TEXT			= "Esegui avvisi sonori di aura DBM per $spell:%s in questo scontro."
L.AUTO_PRIVATEAURA_OPTION_TARGET_TEXT	= "Esegui avvisi sonori di aura DBM quando sei bersagliato da $spell:%s."
L.AUTO_PRIVATEAURA_OPTION_GTFO_TEXT		= "Esegui avvisi sonori di aura DBM quando devi allontanarti da $spell:%s."
L.AUTO_PRIVATEAURA_OPTION_POST_TEXT		= "Esegui avvisi sonori di aura DBM per gli effetti persistenti di $spell:%s."
L.AUTO_CUSTOMTIMER_OPTION_TEXT			= "Mostra temporizzatore per $spell:%s"
L.AUTO_CUSTOMALERT_OPTION_TEXT			= "Imposta suono di avviso per quando $spell:%s sta per essere castato"
...
L.MOVE_PRIVATE_AURA_TEXT		= "<valore segreto> ti bersaglia con l'incantesimo <valore segreto>"
L.MOVE_PRIVATE_AURA_DISABLED	= "L'anteprima è disabilitata perché i Riquadri delle Aure sono disabilitati globalmente nelle opzioni."
...
L.ARROW_ERROR_USAGE	= {
	...
	"/dbm arrow <giocatore>: Crea una freccia che punta verso un giocatore specifico nel tuo gruppo o nell'incursione (distingue tra maiuscole e minuscole!).",
...
L.BREZ_HEADER			= "Resurrezione in Combattimento"
L.KEYSTONES_HEADER		= L.DBM .. " - Chiavi"

L.OVERRIDE_ACTIVATED	= "Le sostituzioni di configurazione sono state attivate per questo incontro dal RL"

--LDB
L.LDB_TOOLTIP_HELP1	= "Clicca per aprire "..L.DBM..""
L.LDB_TOOLTIP_HELP2	= "Clicca col tasto destro per aprire la configurazione"
L.SILENTMODE_IS		= "Modalità silente: "
...
L.FOLLOWER	= "Seguace"--i.e. the new dungeon type in 10.2.5. I haven't found a translated string yet
L.STORY		= PLAYER_DIFFICULTY_STORY_RAID or "Storia"--i.e. the new dungeon type in 11.0.0. I haven't found a translated string yet
L.DUOS		= "Duo"
...
L.TOOLTIP_ENRAGE_TIMER	= "Temporizzatore dell'Enrage"
L.TOOLTIP_KILLS			= "Uccisioni (%s)"
L.TOOLTIP_WIPES			= "Disfatte (%s)"
L.TOOLTIP_FASTEST		= "Uccisione più veloce (%s)"

-- Midnight jazz
L.MN_TIMELINE_HEADER	= "Vuoi usare la Timeline di Blizzard o le Barre di DBM?"
L.MN_BLIZZARD_TIMELINE	= "Timeline di Blizzard"
L.MN_DBM_TIMELINE		= "Barre di DBM"
L.MN_WARNIGS_HEADER		= "Vuoi usare gli Avvisi di Incontro di Blizzard o quelli di DBM?"
L.MN_BLIZZARD_WARNINGS	= "Avvisi di Blizzard"
L.MN_DBM_WARNINGS		= "Avvisi di DBM"
L.MN_TEXT_TIMERS_HEADER	= "Vuoi usare i timer testuali?\n(Usa i dati delle barre DBM, anche se non sono visibili)"
