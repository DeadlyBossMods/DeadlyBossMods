...
L.AUTO_SPEC_WARN_TEXTS.blizztarget		= "%s (%%s) su >%%s< "L.AUTO_SPEC_WARN_TEXTS.blizzyou				= "%s (%%s) su di te"L.AUTO_SPEC_WARN_TEXTS.defensive			= "%s - difensivi"
...
L.AUTO_SPEC_WARN_OPTIONS.blizztarget 	= "Mostra avviso speciale (con conteggio) quando qualcuno è affetto da $spell:%s"L.AUTO_SPEC_WARN_OPTIONS.blizzyou		= "Mostra avviso speciale (con conteggio) quando affetto da $spell:%s"L.AUTO_SPEC_WARN_OPTIONS.defensive 		= "Mostra avviso speciale per usare abilità difensive per $spell:%s"
