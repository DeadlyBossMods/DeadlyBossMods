...
L.AUTO_ANNOUNCE_OPTIONS.targetsource 	= "Exibir anúncio (com fonte) para alvos de $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.targetcount		= "Exibir anúncio (com contagem) para alvos de $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.blizztarget		= "Exibir anúncio (com contagem) para alvos de $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.spell			= "Exibir anúncio para $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.spellsource		= "Exibir anúncio (com fonte) para $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.incoming 		= "Exibir anúncio quando $spell:%s tiver penalidades se aproximando"
L.AUTO_ANNOUNCE_OPTIONS.incomingcount 	= "Exibir anúncio (com contagem) quando $spell:%s tiver penalidades se aproximando"
L.AUTO_ANNOUNCE_OPTIONS.ends 			= "Exibir anúncio quando $spell:%s tiver terminado"
L.AUTO_ANNOUNCE_OPTIONS.endtarget 		= "Exibir anúncio (com alvo) quando $spell:%s tiver terminado"
...
L.AUTO_ANNOUNCE_OPTIONS.sooncount		= "Exibir anúncio antecipado (com contagem) para $spell:%s"
...
L.AUTO_TIMER_OPTIONS.addscount			= "Exibir cronômetro (com contagem) para a chegada de adds"
...
L.MN_TEXT_TIMERS_HEADER = "Deseja usar temporizadores em texto?\n(Utiliza dados das barras do DBM, mesmo que não estejam visíveis)"
