...
L.VOICE_PACK_OUTDATED				= "O pacote de vozes do seu " .. L.DBM .. " pode estar sem alguns dos sons suportados por esta versão do " .. L.DBM .. ". Filtro de anúncio especial sonoro foi desativado. Por favor baixe a versão mais recente do pacote de vozes ou contate o autor para um pacote que contenha os sons aqui referidos."
L.VOICE_MISSING						= "Você tinha um pacote de vozes " .. L.DBM .. " selecionado que não pode ser encontrado. Sua seleção foi restaurada para 'Nenhum/None'. Caso seja um erro, certifique-se que o pacote esta instalado corretamente e ativado em addons."
...
L.UPDATEREMINDER_DISABLE			= ": Seu " .. L.DBM .. " foi desativado por estar drasticamente desatualizado (pelo menos %d revisões). Atualize para utilizá-lo novamente. Isso garante que versões antigas ou códigos incompatíveis não prejudiquem sua experiência de jogo ou a de sua raide."
L.UPDATEREMINDER_DISABLETEST		= ": Seu " .. L.DEADLY_BOSS_MODS .. " foi desativado devido à sua versão desatualizada neste reino de teste/beta. Ele não pode ser usado até ser atualizado, garantindo que mods antigos não afetem o feedback de teste."
...
L.UPDATEREMINDER_MAJORPATCH			= ": Seu " .. L.DBM .. " foi desativado por estar drasticamente desatualizado (pelo menos %d revisões). Atualize para utilizá-lo novamente. Baixe a versão mais recente em deadlybossmods.com ou Curse o mais breve possível."
L.VEM								= ": Você está usando " .. L.DBM .. " e Voice Encounter Mods. " .. L.DBM .. " não funcionará corretamente nessa configuração e, portanto, não será carregado."
L.OUTDATEDPROFILES					= ": " .. L.DBM .. "-Profiles não é compatível com esta versão de " .. L.DBM .. ". Remova-o para evitar conflitos e permitir que " .. L.DBM .. " funcione corretamente."
L.OUTDATEDSPELLTIMERS 				= ": DBM-SpellTimers interfere no " .. L.DBM .. " e deve ser desativado para que ele funcione corretamente."
L.OUTDATEDRLT 						= ": DBM-RaidLeadTools interfere no " .. L.DBM .. ". Este addon não é mais suportado e deve ser removido para evitar conflitos."
L.VICTORYSOUND 						= ": DBM-VictorySound não é compatível com esta versão do " .. L.DBM .. ". Remova-o para evitar conflitos e garantir o funcionamento adequado."
L.DPMCORE 							= ": Os módulos Deadly PvP foram descontinuados e não são compatíveis com esta versão do " .. L.DBM .. ". Remova-os para evitar conflitos."
L.DBMLDB 							= ": O DBM-LDB agora está incorporado ao DBM-Core. Embora não cause problemas, é recomendável remover 'DBM-LDB' da pasta de addons."
L.DBMLOOTREMINDER 					= ": O módulo de terceiros DBM-LootReminder está instalado. Ele não é mais compatível com o cliente do WoW Retail e causa problemas no " .. L.DBM .. ", impedindo o envio de cronômetros de puxada. Recomenda-se desinstalá-lo."
L.UPDATE_REQUIRES_RELAUNCH			= ": Esta versão de " .. L.DBM .. " exige que o jogo seja reiniciado por completo para funcionar corretamente. A atualização inclui novos arquivos ou alterações no .toc que não podem ser carregadas via ReloadUI. Continuar sem reiniciar pode causar erros ou funcionalidades quebradas."
...
L.AUTO_ANNOUNCE_OPTIONS.countdown		= "Exibir contagem regressiva de anúncio antecipado para $spell:%s"
...
L.AUTO_ANNOUNCE_OPTIONS.prestage		= "Exibir anúncio antecipado para a fase %s"
L.AUTO_ANNOUNCE_OPTIONS.count			= "Exibir anúncio (com contagem) para $spell:%s"
