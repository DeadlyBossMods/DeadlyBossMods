...
DBM_CORE_RAID_DOWN								= "%s清除 用了%s！"
DBM_CORE_RAID_DOWN_L							= "%s清除 用時%s！你最快的清除紀錄 %s。"
DBM_CORE_RAID_DOWN_NR						= "%s清除 用時%s！這是一個新紀錄！(舊紀錄為 %s)。"
...
DBM_CORE_RANGECHECK_RHEADER			= "反向距離監視 (%d碼)"
DBM_CORE_RANGECHECK_RHEADERT		= "反向距離監視 (%d碼-%d人)"
...
DBM_CORE_RANGECHECK_SETRANGE_TO		= "%d 碼"
...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.targetNF			= "警告：$spell:%s的目標(忽略全局目標過濾)"
...
DBM_CORE_AUTO_SPEEDCLEAR_OPTION_TEXT	= "顯示 %s 的最快清除計時器"
...
--LDB
DBM_LDB_TOOLTIP_HELP1	= "左鍵點擊開啟 "..DBM_DBM
DBM_LDB_TOOLTIP_HELP2	= "右鍵點擊以切換靜默模式"
