...
L.AUTO_SPEC_WARN_TEXTS.blizztarget			= ">%%2$s<中了%s (%%1$s) "L.AUTO_SPEC_WARN_TEXTS.blizzyou					= "你中了%s (%%s)"L.AUTO_SPEC_WARN_TEXTS.link					= "%s 與 >%%s< 連結"
...
L.AUTO_SPEC_WARN_OPTIONS.blizztarget 		= "特別提示：當他人中了$spell:%s時 (包含計數)"L.AUTO_SPEC_WARN_OPTIONS.blizzyou		= "特別提示：當你中了$spell:%s時 (包含計數)"L.AUTO_SPEC_WARN_OPTIONS.link				= "特別提示：當你中了$spell:%s與其他玩家連結時"
