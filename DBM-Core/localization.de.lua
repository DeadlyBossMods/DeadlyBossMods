...
DBM_CORE_AUTO_TIMER_OPTIONS = {
	target = "Debufftimer f�r |cff71d5ff|Hspell:%d|h%s|h|r anzeigen",
	cast = "Casttimer f�r |cff71d5ff|Hspell:%d|h%s|h|r anzeigen",
	active = "Timer w�hrend |cff71d5ff|Hspell:%d|h%s|h|r aktiv ist anzeigen",
	cd = "Cooldowntimer f�r |cff71d5ff|Hspell:%d|h%s|h|r anzeigen",
	next = "Timer f�r n�chstes |cff71d5ff|Hspell:%d|h%s|h|r anzeigen",
	achievement = "Timer f�r %s anzeigen"
}
