...
L.GUILD_COMBAT_STARTED			= "%s wurde von der Gildengruppe von %s in den Kampf verwickelt"
...
L.GUILD_BOSS_DOWN			= "%s wurde von der Gildengruppe von %s nach %s besiegt!"
...
L.GUILD_COMBAT_ENDED_AT		= "Die Gildengruppe von %s ist bei %s (%s) nach %s gewiped."
...
L.MOVIE_NOTSKIPPED			= L.DBM .. " hat eine überspringbare Zwischensequenz erkannt, diese jedoch aufgrund eines Blizzard-Fehlers NICHT übersprungen. Sobald dieser Fehler behoben ist, wird das Überspringen wieder aktiviert."
...
L.PROFILE_NOT_FOUND			= "<"..L.DBM.."> Dein derzeitiges Profil ist korrupt. "..L.DBM.." wird das Profil '%s' laden."
...
L.PROFILE_DELETED			= "Profil '%s' gelöscht. Profil '%s' wird angewendet."
L.PROFILE_DELETE_ERROR		= "Löschen des Profils fehlgeschlagen. Profil '%s' existiert nicht."
L.PROFILE_CANNOT_DELETE		= "Das Profil '%s' kann nicht gelöscht werden."
...
L.OPTION_CATEGORY_PAURAS 			= "Private Auren"
...
L.UPDATEREMINDER_DISABLETEST 	= "WARNUNG: Da dein " .. L.DEADLY_BOSS_MODS .. " veraltet ist und dies ein Test-/Beta-Server ist, wurde es zwangsweise deaktiviert und kann erst nach einem Update wieder verwendet werden. Dies soll sicherstellen, dass keine veralteten Mods zur Generierung von Test-Feedback verwendet werden."
...
L.BREAK_MIN					= "Pause endet in %s |4Minute:Minuten!"
L.BREAK_SEC					= "Pause endet in %s |4Sekunde:Sekunden!"
L.TIMER_BREAK				= "Pause!"
L.ANNOUNCE_BREAK_OVER		= "Pause ist vorbei (seit %s Uhr)"

L.TIMER_PULL					= "Pull in"
L.ANNOUNCE_PULL				= "Pull in %d |4Sekunde:Sekunden. (gesendet von: %s)"
L.ANNOUNCE_PULL_NOW			= "Pull jetzt!"
L.ANNOUNCE_PULL_TARGET		= "Pulle %s in %d |4Sekunde:Sekunden. (gesendet von: %s)"
...
L.AUTO_ANNOUNCE_TEXTS.blizztarget	= "%s (%%s) auf >%%s<"
L.AUTO_ANNOUNCE_TEXTS.spell			= "%s"
L.AUTO_ANNOUNCE_TEXTS.incoming		= "%s eingehender Debuff"
L.AUTO_ANNOUNCE_TEXTS.incomingcount	= "%s eingehender Debuff (%%s)"
...
L.AUTO_ANNOUNCE_OPTIONS.targetsource	= "Verkünde (mit Quelle) Ziele von $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.targetcount		= "Verkünde (mit Zähler) Ziele von $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.blizztarget		= "Verkünde (mit Zähler) Ziele von $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.spell			= "Zeige Warnung für $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.incoming		= "Zeige Warnung, wenn $spell:%s eingehende Debuffs hat"
L.AUTO_ANNOUNCE_OPTIONS.incomingcount	= "Zeige Warnung (mit Zähler), wenn $spell:%s eingehende Debuffs hat"
...
L.AUTO_ANNOUNCE_OPTIONS.sooncount		= "Zeige Vorwarnung (mit Zähler) für $spell:%s"
...
L.AUTO_ANNOUNCE_OPTIONS.count			= "Zeige Warnung (mit Zähler) für $spell:%s"
...
L.AUTO_SPEC_WARN_TEXTS.blizztarget		= "%s (%%s) auf >%%s< "
L.AUTO_SPEC_WARN_TEXTS.blizzyou			= "%s (%%s) auf dir"
L.AUTO_SPEC_WARN_TEXTS.defensive		= "%s - Defensivfähigkeiten"
L.AUTO_SPEC_WARN_TEXTS.taunt			= "%s auf >%%s< - jetzt spotten"
L.AUTO_SPEC_WARN_TEXTS.tauntsecret	= "%s auf %%s - jetzt spotten"
...
L.AUTO_SPEC_WARN_TEXTS.runcount 		= "%s – weglaufen (%%s)"
...
L.AUTO_SPEC_WARN_TEXTS.addscount 		= "Eingehende Adds – Ziel wechseln (%%s)"
...
L.AUTO_SPEC_WARN_OPTIONS.sooncount		= "Spezialvorwarnung (mit Zähler) für $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.interruptcount	= "Spezialwarnung (mit Zähler) zum Unterbrechen von $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.you 			= "Spezialwarnung, wenn du von $spell:%s betroffen bist"
L.AUTO_SPEC_WARN_OPTIONS.youcount		= "Spezialwarnung (mit Zähler), wenn du von $spell:%s betroffen bist"
...
L.AUTO_SPEC_WARN_OPTIONS.targetcount 	= "Spezialwarnung (mit Zähler), wenn jemand von $spell:%s betroffen ist"
L.AUTO_SPEC_WARN_OPTIONS.blizztarget 	= "Spezialwarnung (mit Zähler), wenn jemand von $spell:%s betroffen ist"
L.AUTO_SPEC_WARN_OPTIONS.blizzyou		= "Spezialwarnung (mit Zähler), wenn du von $spell:%s betroffen bist"
...
L.AUTO_SPEC_WARN_OPTIONS.dodgecount		= "Spezialwarnung (mit Zähler) zum Ausweichen bei $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.moveawaycount	= "Spezialwarnung (mit Zähler) zum Weggehen von anderen bei $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.soakcount		= "Spezialwarnung (mit Zähler) zum Soaken für $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.runcount 		= "Zeige Spezialwarnung (mit Zähler), um vor $spell:%s wegzulaufen"
...
L.AUTO_SPEC_WARN_OPTIONS.switchcount	= "Spezialwarnung (mit Zähler) für Zielwechsel auf $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.addscount 		= "Spezialwarnung (mit Zähler), um bei eingehenden Adds das Ziel zu wechseln"
...
L.AUTO_TIMER_TEXTS.stagecount			= "Phase %%s"--NICHT FEHLERHAFT, Phase ist 2. Argument, spellID wird absichtlich ignoriert
L.AUTO_TIMER_TEXTS.stagecountcycle		= "Phase %%s (%%s)"--^^ Beispiel: Phase 2 (3) für einen Kampf, der zwischen Phase 1 und 2 wechselt, aber auch Zyklen zählt
...
L.AUTO_TIMER_OPTIONS.targetcount= "Dauer des Debuffs (mit Zähler) für $spell:%s anzeigen"
L.AUTO_TIMER_OPTIONS.cast		= "Wirkzeit von $spell:%s anzeigen"
L.AUTO_TIMER_OPTIONS.castcount	= "Wirkzeit (mit Zähler) von $spell:%s anzeigen"
...
L.AUTO_TIMER_OPTIONS.cdnp 		= "Zeige nur Namensplaketten-Timer für die Abklingzeit von $spell:%s"
...
L.AUTO_TIMER_OPTIONS.cdcombo	= "Zeige Timer für den Abklingzeit-Kombotimer von Fähigkeiten"--Wird verwendet, um 2 Fähigkeiten zu einem einzigen Timer zu kombinieren
...
L.AUTO_TIMER_OPTIONS.nextnp		= "Zeige nur Namensplaketten-Timer für die nächste $spell:%s Fähigkeit"
...
L.AUTO_TIMER_OPTIONS.var			= "Zeige Timer (mit Varianz) für die Abklingzeit von $spell:%s"
L.AUTO_TIMER_OPTIONS.varcount		= "Zeige Timer (mit Zähler und Varianz) für die Abklingzeit von $spell:%s"
L.AUTO_TIMER_OPTIONS.varnp			= "Zeige nur den Namensplaketten-Timer (mit Varianz) für die Abklingzeit von $spell:%s"
L.AUTO_TIMER_OPTIONS.varpnp			= "Zeige nur den priorisierten Namensplaketten-Timer (mit Varianz) für die Abklingzeit von $spell:%s"
L.AUTO_TIMER_OPTIONS.varsource		= "Zeige Timer (mit Varianz und Zauberquelle) für die Abklingzeit von $spell:%s"
L.AUTO_TIMER_OPTIONS.varspecial		= "Zeige Timer (mit Varianz) für die Abklingzeit einer Spezialfähigkeit"
L.AUTO_TIMER_OPTIONS.varcombo		= "Zeige Timer (mit Varianz) für die Abklingzeit von Fähigkeitskombos"
L.AUTO_TIMER_OPTIONS.nextcombo		= "Zeige Timer für die nächste Fähigkeitskombination"--Wird verwendet, um 2 Fähigkeiten zu einem einzigen Timer zu kombinieren
L.AUTO_TIMER_OPTIONS.achievement	= "Zeit für %s anzeigen"
L.AUTO_TIMER_OPTIONS.stage			= "Zeige Zeit bis nächste Phase"
L.AUTO_TIMER_OPTIONS.stagecount				= "Zeige Timer (mit Zähler) für die nächste Phase"
L.AUTO_TIMER_OPTIONS.stagecountcycle		= "Zeige Timer (mit Phasenzähler und Zykluszähler) für die nächste Phase"
L.AUTO_TIMER_OPTIONS.stagecontext			= "Zeige Timer für die nächste $spell:%s Phase"
L.AUTO_TIMER_OPTIONS.stagecontextcount		= "Zeige Timer (mit Zähler) für die nächste $spell:%s Phase"
L.AUTO_TIMER_OPTIONS.intermission			= "Zeige Timer für die nächste Zwischenphase"
L.AUTO_TIMER_OPTIONS.intermissioncount		= "Zeige Timer (mit Zähler) für die nächste Zwischenphase"
L.AUTO_TIMER_OPTIONS.adds		= "Zeige Zeit bis Adds erscheinen"
L.AUTO_TIMER_OPTIONS.addscount	= "Zeige Timer (mit Zähler) bis Adds erscheinen"
...
L.AUTO_YELL_OPTION_TEXT.count			= "Schreie (mit Zähler), wenn du von $spell:%s betroffen bist"
...
L.AUTO_NAMEPLATE_OPTION_TEXT_FORCED		= "Zeige Namensplaketten-Auren für $spell:%s ausschließlich mit " .. L.DBM
...
L.AUTO_PRIVATEAURA_OPTION_TEXT	= "Spiele DBM-Soundwarnungen für die Private Auren von $spell:%s in diesem Kampf ab."
...
L.KEYSTONES_HEADER			= L.DBM .. " - Schlüsselsteine"

L.OVERRIDE_ACTIVATED		= "Konfigurations-Overrides wurden für diesen Kampf vom Schlachtzugsleiter aktiviert"
...
L.WORLD_BUFFS.blackfathomBoon	= "Segen von Blackfathom"
