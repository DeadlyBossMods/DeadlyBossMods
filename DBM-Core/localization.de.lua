...
L.AUTO_SPEC_WARN_TEXTS.blizztarget		= "%s (%%s) auf >%%s< "L.AUTO_SPEC_WARN_TEXTS.blizzyou				= "%s (%%s) auf dir"L.AUTO_SPEC_WARN_TEXTS.defensive		= "%s - Defensivfähigkeiten"
...
L.AUTO_SPEC_WARN_OPTIONS.blizztarget 	= "Spezialwarnung (mit Zählung), wenn jemand von $spell:%s betroffen ist"L.AUTO_SPEC_WARN_OPTIONS.blizzyou		= "Spezialwarnung (mit Zählung), wenn du von $spell:%s betroffen bist"L.AUTO_SPEC_WARN_OPTIONS.defensive 		= "Spezialwarnung zur Nutzung von Defensivfähigkeiten bei $spell:%s"
