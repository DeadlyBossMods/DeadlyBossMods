...
L.PROFILE_NOT_FOUND			= "<"..L.DBM.."> Dein derzeitiges Profil ist korrupt. "..L.DBM.." wird das Profil 'Standard' laden."
...
L.PROFILE_DELETED			= "Profil '%s' gelöscht. Profil 'Standard' wird angewendet."
L.PROFILE_DELETE_ERROR		= "Löschen des Profils fehlgeschlagen. Profil '%s' existiert nicht."
L.PROFILE_CANNOT_DELETE		= "Das Profil 'Standard' kann nicht gelöscht werden."
