...
L.AUTO_ANNOUNCE_OPTIONS.blizztarget		= "Verkünde Ziele von $spell:%s (mit Zählung)"
...
L.AUTO_SPEC_WARN_OPTIONS.blizztarget 	= "Spezialwarnung (mit Zählung), wenn jemand von $spell:%s betroffen ist"
L.AUTO_SPEC_WARN_OPTIONS.blizzyou		= "Spezialwarnung (mit Zählung), wenn du von $spell:%s betroffen bist"
