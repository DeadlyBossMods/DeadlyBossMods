...
L.AUTO_SPEC_WARN_TEXTS.blizztarget		= "%s (%%s) sur >%%s< "L.AUTO_SPEC_WARN_TEXTS.blizzyou				= "%s (%%s) sur vous"L.AUTO_SPEC_WARN_TEXTS.link				= "%s lié avec >%%s<"
...
L.AUTO_SPEC_WARN_OPTIONS.blizztarget 	= "Afficher une annonce spéciale (avec compte) quand quelqu'un est affecté par $spell:%s"L.AUTO_SPEC_WARN_OPTIONS.blizzyou		= "Afficher une annonce spéciale (avec compte) quand vous êtes affecté par $spell:%s"L.AUTO_SPEC_WARN_OPTIONS.link			= "Afficher une annonce spéciale lorsque vous êtes lié à un autre joueur par $spell:%s"
