...
L.UPDATEREMINDER_MAJORPATCH = "ATTENTION : Une mise à jour majeure du jeu a eu lieu et votre " .. L.DBM .. " est obsolète. Il a été désactivé pour éviter des problèmes causés par un code incompatible. Téléchargez la dernière version sur deadlybossmods.com ou Curse dès que possible."
...
L.DPMCORE = "ATTENTION : Deadly PvP Mods est obsolète et incompatible avec cette version de " .. L.DBM .. ". Veuillez le supprimer pour éviter les conflits."
L.DBMLDB = "ATTENTION : DBM-LDB est maintenant intégré dans DBM-Core. Bien qu'il ne provoque aucun problème, il est recommandé de supprimer 'DBM-LDB' de votre dossier d'addons."
L.DBMLOOTREMINDER = "ATTENTION : Vous avez installé le module tiers DBM-LootReminder. Cet addon n'est plus compatible avec le client WoW Retail et provoque des problèmes avec " .. L.DBM .. ", notamment sur les chronomètres de pull. Il est recommandé de le désinstaller."
...
L.OUT_OF_DATE_NAG = "Votre version de " .. L.DBM .. " est obsolète. Il est recommandé de la mettre à jour pour ne pas manquer des alertes, des chronomètres ou des notifications importantes pour votre raid."
