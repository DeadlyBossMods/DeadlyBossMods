...
local prewarnOption 					= "Pré-annonce concernant $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.you				= "Annoncer lorsque $spell:%s est sur vous."
...
L.AUTO_ANNOUNCE_OPTIONS.spell			= "Annoncer $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.incoming		= "Annoncer lorsque $spell:%s a des affaiblissements imminents"
L.AUTO_ANNOUNCE_OPTIONS.incomingcount 	= "Annoncer (avec décompte) lorsque $spell:%s a des affaiblissements imminents"
L.AUTO_ANNOUNCE_OPTIONS.ends			= "Annoncer lorsque $spell:%s se termine"
L.AUTO_ANNOUNCE_OPTIONS.endtarget   	= "Annoncer lorsque $spell:%s se termine (avec cible)"
L.AUTO_ANNOUNCE_OPTIONS.fades			= "Annoncer lorsque $spell:%s se dissipe"
L.AUTO_ANNOUNCE_OPTIONS.addsleft		= "Annoncer le nombre restant de : $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.cast			= "Annoncer lorsque $spell:%s est incanté"
L.AUTO_ANNOUNCE_OPTIONS.soon			= prewarnOption
L.AUTO_ANNOUNCE_OPTIONS.sooncount		= prewarnOption
L.AUTO_ANNOUNCE_OPTIONS.countdown		= "Afficher les pré-annonces au compte à rebours pour $spell:%s"
...
L.AUTO_ANNOUNCE_OPTIONS.stage			= "Annoncer l'arrivée de la phase %s"
L.AUTO_ANNOUNCE_OPTIONS.stagechange		= "Annoncer les changements de phase"
L.AUTO_ANNOUNCE_OPTIONS.prestage		= "Annoncer préventive indiquant l'arrivée de la phase %s"
L.AUTO_ANNOUNCE_OPTIONS.count			= "Annoncer concernant $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.stack			= "Annoncer les cumuls de $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.moveto			= "Annoncer quand se déplacer vers quelqu'un ou quelque part pour $spell:%s"
