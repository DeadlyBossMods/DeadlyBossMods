...
L.BOSS_DOWN_I					= "%s vaincu ! Vous avez un total de %d |4victoire:victoires;."
...
L.INFOFRAME_SETSTRATA 			= "Strate du cadre"
...
L.AUTO_ANNOUNCE_OPTIONS.targetsource	= "Afficher une annonce (avec la source) pour les cibles de $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.targetcount		= "Afficher une annonce (avec compte) pour les cibles de $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.blizztarget		= "Afficher une annonce (avec compte) pour les cibles de $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.spell			= "Afficher une annonce pour $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.spellsource		= "Afficher une annonce (avec la source) pour $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.incoming		= "Afficher une annonce lorsque $spell:%s a des affaiblissements imminents"
L.AUTO_ANNOUNCE_OPTIONS.incomingcount 	= "Afficher une annonce (avec compte) lorsque $spell:%s a des affaiblissements imminents"
L.AUTO_ANNOUNCE_OPTIONS.ends			= "Afficher une annonce pour lorsque $spell:%s se termine"
L.AUTO_ANNOUNCE_OPTIONS.endtarget   	= "Afficher une annonce (avec cible) pour lorsque $spell:%s se termine"
...
L.AUTO_ANNOUNCE_OPTIONS.sooncount		= "Afficher une pré-annonce (avec compte) pour $spell:%s"
...
L.AUTO_ANNOUNCE_OPTIONS.count			= "Afficher une annonce (avec compte) pour $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.youposcount 	= "Afficher une annonce spéciale (avec position et compte) lorsque vous êtes affecté par $spell:%s"
...
L.AUTO_TIMER_OPTIONS.addscount			= "Afficher un chronomètre (avec compte) pour les adds imminents"
...
L.MN_TEXT_TIMERS_HEADER = "Voulez-vous utiliser les décomptes textuels ?\n(Utilise les données des barres de DBM, même si elles ne sont pas affichées)"
