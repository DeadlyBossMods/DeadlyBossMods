...
DBM_CORE_BOSS_DOWN_L				= "%s погибает спустя %s! Последний бой длился %s, лучший бой длился %s. Общее количество побед у Вас %d."
...
DBM_CORE_ACHIEVEMENT_TIMER_SPEED_KILL = "Быстрая победа"
...
DBM_INSTANCE_INFO_ALL_RESPONSES		= "Получен ответ от всех членов рейда"
...
DBM_INSTANCE_INFO_RESULTS			= "Результаты сканирования сохранений. Отметим, что инстансы могут появляться более одного раза, если в вашем рейде есть игроки с локализованными клиентами WoW."
