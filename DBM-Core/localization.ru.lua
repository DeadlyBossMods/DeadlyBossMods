...
L.SLASHCMD_HELP							= {--AI translated (check me)
	"Доступные команды:",
	"-----------------",
	"/dbm unlock: Показывает перемещаемый таймер статус-бара (псевдоним: move).",
	...
	"/dbm timer: Запускает пользовательский таймер " .. L.DBM .. ", смотрите '/dbm timer' для деталей.",
	"/keys: Выполняет проверки ключей M+ и рейтингов в группе/гильдии и предоставляет ярлыки для телепортации в подземелья. (псевдоним: key, keystone)",
...
L.SLASHCMD_HELP2						= {--AI translated (check me)
	"Доступные команды:",
	"-----------------",
	"/dbm version: Выполняет проверку версии модификации боссов (псевдоним: ver).",
	"/dbm version2: Выполняет проверку версии модификации боссов, которая также шепчет устаревшим пользователям (псевдоним: ver2).",
	"/range <number> или /distance <number>: Показывает фрейм диапазона. /rrange или /rdistance для обратных цветов.",
	"/hudar <number>: Показывает HUD для определения расстояния.",
	"/dbm arrow: Показывает стрелку " .. L.DBM .. ", смотрите '/dbm arrow help' для деталей.",
	"/dbm hud: Показывает HUD " .. L.DBM .. ", смотрите '/dbm hud' для деталей."
}
L.TIMER_USAGE = {
