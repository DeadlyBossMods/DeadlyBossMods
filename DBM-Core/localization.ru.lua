...
L.AUTO_ANNOUNCE_OPTIONS = {
	...
	targetcount						= "Объявлять цели заклинания $spell:%s (со счётчиком)",
	...
	count 							= "Предупреждение для $spell:%s (со счётчиком)",
...
L.AUTO_SPEC_WARN_OPTIONS = {
	...
	sooncount						= "Спец-предупреждение (со счётчиком) для $spell:%s",
	...
	interruptcount					= "Спец-предупреждение (со счётчиком) для прерывания заклинания $spell:%s",
	you 							= "Спец-предупреждение, когда на вас $spell:%s",
	youcount						= "Спец-предупреждение (со счётчиком), когда на вас $spell:%s",
	...
	targetcount						= "Спец-предупреждение (со счётчиком), когда на ком-то $spell:%s",
	...
	dodgecount						= "Спец-предупреждение \"избегайте\" (со счётчиком) для $spell:%s",
	...
	moveawaycount					= "Спец-предупреждение \"отбегите от остальных\" (со счётчиком) для $spell:%s",
	...
	count 							= "Спец-предупреждение (со счётчиком) для $spell:%s",
	stack 							= "Спец-предупреждение, когда на вас >=%d стаков $spell:%s",
	switch							= "Спец-предупреждение о смене цели для $spell:%s",
	switchcount 					= "Спец-предупреждение (со счётчиком) о смене цели для $spell:%s",
...
L.AUTO_TIMER_TEXTS = {
	...
	nextspecialshort				= "Спец-способность",
	achievement						= "%s",
	stage							= "След. фаза",
	stageshort						= "Фаза",
	adds							= "Прибытие аддов",
...
L.AUTO_TIMER_OPTIONS = {
	...
	castcount						= "Отсчёт времени применения заклинания (со счётчиком) для $spell:%s",
