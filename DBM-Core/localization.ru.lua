...
L.NEWS_UPDATE						= "|h|c11ff1111Новости|r|h: Это обновление меняет структуру модов, поэтому Классические и Основные версии теперь используют унифицированные (одинаковые) модули. Это означает, что модули Vanilla (включая Сезон открытий), TBC, Wrath и Cata теперь устанавливаются отдельно, используя те же пакеты, что и Актуальные. Подробнее об этом |Hgarrmission:DBM:news|h|cff3588ff[здесь]|r|h"
