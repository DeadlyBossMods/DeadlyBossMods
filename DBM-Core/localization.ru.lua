...
L.NEWS_UPDATE						= "|h|c11ff1111Новости|r|h: DBM был обновлен с изменениями в структуре модов, поэтому Классическая и Актуальная версии теперь могут использовать унифицированные (одинаковые) модули. Это означает, что рейдовые модули Vanilla (включая Сезон открытий), TBC, Wrath и Cata теперь устанавливаются отдельно, используя те же пакеты, что и Актуальные. Подробнее об этом читайте |Hgarrmission:DBM:news|h|cff3588ff[здесь]|r|h"
L.NEWS_UPDATE_REPEAT				= "|h|c11ff1111Новости|r|h: DBM был обновлен с изменениями в структуре модов, поэтому Классическая и Актуальная версии теперь могут использовать унифицированные (одинаковые) модули. Это означает, что рейдовые модули Vanilla (включая Сезон открытий), TBC, Wrath и Cata теперь устанавливаются отдельно, используя те же пакеты, что и Актуальные. В данный момент Вы находитесь в рейде, в котором отсутствует модуль. Это сообщение будет отображаться (и у Вас не будет функциональных оповещений для этой зоны), пока Вы не установите отсутствующий модуль рейда."
