...
L.VERSIONCHECK_OUTDATED				= "Следующие %d игрок(и) имеют устаревшую версию Boss Mod: %s"
...
L.AUTO_ANNOUNCE_OPTIONS.spell 			= "Объявить, когда будет произнесено заклинание $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.spellsource 	= "Объявить, когда будет произнесено заклинание $spell:%s (источник)"
...
L.AUTO_TIMER_OPTIONS.castpnp 		= "Приоритетный отсчёт времени применения заклинания $spell:%s (только индикарторы здоровья)"
