...
L.VOICE_PACK_OUTDATED				= "В вашем голосовом пакете " .. L.DBM .. " отсутствуют звуки, поддерживаемые этой версией " .. L.DBM .. ". Фильтр звуков спец-предупреждений был отключен. Пожалуйста, скачайте обновлённую версию голосового пакета или свяжитесь с автором для обновления, которое содержит отсутствующие звуковые файлы."
...
L.VOICE_DISABLED					= "У вас установлен по крайней мере один голосовой пакет " .. L.DBM .. ", но ни один не включен. Если вы собираетесь использовать голосовой пакет, убедитесь, что он выбран в 'Spoken Alerts', иначе удалите неиспользуемые голосовые пакеты, чтобы скрыть это сообщение"
L.VOICE_COUNT_MISSING				= "Голос отсчёта %d использует голововой пакет, который не был найден. Он был сброшен на настройки по умолчанию: %s."
L.BIG_WIGS							= "BigWigs"
...
L.UPDATEREMINDER_DISABLE			= "ПРЕДУПРЕЖДЕНИЕ: В связи с тем, что Ваш " .. L.DEADLY_BOSS_MODS .. " сильно устарел, он был отключен до обновления. Это сделано для того, чтобы старый и несовместимый код не вызывал плохой игровой опыт для Вас и других членов группы."
...
L.OUTDATEDPROFILES					= "ПРЕДУПРЕЖДЕНИЕ: DBM-Profiles не совместим с этой версией " .. L.DBM .. ". Он должен быть удален, прежде чем DBM сможет продолжить, чтобы избежать конфликтов."
...
L.AUTO_ANNOUNCE_TEXTS = {
	you 							= "%s на тебе",
	target 							= "%s на |3-5(>%%s<)",
	targetsource   					= ">%%s< применяется %s на >%%s<",
	targetcount						= "%s (%%s) на |3-5(>%%s<)",
	spell 							= "%s",
	ends							= "%s заканчивается",
	endtarget						= "%s заканчивается: >%%s<",
	fades							= "%s спадает",
	adds							= "Осталось %s: %%d",
...
L.AUTO_ANNOUNCE_OPTIONS = {
	you 							= "Объявлять когда $spell:%s на тебе",
	target 							= "Объявлять цели заклинания $spell:%s",
	targetNF						= "Объявлять цели заклинания $spell:%s (игнорирует глобальные фильтры целей)",
	targetsource					= "Объявлять цели заклинания $spell:%s (с источником)",
	targetcount						= "Объявлять цели заклинания $spell:%s (со счетчиком)",
	spell 							= "Предупреждение для $spell:%s",
	ends							= "Предупреждать об окончании $spell:%s",
	endtarget						= "Предупреждать об окончании $spell:%s (цель)",
	...
	countdown						= "Спамить заранее отсчёт до заклинания $spell:%s",
	prewarn 						= prewarnOption,
	bait							= "Предупреждать заранее (чтобы байтить) для $spell:%s",
	stage 							= "Объявлять фазу %s",
	stagechange						= "Объявлять смены фаз",
	prestage 						= "Предупреждать заранее о фазе %s",
	count 							= "Предупреждение для $spell:%s (со счетчиком)",
	stack 							= "Объявлять количество стаков $spell:%s",
	moveto							= "Показывать предупреждение идти к кому-то или куда-то для заклинания $spell:%s"
}
...
L.AUTO_SPEC_WARN_TEXTS = {
	...
	interrupt						= "%s - прервите >%%s<!",
	interruptcount					= "%s - прервите >%%s<! (%%d)",
	you 							= "%s на вас",
	youcount						= "%s (%%s) на вас",
	youpos							= "%s (Позиция: %%s) на вас",
	soakpos							= "%s (Позиция погл.: %%s)",
	target 							= "%s на |3-5(>%%s<)",
	targetcount						= "%s (%%s) на >%%s< ",
	defensive						= "%s - защититесь",
	taunt							= "%s на >%%s< - затаунти",
	close 							= "%s на |3-5(>%%s<) около вас",
	move 							= "%s - отбегите",
	keepmove						= "%s - продолжайте двигаться",
	stopmove						= "%s - остановитесь",
	dodge							= "%s - избегайте",
	dodgecount						= "%s (%%s) - избегайте",
	dodgeloc						= "%s - избегайте от %%s",
	moveaway						= "%s - отбегите от остальных",
	moveawaycount					= "%s (%%s) - отбегите от остальных",
	moveto							= "%s - бегите к >%%s<",
	soak							= "%s - перекройте",
	jump							= "%s - подпрыгните",
	run 							= "%s - убегайте",
	cast 							= "%s - прекратите чтение заклинаний",
	lookaway						= "%s на %%s - отвернитесь",
	reflect 						= "%s на |3-5(>%%s<) - прекратите атаку",
	count 							= "%s! (%%s)",
	stack 							= "На вас %%d стаков от %s",
	switch 							= "%s - переключитесь",
	switchcount 					= "%s - переключитесь (%%s)",
	gtfo							= "Под вами %%s - выбегите",
	adds							= "Прибыли адды - смените цель",
	addscustom						= "Прибыли адды - %%s",
	targetchange					= "Смена цели - переключитесь на %%s"
}
...
L.AUTO_SPEC_WARN_OPTIONS = {
	...
	sooncount						= "Спец-предупреждение (со счетчиком) для $spell:%s",
	bait							= "Спец-предупреждение (для байта) для $spell:%s",
	prewarn 						= "Спец-предупреждение за %s сек. до $spell:%s",
	dispel 							= "Спец-предупреждение для рассеивания/похищения заклинания $spell:%s",
	interrupt						= "Спец-предупреждение для прерывания заклинания $spell:%s",
	interruptcount					= "Спец-предупреждение (со счетчиком) для прерывания заклинания $spell:%s",
	you 							= "Спец-предупреждение, когда на вас $spell:%s",
	youcount						= "Спец-предупреждение (со счетчиком), когда на вас $spell:%s",
	youpos							= "Спец-предупреждение (с позицией) когда на вас $spell:%s",
	soakpos							= "Спец-предупреждение (с позицией) для помощи с поглощением $spell:%s",
	target 							= "Спец-предупреждение, когда на ком-то $spell:%s",
	targetcount						= "Спец-предупреждение (со счетчиком), когда на ком-то $spell:%s",
	defensive 						= "Спец-предупреждение для использования защитных способностей от $spell:%s",
	taunt 							= "Спец-предупреждение \"затаунти\", когда на другом танке $spell:%s",
	close 							= "Спец-предупреждение, когда на ком-то рядом с вами $spell:%s",
	move 							= "Спец-предупреждение \"отбегите\" для $spell:%s",
	keepmove 						= "Спец-предупреждение \"продолжайте двигаться\" для $spell:%s",
	stopmove 						= "Спец-предупреждение \"остановитесь\" для $spell:%s",
	dodge 							= "Спец-предупреждение \"избегайте\" для $spell:%s",
	dodgecount						= "Спец-предупреждение \"избегайте\" (со счетчиком) для $spell:%s",
	dodgeloc						= "Спец-предупреждение \"избегайте\" (с местом) для $spell:%s",
	moveaway						= "Спец-предупреждение \"отбегите от остальных\" для $spell:%s",
	moveawaycount					= "Спец-предупреждение \"отбегите от остальных\" (со счетчиком) для $spell:%s",
	moveto							= "Спец-предупреждение \"бегите к кому-то\", на ком $spell:%s",
	soak							= "Спец-предупреждение \"перекройте\" для $spell:%s",
	jump							= "Спец-предупреждение \"подпрыгните\" для $spell:%s",
	run 							= "Спец-предупреждение \"убегайте\" для $spell:%s",
	cast 							= "Спец-предупреждение \"прекратите чтение заклинаний\" для $spell:%s",
	lookaway						= "Спец-предупреждение \"отвернитесь\" для $spell:%s",
	reflect 						= "Спец-предупреждение \"прекратите атаку\" для $spell:%s",
	count 							= "Спец-предупреждение (со счетчиком) для $spell:%s",
	stack 							= "Спец-предупреждение, когда на вас >=%d стаков $spell:%s",
	switch							= "Спец-предупреждение о смене цели для $spell:%s",
	switchcount 					= "Спец-предупреждение (со счетчиком) о смене цели для $spell:%s",
	gtfo 							= "Спец-предупреждение выбегите из войды на земле",
	adds							= "Спец-предупреждение сменить цель для прибывающих аддов",
	addscustom						= "Спец-предупреждение для прибывающих аддов",
	targetchange					= "Спец-предупреждение для смены приоритетной цели"
}
...
L.AUTO_TIMER_TEXTS = {
	...
	cdsource						= "Восст. %s: >%%s<",
	cdsourceshort					= "~%s: >%%s<",
	cdspecial						= "Восст. спец-способности",
	cdspecialshort					= "~Восст. спец-способности",
	next 							= "След. %s",
	nextshort						= "%s",
	nextcount						= "След. %s (%%s)",
	nextcountshort					= "%s (%%s)",
	nextsource						= "След. %s: >%%s<",
	nextsourceshort					= "%s: %%s",
	nextspecial						= "След. спец-способность",
	nextspecialshort				= "Cпец-способность",
	achievement						= "%s",
	stage							= "След. фаза",
	stageshort						= "Фаза",
	adds							= "Прибытие аддов",
	addsshort						= "Адды",
	addscustom						= "Прибытие аддов (%%s)",
	addscustomshort					= "Адды (%%s)",
	roleplay						= GUILD_INTEREST_RP
}

L.AUTO_TIMER_OPTIONS = {
	target 							= "Отсчёт времени действия дебаффа $spell:%s",
	cast 							= "Отсчёт времени применения заклинания $spell:%s",
	castcount						= "Отсчёт времени применения заклинания (со счетчиком) для $spell:%s",
	castsource						= "Отсчёт времени применения заклинания (с источником) для $spell:%s",
	active 							= "Отсчёт времени действия $spell:%s",
	fades							= "Отсчёт времени до спадения $spell:%s с игроков",
	ai								= "Отсчёт времени до восстановления $spell:%s (ИИ)",
	cd 								= "Отсчёт времени до восстановления $spell:%s",
	cdcount 						= "Отсчёт времени до восстановления $spell:%s",
	cdsource						= "Отсчёт времени до восстановления $spell:%s (с источником)",
	cdspecial						= "Отсчёт времени до восстановления спец-способности",
	next 							= "Отсчёт времени до следующего $spell:%s",
	nextcount 						= "Отсчёт времени до следующего $spell:%s",
	nextsource						= "Отсчёт времени до следующего $spell:%s (с источником)",
	nextspecial						= "Отсчёт времени до следующей спец-способности",
	achievement 					= "Отсчёт времени для %s",
	stage							= "Отсчёт времени до следующей фазы",
	adds							= "Отсчёт времени до прибытия аддов",
	addscustom						= "Отсчёт времени до прибытия аддов",
	roleplay						= "Отсчёт времени для ролевой игры"
}
...
L.AUTO_YELL_OPTION_TEXT = {
	shortyell						= "Кричать, когда на вас $spell:%s",
	yell							= "Кричать (с именем игрока), когда на вас $spell:%s",
	count							= "Кричать (со счётчиком), когда на вас $spell:%s",
	fade							= "Кричать (с обратный отсчётом), когда $spell:%s спадает",
	shortfade						= "Кричать (с обратный отсчётом), когда $spell:%s спадает",
	iconfade						= "Кричать (с обратный отсчётом и меткой), когда $spell:%s спадает",
	position						= "Кричать (с позицией), когда на вас $spell:%s",
	combo							= "Кричать (с пользовательским текстом), когда на вас $spell:%s и в тоже время другие заклинания",
	repeatplayer					= "Кричать повторно (с именем игрока), когда на вас $spell:%s",
	repeaticon						= "Кричать повторно (с меткой), когда на вас $spell:%s"
}
L.AUTO_YELL_ANNOUNCE_TEXT = {
	shortyell						= "%s",
	yell							= "%s на " .. UnitName("player") .. "!",
	count							= "%s на " .. UnitName("player") .. "! (%%d)",
	fade							= "%s спадает через %%d",
	shortfade						= "%%d",
	iconfade						= "{rt%%2$d}%%1$d",
	position 						= "%s %%s на {rt%%d}"..UnitName("player").."{rt%%d}",
	combo							= "%s и %%s"--Spell name (from option, plus spellname given in arg)
}
