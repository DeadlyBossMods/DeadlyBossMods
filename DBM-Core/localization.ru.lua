...
DBM_ARROW_ERROR_USAGE	= {
	...
	"/dbm arrow <x> <y>: создаёт стрелку, указывающую в определённую точку (0 < x/y < 100)",
	"/dbm arrow <player>: создаёт стрелку, указывающую на определённого игрока в вашей группе или рейде",
	"/dbm arrow hide: прячет стрелку",
