...
*Countdown sounds can now be injected into countdown options if files 1.ogg through 10.ogg are placed within "count" folder inside your voice pack. DBM will auto add these sounds to countdown options if you have a Voice-Version of 2 or later.