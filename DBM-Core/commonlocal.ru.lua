...
CL.SPREADDEBUFF				= "Распространение дебаффа"--Если вдруг окажется, что не подойдёт по смыслу, то дайте знать. Возможен вариант - Рассредоточение с дебаффом
CL.SPREADDEBUFFS			= "Распространение дебаффов"--Если вдруг окажется, что не подойдёт по смыслу, то дайте знать. Возможен вариант - Рассредоточение с дебаффами
CL.LASER					= "Лазер"
CL.LASERS					= "Лазеры"
CL.RIFT						= "Разлом"
CL.RIFTS					= "Разломы"
