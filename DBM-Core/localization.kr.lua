...
DBM_CORE_BOSS_DOWN_I				= "%s 전투에서 승리하였습니다! 이 난이도에서 %d회 승리하셨습니다."
DBM_CORE_BOSS_DOWN_L				= "%s 전투에서 승리하였습니다! 전투시간은 %s이며, 직전 전투시간은 %s입니다. 가장 빨랐던 기록은 %s이며, 이 난이도에서 %d회 승리하셨습니다."
DBM_CORE_BOSS_DOWN_NR				= "%s 전투에서 승리하였습니다! 전투시간은 %s입니다. 와우, 이 기록은 새로운 기록이군요! 과거 기록은 %s이며, 이 난이도에서 %d회 승리하셨습니다."
DBM_CORE_GUILD_BOSS_DOWN			= "길드원이 %s 전투에서 승리하였습니다! 전투시간은 %s입니다."
DBM_CORE_SCENARIO_COMPLETE			= "%s|1을;를; 완료하였습니다! 소요시간은 %s입니다."
DBM_CORE_SCENARIO_COMPLETE_I		= "%s|1을;를; 완료하였습니다! 이 난이도를 %d회 완료하셨습니다."
DBM_CORE_SCENARIO_COMPLETE_L		= "%s|1을;를; 완료하였습니다! 소요시간은 %s이며, 직전 소요시간은 %s입니다. 가장 빨랐던 기록은 %s이며, 이 난이도를 %d회 완료하셨습니다."
DBM_CORE_SCENARIO_COMPLETE_NR		= "%s|1을;를; 완료하였습니다! 소요시간은 %s입니다. 와우, 이 기록은 새로운 기록이군요! 과거 기록은 %s이며, 이 난이도를 %d회 완료하셨습니다."
DBM_CORE_COMBAT_ENDED_AT			= "%s 전투에서 전멸하였습니다. 전멸시 우두머리의 체력은 %s이며, 전투시간은 %s입니다."
DBM_CORE_COMBAT_ENDED_AT_LONG		= "%s 전투에서 전멸하였습니다. 전멸시 우두머리의 체력은 %s이며, 전투시간은 %s입니다. %d회 전멸하셨습니다."
...
DBM_CORE_SCENARIO_ENDED_AT_LONG		= "%s|1이;가; 종료되었습니다. 소요시간은 %s입니다. %d회 미완료하셨습니다."
...
DBM_CORE_WHISPER_SCENARIO_END_KILL_STATS	= "%s 님이 %s 시나리오를 완료했습니다! %d회 완료하였습니다."
DBM_CORE_WHISPER_SCENARIO_END_WIPE			= "%s 님이 %s 시나리오를 완료하지 못했습니다."
DBM_CORE_WHISPER_SCENARIO_END_WIPE_STATS	= "%s 님이 %s 시니리오를 완료하지 못했습니다. %d회 미완료하였습니다."
