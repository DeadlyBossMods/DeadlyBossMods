...
DBM_CORE_BLIZZ_BUGS					= "6.0 애드온 오류 안내:\n1. 시스템 설정 - 소리에서 사운드 채널이 '낮음(24)'로 설정되어 있을 경우 전투 중에 애드온 소리가 나지 않을 수 있습니다. 이는 6.0에서 동시에 24채널 이상 소리가 날 경우 애드온 소리 우선 순위가 낮게 변경되었기 때문입니다.\n2. DBM은 캐릭터 별로 설정을 저장하므로, 캐릭터 이름에 특수 문자가 있을 경우 설정 저장 또는 불러오기가 올바르게 되지 않을 수 있습니다."
