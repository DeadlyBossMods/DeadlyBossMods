...
DBM_CORE_MPROFILE_COPY_SUCCESS		= "%s의 %d특성 설정을 복사하였습니다."
...
DBM_CORE_MPROFILE_COPYS_SUCCESS		= "%s's %d mod sound settings have been copied."
...
DBM_CORE_MPROFILE_DELETE_SUCCESS	= "%s의 %d특성 설정을 삭제하였습니다."
...
DBM_CORE_ALLMOD_STATS_RESETED		= "현재 경보의 전적이 초기화 됩니다."
