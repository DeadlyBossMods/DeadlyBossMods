...
DBM_CORE_MPROFILE_COPY_SUCCESS		= "%s (%d특성) 설정을 복사하였습니다."
...
DBM_CORE_MPROFILE_COPYS_SUCCESS		= "%s (%d특성) 소리 설정을 복사하였습니다."
...
DBM_CORE_MPROFILE_DELETE_SUCCESS	= "%s (%d특성) 설정을 삭제하였습니다."
