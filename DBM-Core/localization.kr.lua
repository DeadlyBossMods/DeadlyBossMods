...
--DBM_CORE_WHATS_NEW_LINK			= "바 내부 아이콘 표시 기능 및 사용자 설정 기능이 추가되었습니다."
DBM_CORE_WHATS_NEW					= "바 내부 아이콘 표시 기능 및 사용자 설정 기능이 추가되었습니다. |HDBM:forumsnews|h|cff3588ff여기|r를 클릭하면 좀 더 자세한 내용을 볼 수 있습니다.(영문)"
