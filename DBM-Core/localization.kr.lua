...
L.OUTDATEDSPELLTIMERS				= "경고: DBM-SpellTimers 구버전이 " .. L.DBM .. "의 작동을 방해하고 있습니다. " .. L.DBM .. "이 정상 작동하려면 DBM-SpellTimers를 업데이트하거나 삭제해야 합니다. 업데이트 했다면 반드시 게임을 재시작해야 합니다."
L.OUTDATEDRLT						= "경고: DBM-RaidLeadTools가 이 버전의 " .. L.DBM .. "과 호환되지 않습니다. 반드시 삭제해야 " .. L.DBM .. "이 정상 작동합니다."
