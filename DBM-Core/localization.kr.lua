...
DBM_CORE_AUTO_SOUND_OPTION_TEXT_EJ		= "$journal:%d 주문의 영향을 받을 경우 특수 경고음 듣기"
...
DBM_CORE_AUTO_YELL_OPTION_TEXT_EJ		= "$journal:%d 주문의 영향을 받을 경우 외치기"
