...
DBM_CORE_UPDATEREMINDER_HOTFIX			= "지금 사용하시는 DBM 버전은 이 우두머리 전투에서 잘못된 경고를 표시합니다. 이 오류는 다음 정식 버전에서 수정되오나, 최신 alpha 버전으로 업데이트 하면 즉시 수정할 수 있습니다."
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.move			= "%s - 바닥 확인!"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.spell		= "$spell:%s 사용시 특수 경고 보기"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.target		= "$spell:%s 대상을 특수 경고로 보기"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.count		= "$spell:%s 사용시 특수 경고 보기"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.stack		= "당신이 $spell:%2$s %1$d 중첩 이상이 된 경우 특수 경고 보기"
