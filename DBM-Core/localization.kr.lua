...
DBM_CORE_AUTO_ANNOUNCE_TEXTS.endtraget		= "%s 종료 : >%%s<"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.move			= "%s - 바닥 확인 또는 이동!"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.move		= "$spell:%s 바닥/이동 특수 경고 보기"
