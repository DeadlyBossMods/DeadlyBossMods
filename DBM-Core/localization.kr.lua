...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.soon			= "$spell:%s 시전 전에 알림 보기"
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.prewarn		= "$spell:%s 시전 전에 알림 보기"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.soon		= "$spell:%s 시전 전에 특수 경고 보기"
