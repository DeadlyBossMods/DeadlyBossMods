...
DBM_CORE_OUT_OF_DATE_NAG				= "경고: 현재 사용중인 DBM 버전이 오래되었으며 현재 업데이트 팝업 끄기가 선택된 상태입니다. 이 상태는 당신과 당신 공격대에 좋지 않은 영향을 주기 때문에 권장되지 않습니다. 중요한 알림, 바 그리고 공격대원 모두가 볼 수 있는 대화 알림을 놓치지 않기 위해 업데이트 하시는 것을 강력하게 권장 드립니다."
