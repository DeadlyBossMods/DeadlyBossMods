...
L.AUTO_ANNOUNCE_OPTIONS.sooncount	= "$spell:%s 사전 경고 보기 (횟수 포함)"
...
L.AUTO_TIMER_TEXTS.addscount			= "쫄 (%%s)"
...
L.AUTO_TIMER_OPTIONS.addscount			= "쫄 등장 타이머 바 보기 (반복 횟수 포함)"
...
L.MN_TEXT_TIMERS_HEADER	= "문자 타이머를 사용하시겠습니까?\n(DBM 타이머 바 데이터를 사용하며, 바가 보이지 않아도 표시됩니다)"
