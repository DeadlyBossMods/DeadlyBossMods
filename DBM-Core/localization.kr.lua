...
L.PROFILE_NOT_FOUND			= "<" .. L.DBM .. "> 현재 설정된 프로필이 손상되었습니다. " .. L.DBM .. "이 '기본' 프로필을 로딩할 것입니다."
...
L.PROFILE_DELETED			= "'%s' 프로필을 삭제했습니다. '기본' 프로필이 적용됩니다."
L.PROFILE_DELETE_ERROR		= "프로필 삭제 실패. '%s' 프로필이 존재하지 않습니다."
L.PROFILE_CANNOT_DELETE		= "'기본' 프로필은 삭제할 수 없습니다."
