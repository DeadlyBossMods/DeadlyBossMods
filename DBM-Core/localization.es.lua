...
L.AUTO_SPEC_WARN_OPTIONS.blizztarget 	= "Mostrar anuncio especial (con contador) cuando $spell:%s afecte a un jugador"L.AUTO_SPEC_WARN_OPTIONS.blizzyou		= "Mostrar anuncio especial (con contador) cuando te afecte $spell:%s"L.AUTO_SPEC_WARN_OPTIONS.link			= "Mostrar anuncio especial cuando estés vinculado a otro jugador por $spell:%s"
