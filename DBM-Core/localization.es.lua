...
L.AUTO_ANNOUNCE_OPTIONS.targetcount		= "Mostrar anuncio (con contador) de los objetivos de $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.blizztarget		= "Mostrar anuncio (con contador) de los objetivos de $spell:%s"
...
L.AUTO_ANNOUNCE_OPTIONS.incomingcount	= "Mostrar anuncio (con contador) cuando $spell:%s tiene perjuicios inminentes"
...
L.AUTO_ANNOUNCE_OPTIONS.sooncount		= "Mostrar anuncio anticipado (con contador) para $spell:%s"
...
L.AUTO_SPEC_WARN_TEXTS.blizztarget	= "%s (%%s) en >%%s<"
L.AUTO_SPEC_WARN_TEXTS.blizzyou		= "%s (%%s) en ti"
...
L.AUTO_SPEC_WARN_OPTIONS.blizztarget 	= "Mostrar anuncio especial (con contador) cuando $spell:%s afecte a un jugador"
L.AUTO_SPEC_WARN_OPTIONS.blizzyou		= "Mostrar anuncio especial (con contador) cuando te afecte $spell:%s"
...
L.AUTO_TIMER_TEXTS.addscount			= "Esbirros (%%s)"
...
L.AUTO_TIMER_OPTIONS.addscount			= "Mostrar temporizador (con contador) para la siguiente aparición de esbirros"
...
L.MN_TEXT_TIMERS_HEADER = "¿Quieres usar temporizadores de texto?\n(Usa datos de las barras de DBM, aunque no se muestren)"
