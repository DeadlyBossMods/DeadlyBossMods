...
L.OUT_OF_DATE_NAG 					= "Tu versión de " .. L.DBM .. " está desactualizada para este encuentro. Se recomienda actualizar " .. L.DBM .. " para no perderte avisos, temporizadores o indicadores cruciales para tu grupo de banda."
