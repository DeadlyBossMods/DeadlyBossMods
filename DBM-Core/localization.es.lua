...
L.AUTO_ANNOUNCE_TEXTS.targetcount	= "%s (%%s) sobre >%%s<"
...
L.AUTO_SPEC_WARN_TEXTS.dispel		= "%s sobre >%%s< - ¡Disipa ahora!"
L.AUTO_SPEC_WARN_TEXTS.interrupt	= "%s - ¡Interrumpe a >%%s<!"
L.AUTO_SPEC_WARN_TEXTS.interruptcount= "%s - ¡Interrumpe a >%%s<! (%%d)"
L.AUTO_SPEC_WARN_TEXTS.you			= "%s sobre ti"
L.AUTO_SPEC_WARN_TEXTS.youcount		= "%s (%%s) sobre ti"
...
L.AUTO_SPEC_WARN_TEXTS.stack		= "%%d acumulaciones de %s sobre ti"
...
L.AUTO_YELL_ANNOUNCE_TEXT.position 			= "%s %%s sobre {rt%%d}"..UnitName("player").."{rt%%d}"
L.AUTO_YELL_ANNOUNCE_TEXT.positionnoIcon	= "%s %%s sobre " ..UnitName("player"),
