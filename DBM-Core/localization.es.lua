...
L.UPDATEREMINDER_DISABLE			= "anuncio: Se ha desactivado " .. L.DEADLY_BOSS_MODS .. " porque tu versión está demasiado desactualizada. Para prevenir conflictos con las versiones de otros jugadores, no se podrá volver a activar " .. L.DEADLY_BOSS_MODS .. " hasta que lo actualices."
L.UPDATEREMINDER_DISABLETEST		= "anuncio: Se ha desactivado " .. L.DEADLY_BOSS_MODS .. " porque tu versión está demasiado desactualizada y este es un reino de prueba/beta. No se podrá volver a activar " .. L.DEADLY_BOSS_MODS .. " hasta que lo actualices. Esto es para garantizar que no se utilicen modificaciones obsoletas al generar comentarios de prueba."
...
L.UPDATEREMINDER_MAJORPATCH			= "anuncio: Se ha desactivado " .. L.DEADLY_BOSS_MODS .. " porque tu versión está demasiado desactualizada. Dado que se trata de un parche de contenido importante, y para prevenir conflictos con las versiones de otros jugadores, no se podrá volver a activar " .. L.DEADLY_BOSS_MODS .. " hasta que lo actualices."
L.VEM								= "anuncio: Estás ejecutando " .. L.DEADLY_BOSS_MODS .. " y Voice Encounter Mods al mismo tiempo. " .. L.DBM .. " no funciona correctamente con esta configuración y, por lo tanto, no se ejecutará."
L.OUTDATEDPROFILES 					= "anuncio: DBM-Profiles no es compatible con esta versión de " .. L.DBM .. ". Para evitar conflictos, " .. L.DBM .. " no se ejecutará hasta que desactives o desinstales DBM-Profiles."
L.OUTDATEDSPELLTIMERS 				= "anuncio: DBM-SpellTimers provoca que " .. L.DBM .. " deje de funcionar. Desactívalo para que " .. L.DBM .. " funcione correctamente."
L.OUTDATEDRLT 						= "anuncio: DBM-RaidLeadTools provoca que " .. L.DBM .. " deje de funcionar. DBM-RaidLeadTools ya no es compatible con " .. L.DBM .. " y debe desactivarse para que este funcione correctamente."
L.VICTORYSOUND 						= "anuncio: DBM-VictorySound no es compatible con esta versión de " .. L.DBM .. ". Para evitar conflictos, " .. L.DBM .. " no se ejecutará hasta que desactives o desinstales DBM-VictorySound."
L.DPMCORE 							= "anuncio: Deadly PvP Mods ya no está en desarrollo y no es compatible con esta versión de " .. L.DBM .. ". Para evitar conflictos, " .. L.DBM .. " no se ejecutará hasta que borres Deadly PvP Mods."
L.DBMLDB 							= "anuncio: DBM-LDB ahora está incluido en DBM-Core. Se recomienda que borres la carpeta 'DBM-LDB' de tu carpeta de addons."
L.DBMLOOTREMINDER 					= "anuncio: Tienes instalado el módulo de terceros DBM-LootReminder. Este addon ya no es compatible con el cliente de WoW y causa conflictos con los temporizadores de " .. L.DBM .. ". Se recomienda desinstalarlo."
L.UPDATE_REQUIRES_RELAUNCH 			= "anuncio: Esta actualización de " .. L.DBM .. " no funcionará correctamente hasta que reinicies el juego. Esta versión incluye nuevos archivos o cambios en los archivos .toc que no pueden recargarse mediante /reload. Es probable que " .. L.DBM .. " no funcione correctamente hasta que reinicies el juego."
...
L.GEAR_WARNING				= "anuncio: Comprobación de equipo. Tu nivel de objeto equipado es %d menor que tu nivel de objeto de inventario."
L.GEAR_WARNING_WEAPON		= "anuncio: Comprueba que tu arma esté equipada."
...
local prewarnOption = "Mostrar anuncio previo para $spell:%s"
...
L.AUTO_ANNOUNCE_OPTIONS.spell			= "Mostrar anuncio para $spell:%s"
...
L.AUTO_ANNOUNCE_OPTIONS.ends			= "Mostrar anuncio cuando termine $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.endtarget		= "Mostrar anuncio cuando termine $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.fades			= "Mostrar anuncio cuando expire $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.addsleft		= "Anunciar el número de $spell:%s restantes"
L.AUTO_ANNOUNCE_OPTIONS.cast			= "Mostrar anuncio cuando se esté lanzando $spell:%s"
...
L.AUTO_ANNOUNCE_OPTIONS.bait			= "Mostrar anuncio previso para posicionar $spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.stage			= "Anunciar cambio a Fase %s"
L.AUTO_ANNOUNCE_OPTIONS.stagechange		= "Anunciar cambios de fase"
L.AUTO_ANNOUNCE_OPTIONS.prestage		= "Mostrar anuncio previo para Fase %s"
L.AUTO_ANNOUNCE_OPTIONS.count			= "Mostrar anuncio (con contador) para $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.soon 			= "Mostrar anuncio previo especial para $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.sooncount		= "Mostrar anuncio previo especial (con contador) para $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.bait			= "Mostrar anuncio previo especial para posicionar $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.prewarn 		= "Mostrar anuncio previo especial %s s antes de $spell:%s"
...
L.MOVE_SPECIAL_WARNING_BAR	= "anuncio especial desplazable"
L.MOVE_SPECIAL_WARNING_TEXT	= "anuncio especial"
