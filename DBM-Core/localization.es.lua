...
DBM_CORE_COMBAT_ENDED_AT_LONG		= "El combate contra %s (%s) terminó en %s. Lo has intentado %d veces en total."
...
DBM_CORE_WHISPER_COMBAT_END_WIPE_AT	= "%s ha wipeado en %s a las %s"
