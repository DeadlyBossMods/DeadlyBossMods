...
DBM_CORE_BLIZZ_BUGS					= "Do to changes with PlaySoundFile that disabled playing .wav media, all custom user sounds have been reset to defaults to force wipe any and all bad/missing sounds a user may have set in their mods. This was cleanest and smoothest way to fix 'sound won't play' issues users may have been experiencing do to the unannounced change. This reset will not occur again and you're safe to reconfigure custom special warning sounds once more. Also, do not forget that once you set custom sounds on one spec, you can copy sound settings from that spec to another spec, or even other characters from the mod stats window."
