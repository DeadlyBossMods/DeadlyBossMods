...
DBM_CORE_UPDATEREMINDER_HOTFIX			= "DBM version you are on has known bugs or incorrect timers/warnings during this boss encounter. This is corrected in latest release"
DBM_CORE_UPDATEREMINDER_HOTFIX_ALPHA	= "DBM version you are on has known bugs or incorrect timers/warnings during this boss encounter. This is corrected in an upcoming release (or latest alpha version)"
