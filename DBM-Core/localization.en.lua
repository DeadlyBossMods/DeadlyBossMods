...
DBM_CORE_MPROFILE_COPY_SUCCESS		= "%s's %d spec settings have been copied."
DBM_CORE_MPROFILE_COPY_SELF_ERROR	= "Cannot copy a profile to itself."
DBM_CORE_MPROFILE_COPY_S_ERROR		= "Source is corrupted. Setting not copied or partly copied. Copy failed."
DBM_CORE_MPROFILE_DELETE_SUCCESS	= "%s's %d spec setting is deleted."
DBM_CORE_MPROFILE_DELETE_SELF_ERROR	= "Cannot delete a profile currently in use."
DBM_CORE_MPROFILE_DELETE_S_ERROR	= "Source is corrupted. Setting not deleted or partly deleted. Delete failed."

DBM_CORE_ALLMOD_DEFAULT_LOADED		= "Default options for all mods have been loaded."
