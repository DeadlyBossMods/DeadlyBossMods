...
--	"/dbm version2: Performs a raid-wide version check and whispers members who are out of date (alias: ver2).",
	...
	"/dbm timer/ctimer <x> <text>: Starts a <x> second DBM Timer with the name <text>. Adding c adds audio/text countdown.",
	"/dbm broadcast timer/ctimer <x> <text>: Broadcasts a <x> second DBM Timer with the name <text> to the raid (requires leader/promoted status). Adding c adds audio/text countdown.",
