...
L.AUTO_SPEC_WARN_TEXTS = {
	...
	target								= "%s on >%%s<",
	targetcount							= "%s (%%s) on >%%s< ",
	blizztarget							= "%s (%%s) on >%%s< ",	blizzyou						= "%s (%%s) on you",	link								= "%s linked with >%%s<",
...
L.AUTO_SPEC_WARN_OPTIONS = {
	...
	blizztarget							= "Show special announce (with count) when someone is affected by $spell:%s",	blizzyou						= "Show special announce (with count) when you are affected by $spell:%s",	link								= "Show special announce when you are linked to another player by $spell:%s",
