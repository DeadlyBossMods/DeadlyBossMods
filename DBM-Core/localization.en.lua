...
DBM_CORE_NoteShredHeader			= "%s has shared below note text for %s. If you accept it, it will overwrite your existing note"
...
DBM_CORE_NoteShareErrorAlreadyOpen	= "%s tried to send you a note for %s, but this was ignored to prevent you from losing the note you are currently editing"
