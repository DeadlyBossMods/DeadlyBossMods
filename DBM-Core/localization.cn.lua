...
L.NEWS_UPDATE						= "|h|c11ff1111News|r|h: 此次更新主要重做了DBM的结构。无论正式服、还是各个版本的怀旧服都使用相同版本的DBM内核和模组。详情点击 |Haddon:DBM:news|h|cff3588ff[这里]|r|h"
...
L.AUTO_ANNOUNCE_OPTIONS.blizztarget		= "警报：$spell:%s的目标(带计数)"
...
L.AUTO_SPEC_WARN_OPTIONS.blizztarget		= "特殊警报：当他人受到$spell:%s影响时(带计数)"
L.AUTO_SPEC_WARN_OPTIONS.blizzyou		= "特殊警报：当你受到$spell:%s影响时(带计数)"
