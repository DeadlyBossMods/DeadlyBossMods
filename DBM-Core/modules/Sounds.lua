...
do
	local counts = {
		...
		{	text	= "Jérémy (frFR)",value = "Jérémy", path = "Interface\\AddOns\\DBM-Core\\Sounds\\Jérémy\\", max = 10},
		{	text	= "Élise (frFR)",value = "Élise", path = "Interface\\AddOns\\DBM-Core\\Sounds\\Élise\\", max = 10},
		{	text	= "도현원 (koKR)",value = "도현원", path = "Interface\\AddOns\\DBM-Core\\Sounds\\도현원\\", max = 10},
		{	text	= "하민지 (koKR)",value = "하민지", path = "Interface\\AddOns\\DBM-Core\\Sounds\\하민지\\", max = 10},
		...
		{	text	= "Александр (ruRU)",value = "Александр", path = "Interface\\AddOns\\DBM-Core\\Sounds\\Александр\\", max = 10},
		{	text	= "Надежда (ruRU)",value = "Надежда", path = "Interface\\AddOns\\DBM-Core\\Sounds\\Надежда\\", max = 10},
		{	text	= "瑞辰 (zhCN)",value = "瑞辰", path = "Interface\\AddOns\\DBM-Core\\Sounds\\瑞辰\\", max = 10},
		{	text	= "纯如 (zhCN)",value = "纯如", path = "Interface\\AddOns\\DBM-Core\\Sounds\\纯如\\", max = 10},
