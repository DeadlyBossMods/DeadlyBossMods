...
function DBM:ENCOUNTER_WARNING(encounterWarningInfo)
	...
	if targetGUID then
		...
		if tooltipSpellID then
			self:Debug("|cffffff00ENCOUNTER_WARNING: |r fired for text: "..text.." with casterName: "..casterName.." and spellId: "..tooltipSpellID.." and targetName: "..formattedTargetName.." and targetGUID: "..targetGUID, 2, nil, nil, true)
		else
		...
		if tooltipSpellID then
			self:Debug("|cffffff00ENCOUNTER_WARNING: |r fired for text: "..text.." with casterName: "..casterName.." and spellId: "..tooltipSpellID, 2, nil, nil, true)
		else
...
function DBM:ENCOUNTER_TIMELINE_EVENT_ADDED(eventInfo, remaining)
	...
	self:Debug("|cffffff00ENCOUNTER_TIMELINE_EVENT_ADDED: |r fired for eventID: "..eventID.." with spellID: "..C_ColorUtil.WrapTextInColor(spellId, color).." with spellName: "..C_ColorUtil.WrapTextInColor(spellName, color).." and duration: "..C_ColorUtil.WrapTextInColor(tostring(durationRounded), color).." and state: "..tostring(eventState), 3, nil, nil, true)
