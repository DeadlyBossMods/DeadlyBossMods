...
local playerName, playerRealm = private.isForever and GetUnitName("player") or UnitName("player"), GetRealmName()
...
local handleSync
local PForceDisable = 27--When this is incremented, trigger force disable regardless of major patch
...
do
	...
	-- GGR = Guild Gear Reply (whisper back to requester)
