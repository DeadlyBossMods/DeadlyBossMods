...
DBM.DisplayVersion = "11.0.31 alpha"--Core version
DBM.classicSubVersion = 0
DBM.ReleaseRevision = releaseDate(2024, 11, 19) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
