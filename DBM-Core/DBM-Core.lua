...
-- Nil variables
local currentSpecID, currentSpecName, currentSpecGroup, checkWipe, checkBossHealth, checkCustomBossHealth, fireEvent, AddMsg, delayedFunction, lastGroupLeader, syncZoneAuraSounds
