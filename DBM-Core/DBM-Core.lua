...
DBM = {
	...
	Version = "4.48",
	DisplayVersion = "4.49 alpha", -- the string that is shown as version
	ReleaseRevision = 4094 -- the revision of the latest stable version that is available (for /dbm ver2)
}
