...
DBM = {
	...
	DisplayVersion = "9.0.11 alpha", -- the string that is shown as version
	ReleaseRevision = releaseDate(2020, 12, 16) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
