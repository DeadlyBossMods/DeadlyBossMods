...
DBM = {
	...
	DisplayVersion = "9.1.3 alpha", -- the string that is shown as version
	ReleaseRevision = releaseDate(2021, 7, 12) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
