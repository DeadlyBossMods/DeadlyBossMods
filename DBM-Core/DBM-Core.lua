...
DBM = {
	...
	Version = "4.64",
	DisplayVersion = "4.65 alpha", -- the string that is shown as version
	ReleaseRevision = 4564 -- the revision of the latest stable version that is available (for /dbm ver2)
}
