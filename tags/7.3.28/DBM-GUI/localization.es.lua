...
L.TranslationBy 	= "Saispai (ordentradus@gmail.com)"
...
L.SpamBlockNoShowTgtAnnounce= "Ocultar anuncios generales de objetivos y desactivar los sonidos asociados (la opción anterior sobrescribe esta)"
