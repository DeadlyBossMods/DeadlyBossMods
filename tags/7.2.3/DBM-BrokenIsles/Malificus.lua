...
--local timerIncitePanicCD			= mod:NewAITimer(16, 233568, nil, nil, nil, 1)
local timerPestilenceCD				= mod:NewAITimer(16, 233614, nil, nil, nil, 3)
local timerShadowBarrageCD			= mod:NewAITimer(16, 234452, nil, nil, nil, 2)
