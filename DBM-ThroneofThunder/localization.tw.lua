...
L:SetWarningLocalization({
	specWarnVitaSoaker			= "你是下一位動盪生命吸收者!",
	warnVitaSoakerSoon			= "你是下下一位，請準備!"
})

L:SetOptionLocalization({
	warnVitaSoakerSoon	= "提示你為下下一位動盪生命吸收者(需要開啟訊息框架)",
	specWarnVitaSoaker	= "當你為下一個$spell:138297吸收者顯示特別警告，以上基於訊息框架位置(需要開啟訊息框架)",
	SetIconsOnVita		= "為中了$spell:138297和離他最遠的玩家設置團隊圖示",
	InfoFrame			= "顯示訊息框架給沒有$spell:138372的人排序動盪生命吸收(不包含坦克)"
})

L:SetMiscLocalization({
	Defeat						= "慢著!我不是你們的敵人。",
	NoSensitivity				= "動盪生命吸收者排序",
