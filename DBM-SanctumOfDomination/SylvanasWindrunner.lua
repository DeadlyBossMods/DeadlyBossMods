...
local allTimers = {
	["lfr"] = {
		...
		[3] = {
			--Bane Arrows
			[354011] = {36.1, 88.2, 87.9, 89.9},
			--Banshee's Heartseeker
			[353969] = {38.9, 24.4, 54.9, 3, 14.2, 24.4, 35.5, 11.8, 34.8, 12.5, 36.8, 12.1, 23.3},
			--Shadow Dagger
			[353935] = {55.2, 89.1, 94.4, 84.8},
			--Banshee Scream
			[353952] = {105.7, 62.1, 63.3, 63.4},
			--Wailing Arrow
			[347609] = {86.1, 64.8, 64.9, 66.6, 65},
			--Veil of Darkness
			[347726] = {44, 68.7, 66.6, 67.2 67.4},
			--Raze
			[354147] = {95.2, 89.7, 87},
		},
	},
