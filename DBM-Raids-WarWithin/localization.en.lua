...
L:SetMiscLocalization({
	Red		= " [Red]",--Skeinspinner Takazj
	Blue	= " [Blue]"--Anub'arash
})
...
L:SetOptionLocalization({
	...
	MatchEW				= DBM_COMMON_L.SQUARE_ICON_SMALL ..", ".. DBM_COMMON_L.TRIANGLE_ICON_SMALL ..", ".. DBM_COMMON_L.DIAMOND_ICON_SMALL ..", ".. DBM_COMMON_L.CROSS_ICON_SMALL .. " (non mythic difficulties) ".. DBM_COMMON_L.SQUARE_ICON_SMALL ..", ".. DBM_COMMON_L.TRIANGLE_ICON_SMALL ..", ".. DBM_COMMON_L.STAR_ICON_SMALL ..", ".. DBM_COMMON_L.CIRCLE_ICON_SMALL .. " (mythic difficulty) with a melee > ranged > healer priority (matches Echowigs behavior)",--Default
	UseAllAscending		= DBM_COMMON_L.STAR_ICON_SMALL ..", ".. DBM_COMMON_L.CIRCLE_ICON_SMALL ..", ".. DBM_COMMON_L.DIAMOND_ICON_SMALL ..", ".. DBM_COMMON_L.TRIANGLE_ICON_SMALL .. "+ (all difficulties) with a melee > ranged > healer priority",
	DisableIconsForRaid	= "Disable setting icons and show yells with no icons",
	DisableAllForRaid	= "Disable setting icons and yells entirely"
})
