...
local specWarnPowerShot			= mod:SpecWarning({type = "moveto", spellId = 229124, sound = 1, voiceVer = 2, voiceFile = "findshelter"})--Johnny Awesome
local specWarnColdCrash			= mod:SpecWarning({type = "moveto", spellId = 283199, sound = 3, voiceVer = 2, voiceFile = "findshelter"})--Mama Stormstout
