...
L:SetMiscLocalization({
	...
	Lost3			= "Tellement de sang ! Joli",-- Good
	Lost4			= "Retournez dans la file et retentez votre chance",-- Good
	Lost5			= "On ne fait pas d’omelette sans casser des œufs",-- Good
	Lost6			= "essayez de moins mourir",-- Good
	Lost7			= "quel carnage",-- Good
	Lost8			= "s’appelait",--LoL at fight club reference here
	Lost9			= "ne s’est pas très bien terminé",-- Good
