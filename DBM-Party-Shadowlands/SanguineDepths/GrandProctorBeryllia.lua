...
local timerIronSpikesCD				= mod:NewAITimer(13, 325254, nil, "Tank|Healer", nil, 5, nil, DBM_CORE_Translations.TANK_ICON)
local timerRiteofSupremacyCD		= mod:NewAITimer(10, 325360, nil, nil, nil, 2, nil, DBM_CORE_Translations.DEADLY_ICON)
local timerRiteofSupremacy			= mod:NewCastTimer(10, 325360, nil, false, nil, 5, nil, DBM_CORE_Translations.DEADLY_ICON)
