...
local timerStoneCallCD				= mod:NewCDTimer(37.6, 319733, nil, nil, nil, 1, nil, DBM_CORE_Translations.DAMAGE_ICON)--37.6-43.6
local timerStoneShatteringLeapCD	= mod:NewCDTimer(29, 319592, nil, nil, nil, 3)
local timerCurseofStoneCD			= mod:NewCDTimer(29.1, 327411, nil, nil, nil, 3, nil, DBM_CORE_Translations.CURSE_ICON)
