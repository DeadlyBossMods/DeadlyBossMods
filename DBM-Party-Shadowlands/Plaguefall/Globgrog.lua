...
local timerSummonSlimeCD			= mod:NewCDTimer(13, 327608, nil, nil, nil, 1, nil, DBM_CORE_Translations.DAMAGE_ICON)
local timerSlimeWaveCD				= mod:NewCDTimer(13, 324667, nil, "Tank", nil, 5, nil, DBM_CORE_Translations.TANK_ICON)
