...
L:SetWarningLocalization({
	specWarnParasiticInfester	= "당신에게 기생성 무력화",
	specWarnParasiticInfesterKick	= "기생성 무력화 - 차단!"
})

L:SetTimerLocalization{
	timerParasiticInfesterCD	= "~기생충"
}

L:SetOptionLocalization({
	specWarnParasiticInfester	= "당신이 기생성 무력화 대상이면 특수 알림 보기",
	specWarnParasiticInfesterKick	= "기생성 무력화를 차단해야 할 때 특수 경고 보기",
	timerParasiticInfesterCD	= "기생성 무력화 타이머 바 보기",
	yellParasiticInfester		= "기생성 무력화 대상일 때 말풍선으로 알리기"
})
