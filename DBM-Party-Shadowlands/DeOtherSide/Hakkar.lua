...
local timerBloodBarrageCD			= mod:NewAITimer(13, 323064, nil, nil, nil, 4, nil, DBM_CORE_Translations.INTERRUPT_ICON)
local timerCorruptedBloodCD			= mod:NewAITimer(13, 322746, nil, nil, nil, 3)
local timerPiercingBarbCD			= mod:NewAITimer(13, 322736, nil, "Tank|Healer", nil, 5, nil, DBM_CORE_Translations.TANK_ICON)
--Son of Hakkar:
