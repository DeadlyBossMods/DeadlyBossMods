...
--local timerAvastyeCD				= mod:NewAITimer(13, 257316, nil, nil, nil, 1, nil, DBM_CORE_Translations.DAMAGE_ICON)
local timerCometStormCD				= mod:NewAITimer(15.8, 320772, nil, nil, nil, 3)
local timerIceboundAegisCD			= mod:NewAITimer(15.8, 321754, nil, nil, nil, 5, nil, DBM_CORE_Translations.DAMAGE_ICON)
local timerFrozenBindsCD			= mod:NewAITimer(15.8, 323730, nil, nil, nil, 3, nil, DBM_CORE_Translations.MAGIC_ICON)
