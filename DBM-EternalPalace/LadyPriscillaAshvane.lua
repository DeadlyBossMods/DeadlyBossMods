...
local yellArcingAzerite					= mod:NewPosYell(296944, DBM_CORE_Translations.AUTO_YELL_CUSTOM_POSITION)
...
local timerBarnacleBashCD				= mod:NewCDCountTimer(15, 296725, nil, nil, nil, 5, nil, DBM_CORE_Translations.TANK_ICON, nil, mod:IsTank() and 2, 4)
local timerBrinyBubbleCD				= mod:NewCDCountTimer(15, 297324, nil, nil, nil, 3, nil, DBM_CORE_Translations.TANK_ICON..DBM_CORE_Translations.DAMAGE_ICON, nil, 2, 4)
