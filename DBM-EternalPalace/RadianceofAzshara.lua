...
local timerTideFistCD					= mod:NewNextCountTimer(58.2, 296546, nil, "Tank", nil, 5, nil, DBM_CORE_Translations.TANK_ICON, nil, mod:IsTank() and 2, 4)
...
local timerUnshacklingPowerCD			= mod:NewNextCountTimer(58.2, 296894, nil, nil, nil, 2, nil, DBM_CORE_Translations.HEALER_ICON, nil, 1, 4)
