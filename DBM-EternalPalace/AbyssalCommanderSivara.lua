...
local yellMark							= mod:NewPosYell(294726, DBM_CORE_Translations.AUTO_YELL_CUSTOM_POSITION, true, 2)
...
local yellOverflowingChill				= mod:NewPosYell(295348, DBM_CORE_Translations.AUTO_YELL_CUSTOM_POSITION2)
...
local yellOverflowingVenom				= mod:NewPosYell(295421, DBM_CORE_Translations.AUTO_YELL_CUSTOM_POSITION2)
...
local yellFrostJav						= mod:NewPosYell(295606, DBM_CORE_Translations.AUTO_YELL_CUSTOM_POSITION2)
local specWarnToxicJav					= mod:NewSpecialWarningYou(295607, nil, nil, nil, 1, 2)
local yellToxicJav						= mod:NewPosYell(295607, DBM_CORE_Translations.AUTO_YELL_CUSTOM_POSITION2)
local specWarnGTFO						= mod:NewSpecialWarningGTFO(300961, nil, nil, nil, 1, 8)

--mod:AddTimerLine(BOSS)
local timerCrushingReverbCD				= mod:NewCDTimer(22.3, 295332, nil, nil, nil, 5, nil, DBM_CORE_Translations.TANK_ICON, nil, mod:IsMelee() and 2, 4)
local timerOverwhelmingBarrageCD		= mod:NewCDTimer(40, 296551, nil, nil, nil, 2, nil, DBM_CORE_Translations.DEADLY_ICON, nil, 1, 4)
local timerOverflowCD					= mod:NewCDTimer(40.1, 295346, nil, nil, nil, 3)--31.6 previously, but 40 as of mythic testing
local timerInversionCD					= mod:NewCDTimer(72.9, 295791, nil, nil, nil, 2, nil, DBM_CORE_Translations.HEROIC_ICON, nil, 3, 4)
local timerfrostshockboltsCD			= mod:NewCDTimer(60.8, 295601, nil, nil, nil, 3)
local timerChimericMarksCD				= mod:NewCDTimer(22.8, 294726, nil, nil, nil, 2, nil, DBM_CORE_Translations.MYTHIC_ICON)--Mythic
