...
L.Statistic_Incompletes  = "Incompletos:"--Para cenários, TODO, encontrar um jeito limpo de substituir derrotas por estatistica incompleto para mods de cenario
...
L.MonochromeOutline   = "Contorno Monochromático"
L.MonochromeThickOutline = "Espessura do contorno Monochromático"
...
L.ShowAllVersions    = "exibir a versão da mod para todos os membros nochat"
...
L.CountdownVoice3   = "Definir voz tercearia para sons de contagem"
...
L.SpecWarn_AlwaysVoice  = "Sempre tocar todos os avisos faladosalerts (Substitui opções escificas dos chefes. Util para lideres de raids)"
...
L.SpamBlockNoShowAnnounce = "Não exibir anuncios ou tocar avisos sonoros"
L.SpamBlockNoSendWhisper = "Não enviar sussurros para outros jogadores"
L.SpamBlockNoSetIcon  = "Não marcar jogadores com icones"
...
L.SpamBlockNoHealthFrame = "Não exibirr quadros de vida"
L.SpamBlockNoCountdowns  = "Não tocar sons de contagem regressiva"
L.SpamBlockNoIconRestore = "Não guardar estado dos incones e restaura-los ao fim do combate"
...
L.FilterTankSpec   = "Filtrar mensagens designadas para tank role quando não for tank. (Nota: Desabilitar esta função não é recomendado para a maioria dos usuarios ja que avisos de 'taunt' ( insultos ) estão habilitados por definição.)"
...
L.FilterDispels    = "Filtrar avisos para magias dissipaveis se a seu dissipar estiver em recarga."
...
L.DontPlayPTCountdown   = "Não tocar o audio da contagem regressiva de puxada/combate/customizado"
...
L.HideWatchFrame   = "Esconder/acompanhar quadros (de objetivos) durante as lutas contra os chefes, caso nenhuma conquista esteja sendo acompanhada. No modo desafio, cria uma medalha temporaria na luta de chefes enquanto o quadro estiver escondido"
...
L.HideApplicantAlertsNotL = "se nao for o lider do grupo (aplica filtro de grupo cheio caso seja o lider)"
...
L.AutologBosses    = "Gravar automaticamente o relatório de encontro com os chefes utilizando o relatório de combate da Blizzard(Requer que seja usado /dbm pull antes do chefe <a href=\"http://www.warcraftl...ftlogs.com|r</a> compatibilidade)"
L.AdvancedAutologBosses  = "Gravar automaticamente o encontro com o chefe utilizando o Transcritor"
L.LogOnlyRaidBosses   = "Só gravar encontros com chefes de raid (exclui Localizador de Raids/Grupos/Cenarios)"
...
L.FakeBW     = "Finjir ser BigWigs em checagens de versão ao invés de ser DBM ( utíl para guildas que forçam o uso de BigWigs )"
...
L.DualProfile    = "Habilite suporte para outras mods de chefes de acordo com a especialização. (O gerenciameto de perfis de mods de chefes é feito da tela de mods de chefes carregados)"
