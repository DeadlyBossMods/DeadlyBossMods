...
L.Area_SpecWarnFlash		= "Special Warning Flash Options"
L.SpecWarn_FlashColor		= "Flash color"
L.SpecWarn_FlashDur			= "Flash duration: %d"
L.SpecWarn_FlashAlpha		= "Flash alpha"--TODO, add : %d when numbers less than 1 are supported (it seems to math.floor it)
L.Area_SpecWarnFont			= "Special Warning Font Options"
...
L.Area_SpecWarnSound		= "Special warning Sound Options"
