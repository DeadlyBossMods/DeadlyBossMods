...
L.AutologBosses				= "Automatically record boss encounters using blizzard combat log (Use /pull before bosses is required for |HDBM:generic|h|cff3588ffwarcraftlogs.com|r compatability)"
