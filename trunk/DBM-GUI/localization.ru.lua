...
L.Area_SpecWarnFlash		= "Настройка мигания для специальных предупреждений"
L.SpecWarn_FlashColor		= "Цвет мигания"
L.SpecWarn_FlashDur			= "Длительности мигания: %d"
L.SpecWarn_FlashAlpha		= "Прозрачность мигания"--TODO, add : %d when numbers less than 1 are supported (it seems to math.floor it)
L.Area_SpecWarnFont			= "Настройка шрифта для специальных предупреждений"
...
L.Area_SpecWarnSound		= "Настройка звука для специальных предупреждений"
