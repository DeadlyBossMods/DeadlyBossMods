...
L.ShowAllVersions	 		= "Affiche les versions des BossMods pour chaque membre du groupe dans la fenêtre de discussion"
...
L.ShowDefeatMessage 		= "Afficher les messages de victoire dans la fenêtre de discussion"
L.ShowGuildMessages 		= "Afficher les messages de engagement/victoire/échec de la guilde dans la fenêtre de discussion"
