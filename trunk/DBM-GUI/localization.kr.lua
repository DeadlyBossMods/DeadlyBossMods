...
L.SWFNever					= "하지 않음"
L.SWFDefaultOnly			= "특수 경고가 기본 효과음만 재생할 때 (사용자 정의 효과음은 계속 재생 허용)"
...
L.DontPlayPTCountdown		= "풀링/휴식/전투/사용자 정의 초읽기 음성 재생 안함"
L.DontShowPTCountdownText	= "풀링/휴식/전투/사용자 정의 초읽기 숫자 표시 안함"
L.PT_Threshold				= "휴식/전투/사용자 정의 타이머 초읽기 숫자 표시 안함: %d초 까지"
