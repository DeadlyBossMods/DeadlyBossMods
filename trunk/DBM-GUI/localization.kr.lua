...
L.Website					= "DBM 사용자 포럼을 방문해 보세요. |cFF73C2FBhttp://www.inven.co.kr/board/powerbbs.php?come_idx=3716|r (인벤 제공)"
L.WebsiteButton				= "게시판"
...
L.InfoRaidWarning			= [[공격대 경보 창 위치와 색상을 수정할 수 있습니다.
...
L.WarningIconLeft 			= "알림 왼쪽에 아이콘 보기"
L.WarningIconRight 			= "알림 오른쪽에 아이콘 보기"
...
L.SpecialWarnSound			= "특수 경고 소리 1(당신이나 특정 대상에게만 사용되는 주문)"
L.SpecialWarnSound2			= "특수 경고 소리 2(모든 공격대원에게 사용되는 주문)"
L.SpecialWarnSound3			= "특수 경고 소리 3(전멸기, 매우 중요한 주문)"
