...
local timerTurret1			= mod:NewCastTimer(55, "timerTurret1")
local timerTurret2			= mod:NewCastTimer(75, "timerTurret2")
local timerTurret3			= mod:NewCastTimer(95, "timerTurret3")
local timerTurret4			= mod:NewCastTimer(115, "timerTurret4")
