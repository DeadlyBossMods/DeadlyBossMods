...
DBM_CORE_BOSS_DOWN_NR				= "%s 전투에서 승리하였습니다. 전투시간은 %s입니다. 이 기록은 새로운 기록이군요! 과거 기록은 %s이며, 이 난이도에서 %d회 승리하셨습니다!"
...
DBM_CORE_SCENARIO_COMPLETE_NR		= "%s|1을;를; 완료하였습니다. 소요시간은 %s입니다. 이 기록은 새로운 기록이군요! 과거 기록은 %s이며, 이 난이도를 %d회 완료하셨습니다!"
