...
DBM_CORE_COMBAT_STARTED				= "%s作戰開始，祝你好運 :)";
DBM_CORE_BOSS_DOWN					= "%s被擊殺！用時%s。"
DBM_CORE_BOSS_DOWN_LONG				= "%s被擊殺！本次用時%s，上次用時%s，最快擊殺用時%s。"
DBM_CORE_BOSS_DOWN_NEW_RECORD		= "%s被擊殺！用時%s，新的擊殺紀錄誕生了！（原紀錄為%s）"
DBM_CORE_COMBAT_ENDED				= "%s作戰結束，用時%s。"
...
DBM_CORE_OPTION_TIMER_ENRAGE		= "顯示狂怒倒計時"
...
DBM_CORE_UPDATEREMINDER_HEADER		= "你的Deadly Boss Mods版本已過期。\n你可以在如下位址下載到新版本%s(r%d)："
DBM_CORE_UPDATEREMINDER_FOOTER		= "Ctrl-C：複製下載地址到剪切板。"
...
DBM_PIZZA_ERROR_USAGE				= "命令：/dbm [broadcast] timer <時間（秒）> <文本>"
