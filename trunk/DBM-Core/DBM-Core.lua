...
DBM = {
	...
	Version = "4.32",
	DisplayVersion = "4.33 alpha", -- the string that is shown as version
	ReleaseRevision = 2643 -- the revision of the latest stable version that is available (for /dbm ver2)
}
