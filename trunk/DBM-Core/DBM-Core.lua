...
DBM = {
	...
	Version = "4.96",
	DisplayVersion = "4.97 alpha", -- the string that is shown as version
	ReleaseRevision = 6277 -- the revision of the latest stable version that is available (for /dbm ver2)
}
