...
DBM = {
	...
	Version = "4.36",
	DisplayVersion = "4.37 alpha", -- the string that is shown as version
	ReleaseRevision = 3009 -- the revision of the latest stable version that is available (for /dbm ver2)
}
