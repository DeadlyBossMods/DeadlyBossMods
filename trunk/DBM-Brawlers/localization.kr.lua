...
--	EnteringArena1	= "들어서는 건",-1,7
--	EnteringArena2	= "도전자가 나타났습니다.",-4
--	EnteringArena3	= "조심하십시오...",-2
--	EnteringArena4	= "박수를 부탁드립니다",-3,8
	Rank1			= "1계급",
	Rank2			= "2계급",
	Rank3			= "3계급",
	Rank4			= "4계급",
	...
	Victory3		= "멋진 승리였습니다.",--멋진 승리였습니다, 아버님댁보일러! 이제 다시 줄을 서세요.
	...
	Lost1			= "솔직히 말할게요.",--솔직히 말할게요, %s... 대체 지금 뭘 하시는 건가요?
	Lost2			= "안됐네요,",--안됐네요, %s. 이제 그 시체 좀 치워 주실래요? 다음 싸움꾼들이 기다리고 있어서요.
	Lost3			= "다음 번에는 이렇게 쉽게 죽지 마세요.",--%s %s 우리 %s... 다음 번에는 이렇게 쉽게 죽지 마세요.
	Lost4			= "줄은 다시 서야 해요.",
	Lost5			= "정말 운이 없군요",--하하! 정말 운이 없군요! %s입니다! 아하하하! 당신이 불길 속에서 죽는다에 25골드를 걸었어요!
	Lost6			= "아이구... 그렇게 아팠으니",--아이구... 그렇게 아팠으니 많이 성숙해지겠어요.
	Lost7			= "그거 참",--그거 참... 안 좋게 끝났네요.
	Lost8			= "지금까지",--지금까지 %s 였습니다.
