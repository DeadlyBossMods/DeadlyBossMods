...
L:SetOptionLocalization({
	...
	warnShadowblazeSoon		= "Show pre-warning countdown for $spell:94085(5sec before)\n(Only after timer has been synced to first yell to ensure accuracy of countdown.)",
	specWarnShadowblazeSoon	= "Show pre-special warning for $spell:94085\n(5sec second prewarn before sync do to possible 1-2sec variation, 1sec prewarn after sync)",
