...
DBM = {
	...
	DisplayVersion = "6.2 alpha", -- the string that is shown as version
	ReleaseRevision = 13772 -- the revision of the latest stable version that is available
}
...
DBM.DefaultOptions = {
	...
	pecialWarningFlashCol5 = {0.2, 1.0, 1.0},--Tealish
