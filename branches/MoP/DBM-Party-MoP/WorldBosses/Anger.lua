...
local specWarnGrowingAnger		= mod:NewSpecialWarningSpell(119622, nil, nil, nil, true)
...
local timerWrathCD				= mod:NewCDTimer(50, 119488)--Based on rage, but timing is consistent enough to use a CD bar, might require some perfecting later, similar to xariona's special, if rage doesn't reset after wipes, etc.
local timerWrath				= mod:NewBuffActiveTimer(28, 119488, nil, mod:IsTank() or mod:IsHealer())
