...
DBM_CORE_GUILD_COMBAT_STARTED		= "%s has been engaged by "..(GetGuildInfo("player"))
...
DBM_CORE_GUILD_BOSS_DOWN			= "%s has been defeated by "..(GetGuildInfo("player")).." after %s!"
...
DBM_CORE_GUILD_COMBAT_ENDED_AT		= (GetGuildInfo("player")).." has wiped on %s (%s) after %s."
