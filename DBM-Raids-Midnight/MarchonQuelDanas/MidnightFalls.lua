...
local timerHeavensGlaivesCD			= mod:NewCDCountTimer(20.5, 1253915, nil, nil, nil, 3, nil, DBM_COMMON_L.DEADLY_ICON)--Shortnmae "Glaives"
...
local timerTotalEclipseCD			= mod:NewCDTimer(60, 1261871, nil, nil, nil, 6, nil, DBM_COMMON_L.IMPORTANT_ICON)--Stage 1.5 intermisison start
...
local timerDarkMeltdownCD			= mod:NewCDTimer(20.5, 1281194, nil, nil, nil, 2)--Stage 2 (timer for stage 3 begin). Shorttest "Stage Three"
