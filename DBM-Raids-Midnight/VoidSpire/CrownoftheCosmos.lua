...
local timerNullCoronaCD					= mod:NewCDCountTimer(20.5, 1233865, DBM_COMMON_L.HEALABSORB.." (%s)", nil, nil, 3, nil, DBM_COMMON_L.MAGIC_ICON..DBM_COMMON_L.HEALER_ICON)--P1+
...
local timerInterruptingTremorCD			= mod:NewCDCountTimer(20.5, 1243743, nil, "SpellCaster|HasInterrupt", 2, 4, nil, DBM_COMMON_L.INTERRUPT_ICON)--P1 Add
