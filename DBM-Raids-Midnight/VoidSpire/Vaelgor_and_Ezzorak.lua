...
local specWarnNullBeam				= mod:SpecWarning({type = "count", spellId = 1262623, sound = 2, voiceVer = 2, voiceFile = "beamincoming"})
local specWarnVoidHowl				= mod:SpecWarning({type = "count", spellId = 1244917, sound = 2, voiceVer = 2, shortText = DBM_COMMON_L.ORBS, voiceFile = "range5"})
local specWarnGloom					= mod:SpecWarning({type = "blizztarget", spellId = 1245391, sound = 2, voiceVer = 2})
local specWarnDreadBreath			= mod:SpecWarning({type = "blizztarget", spellId = 1244221, sound = 2, voiceVer = 2, shortSpellId = 17088})
local specWarnMidnightFlames		= mod:SpecWarning({type = "count", spellId = 1249748, sound = 2, voiceVer = 2, shortText = DBM_COMMON_L.AOEDAMAGE, voiceFile = "aesoon"})
--local specWarnGrabblingMaw		= mod:SpecWarning({type = "count", spellId = 1280458, sound = 1, voiceVer = 2})
local specWarnRakfang				= mod:SpecWarning({type = "defensive", spellId = 1245645, sound = 1, voiceVer = 2, voiceFile = "defensive"})
local specWarnVaelwing				= mod:SpecWarning({type = "defensive", spellId = 1265131, sound = 1, voiceVer = 2, voiceFile = "defensive"})
local specWarnCosmosisGloom			= mod:SpecWarning({type = "count", spellId = 1277470, sound = 2, voiceVer = 2, voiceFile = "gloomincoming"})
local specWarnCosmosisNullbeam		= mod:SpecWarning({type = "count", spellId = 1277471, sound = 2, voiceVer = 2, voiceFile = "beamincoming"})
local specWarnCosmosisDreadBreath	= mod:SpecWarning({type = "blizztarget", spellId = 1277472, sound = 2, voiceVer = 2})
local specWarnCosmosisVoidHowl		= mod:SpecWarning({type = "count", spellId = 1277473, sound = 2, voiceVer = 2, voiceFile = "range5"})
local specWarnRadiantBarrier		= mod:SpecWarning({type = "count", spellId = 1248847, sound = 2, voiceVer = 2, voiceFile = "findshield"})
	...
	local function timersMythic(self, timer, timerExact, eventID)
		...
		elseif stage == 1.5 then--Stage 1.5 (intermission) routing bucket
			...
			elseif self:IsRoundedTimer(timer, 23) then--Intermission Cosmosis: Dread Breath (long)
				--Blizzards timer is actually wrong and we have to adjust it
				timerCosmosisDreadBreathCD:TLStart(27, eventID, self:TLCountStart(eventID, "cosmosisdreadbreath", "cosmosisDreadBreathCount"))
				self:Schedule(25, BuggedBreathDelay, self, eventID)
