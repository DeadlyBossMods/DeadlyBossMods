...
local specWarnCallPack		= mod:NewSpecialWarning("OptionVersion2", "specWarnCallPack", mod:IsRanged() or mod:IsTank(), nil, nil, 4)--Summons add for every person within 40 yards of boss. Ranged should be able to avoid this. Tank in warning to pick ones up spawned by melee
local specWarnTears			= mod:NewSpecialWarningSpell(144702, nil, nil, nil, 2)
local specWarnMoonfangCurse	= mod:NewSpecialWarning("OptionVersion2", "specWarnMoonfangCurse", mod:IsMelee(), nil, nil, 4)
