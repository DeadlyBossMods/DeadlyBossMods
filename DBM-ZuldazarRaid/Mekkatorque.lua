...
local specWarnElectroshockAmp			= mod:NewSpecialWarningCount(289699, nil, DBM_CORE_Translations.AUTO_SPEC_WARN_OPTIONS.stack:format(8, 289699), nil, 1, 2)
...
local timerGigaVoltChargeCD				= mod:NewNextCountTimer(14.1, 286646, nil, nil, nil, 3, nil, DBM_CORE_Translations.TANK_ICON, nil, 2, 4)
local timerWormholeGeneratorCD			= mod:NewNextCountTimer(55, 287952, 67833, nil, nil, 3, nil, DBM_CORE_Translations.HEROIC_ICON, nil, 3, 4)--Shorttext "Wormhole"
...
function mod:SPELL_AURA_APPLIED(args)
	...
	if spellId == 287757 or spellId == 286646 then--283409?
		...
		if args:IsPlayer() then
			...
			specWarnGigaVoltChargeFading:Schedule(8.5, DBM_CORE_Translations.BREAK_LOS)
