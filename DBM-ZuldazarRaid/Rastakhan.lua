...
local timerScorchingDetonationCD		= mod:NewCDCountTimer(23.1, 284831, nil, "Tank", nil, 5, nil, DBM_CORE_Translations.TANK_ICON, nil, 2, 4)
...
----Headhunter Gal'wana
local timerGrievousAxeCD				= mod:NewCDTimer(17.1, 284781, nil, nil, nil, 3, nil, DBM_CORE_Translations.HEALER_ICON)
--Stage Two: Bwonsamdi's Pact
...
local timerInevitableEndCD				= mod:NewCDCountTimer(62.5, 287333, nil, nil, nil, 2, nil, DBM_CORE_Translations.DEADLY_ICON, nil, 1, 5)--62-75?
local timerAddsCD						= mod:NewAddsTimer(120, 284446, nil, nil, nil, 1, nil, DBM_CORE_Translations.DAMAGE_ICON)--Single use at start of Stage 3
----Spirits
mod:AddTimerLine(DBM_ADDS)
...
function mod:SPELL_CAST_SUCCESS(args)
	...
	elseif spellId == 284521 then--Spirit Expulsion
		...
		self.vb.InevitableEndCount = 0
		--
		warnPhase:Show(DBM_CORE_Translations.AUTO_ANNOUNCE_TEXTS.stage:format(4))
