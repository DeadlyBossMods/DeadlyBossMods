...
L:SetWarningLocalization({
	...
	WarnOrbsSoon		= "Сумеречное иссечение через %d сек!",
	WarnEggWeaken		= "С яиц убран сумеречный панцирь",
	SpecWarnOrbs		= "Скоро Сумеречное иссечение!",
...
L:SetOptionLocalization({
	...
	WarnOrbsSoon		= "Предупреждение для $spell:92954 (За 5с до начала, каждую 1с)\n(Предупреждение может быть неточным!)",
	...
	SpecWarnOrbs		= "Спец-предупреждение для $spell:92954\n(Предупреждение может быть неточным)",
