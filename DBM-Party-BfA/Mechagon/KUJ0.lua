...
local timerVentingFlamesCD			= mod:NewCDTimer(13.4, 291946, nil, nil, nil, 2, nil, DBM_CORE_Translations.DEADLY_ICON)
local timerBlazingChompCD			= mod:NewCDTimer(15.8, 294929, nil, "Tank|Healer", nil, 5, nil, DBM_CORE_Translations.TANK_ICON)
...
function mod:SPELL_CAST_START(args)
	...
	if spellId == 291946 then
		specWarnVentingFlames:Show(DBM_CORE_Translations.BREAK_LOS)
