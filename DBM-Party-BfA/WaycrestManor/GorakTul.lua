...
local timerDarkenedLightningCD		= mod:NewCDTimer(15.7, 266225, nil, nil, nil, 4, nil, DBM_CORE_Translations.INTERRUPT_ICON)--Has interrupt spell icon but it's not actually interruptable
