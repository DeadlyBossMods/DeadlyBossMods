...
local timerSoulrendCD				= mod:NewCDTimer(41.3, 249923, nil, nil, nil, 3, nil, DBM_CORE_Translations.DAMAGE_ICON)
local timerWrackingPainCD			= mod:NewCDTimer(17, 250096, nil, "HasInterrupt", nil, 4, nil, DBM_CORE_Translations.INTERRUPT_ICON)--17-23
local timerSkewerCD					= mod:NewCDTimer(12, 249919, nil, "Tank", nil, 5, nil, DBM_CORE_Translations.TANK_ICON)
